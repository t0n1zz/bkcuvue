...
class Seragam implements FromArray, WithHeadings, WithCustomStartCell, WithEvents, WithTitle
{
    ...
    public function registerEvents(): array
    {
        ...
        return [
            AfterSheet::class => function (AfterSheet $event) {
                ...
                $sheet->setCellValue('C5', "MASUK KANTOR/ MASUK KERJA (DALAM HARI)");
    ...
    public function array(): array
    {
        ...
        $masukKantorS = Presensi::with('seragamKerja')->has('seragamKerja')->where('id_kegiatan', 0)->whereYear('created_at', '=', Carbon::parse($date)->format('Y'))->select('id_user', 'id', 'id_aktivis','tanggal')->get();
