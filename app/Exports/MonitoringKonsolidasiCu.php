...
class MonitoringCuKonsolidasiCu implements FromArray, WithHeadings, WithCustomStartCell, WithEvents, WithTitle,WithColumnFormatting
{
    ...
    public function registerEvents(): array
    {
        ...
        return [
            AfterSheet::class => function (AfterSheet $event) {
                ...
                $sheet->setCellValue('A1', "Laporan MonitoringCu PUSKOPCUINA Via SIMO");
    ...
    {
        return 'Laporan MonitoringCu Konsolidasi';
    }
}