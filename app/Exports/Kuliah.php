...
class Kuliah implements FromArray, WithHeadings, WithCustomStartCell, WithEvents, WithTitle
{
    ...
    public function array(): array
    {
        ...
        $alpaS = PresensiKuliah::with('aktivis')->has('aktivis')->whereYear('created_at', '=', Carbon::parse($date)->format('Y'))->select('id_user', 'id_aktivis', 'tanggal')->get();
