...
class Off implements FromArray, WithHeadings, WithCustomStartCell, WithEvents, WithTitle
{
    ...
    public function registerEvents(): array
    {
        ...
        return [
            AfterSheet::class => function (AfterSheet $event) {
                ...
                $sheet->setCellValue('C5', "WAKTU OFF DALAM BULAN");
    ...
    public function array(): array
    {
        ...
        $alpaS = PresensiOffBergilir::with('aktivis')->has('aktivis')->whereYear('created_at', '=', Carbon::parse($date)->format('Y'))
            ->select('id_user', 'id_aktivis', 'tanggal')->get();
