...
class KegiatanKantor implements FromArray, WithHeadings, WithCustomStartCell, WithEvents, WithTitle
{
    ...
    public function registerEvents(): array
    {
        ...
        return [
            AfterSheet::class => function (AfterSheet $event) {
                ...
                $sheet->setCellValue('C5', "KEGIATAN DI LUAR KANTOR(DALAM HARI)");
    ...
    public function array(): array
    {
        ...
        foreach($model as $aktivis){
            ...
            if(isset($kegiatanKantorGroupBy[$aktivis->id])){
                foreach ($kegiatanKantorGroupBy[$aktivis->id]  as $mas) {
