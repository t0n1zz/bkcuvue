    ...
    public function array(): array
    {
        try {
            ...
            if($this->id_tp !='semua'){
                ...
                $model = AppMonitoring::with('cu', 'tp', 'aktivis_cu', 'aktivis_bkcu', 'monitoring_rekom', 'monitoring_pencapaian','monitoring_rekom_ok')->where('id_cu', $this->id_cu)->orderBy('perspektif', 'desc')->get()->toArray();
            }
