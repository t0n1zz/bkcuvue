    ...
    foreach ($this->chunk as $item) {
      ...
      try {
        if ($item['anggota_cu_by_nik'] != null ) {
          ...
          if($item['anggota_cu_by_nik']['status_jalinan'] != null && $item['anggota_cu_by_nik']['name'] == $item['name']){
            $jalinan = true;
          }else{
            $jalinan = false;
          }
        ...
        if ($item['anggota_cu_by_name'] != null) {
          ...
          if($item['anggota_cu_by_name']['status_jalinan'] != null && $item['anggota_cu_by_name']['name'] == $item['name']){
            $jalinan = true;
          }else{
            $jalinan = false;
          }
       ...
       if(!$jalinan){
        ...
        if ($sp_anggota || $anggota || $rek_anggota) {
          if (!$anggotaCuByName && !$anggotaCuByNik) {
            ...
            if ($anggotaCuByName) {
              // if($item['anggota_cu_by_name']['name'] == $item['name']){
              ...
              // if($item['anggota_cu_by_nik']['name'] == $item['name']){
