...
class PublicController extends Controller
{
	...
	public function artikelLihat($slug)
	{
		...
		$artikelGambar = \Storage::disk('s3')->temporaryUrl('images/artikel/' . $artikel->gambar . '.jpg', Carbon::now()->addMinutes(1));
		...
		return view('artikelLihat', compact('artikel', 'artikelsTerkait', 'artikelsBKCUNew', 'artikelsCUNew', 'artikelGambar'));
	}
