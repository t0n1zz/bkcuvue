...
class LaporanCu extends Model {
    ...
    protected $filter = [
        ...
        'cu.name','provinces.name','cu_name','provinces_name','laporan_cu.no_ba','p1','p2','tp'
    ];
