...
class Helper{
	...
	public static function image_processing_no_thumb_png($imagepath, $thumb_width, $thumb_height, $request, $kelas, $name)
	{
		$path = public_path($imagepath);
		$formatedName = '';

		if ($kelas != '' && $request == "no_image") { // no image
			File::delete($path . $kelas . '.png');
		} else {
