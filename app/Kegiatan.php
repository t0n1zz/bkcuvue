...
class Kegiatan extends Model
{
    ...
    protected $allowedFilters = [
        'id', 'id_tempat', 'id_kode', 'name', 'periode', 'durasi', 'mulai', 'selesai', 'status', 'peserta_max', 'peserta_max_cu', 'peserta_min', 'created_at', 'updated_at', 'deleted_at', 'tipe_tempat',
    ...
    {
        return [
            'id_villages' => '', 'id_districts' => '', 'id_regencies' => '', 'id_provinces' => '', 'id_tempat' => '', 'id_kode' => '', 'name' => '', 'kota' => '', 'tipe' => '', 'periode' => '', 'durasi' => '', 'mulai' => '', 'selesai' => '', 'jadwal' => '', 'keterangan' => '', 'status' => '', 'peserta_max' => '', 'peserta_min' => '', 'gambar' => '', 'tipe_tempat' => ''
        ];
    }
