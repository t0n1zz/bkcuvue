...
class Kegiatan extends Model
{
    ...
    protected $fillable = [
        'id_regencies', 'id_districts', 'id_regencies', 'id_provinces', 'id_tempat', 'id_sertifikat', 'id_kode', 'kode_diklat', 'name', 'periode', 'durasi', 'mulai', 'selesai', 'jadwal', 'keterangan', 'keteranganBatal', 'status', 'isSasaran_cu', 'tipe', 'peserta_max', 'peserta_max_cu', 'peserta_min', 'created_at', 'updated_at', 'deleted_at', 'gambar', 'tipe_tempat', 'keputusan_cu', 'keputusan_user', 'pertanyaan_cu', 'pertanyaan_user'
    ];

    protected $allowedFilters = [
        'id', 'id_tempat', 'id_kode', 'kode_diklat', 'name', 'periode', 'durasi', 'mulai', 'selesai', 'status',
        'isSasaran_cu', 'peserta_max', 'peserta_max_cu', 'peserta_min', 'created_at', 'updated_at', 'deleted_at', 'tipe_tempat',

        'villages.name', 'districts.name', 'regencies.name', 'provinces.name', 'tempat.name'
    ];

    protected $orderable = [
        'id', 'id_tempat', 'kode_diklat', 'name', 'periode', 'durasi', 'mulai', 'selesai', 'status',
        'isSasaran_cu', 'peserta_max', 'peserta_max_cu', 'peserta_min', 'created_at', 'updated_at', 'deleted_at', 'tipe_tempat',
    ...
    {
        return [
            'id_villages' => '', 'id_districts' => '', 'id_regencies' => '', 'id_provinces' => '', 'id_tempat' => '', 'kode_diklat' => '', 'name' => '', 'kota' => '', 'tipe' => '', 'periode' => '', 'durasi' => '', 'mulai' => '', 'selesai' => '', 'jadwal' => '', 'keterangan' => '', 'status' => '', 'isSasaran_cu' => '', 'peserta_max' => '', 'peserta_min' => '', 'gambar' => '', 'tipe_tempat' => ''
        ];
    }
