                        ...
                        _c("div", { staticClass: "col-md-12" }, [
                          _c(
                            "div",
                            {
                              staticClass: "form-group",
                              class: {
                                "has-error": _vm.errors.has("form.pengirim"),
                              },
                            },
                            [
                              _c(
                              ...
                              _c("input", {
                                ...
                                domProps: { value: _vm.form.pengirim },
                                on: {
                                  input: function ($event) {
                                    if ($event.target.composing) {
                                      return
                                ...
                                ? _c(
                                    ...
                                    [
                                      ...
                                      _vm._v(
                                        " " +
                                          _vm._s(
                                            _vm.errors.first("form.pengirim")
                                          ) +
                                          "\n\t\t\t\t\t\t\t\t\t\t"
                                      ),
                                    ]
                          ...
                          _c(
                            ...
                            [
                              _c(
                                ...
                                [
                                  _vm.errors.has("form.terima_melalui")
                                    ? _c("i", { staticClass: "icon-cross2" })
                                    : _vm._e(),
                                  _vm._v(
                                    "\n\t\t\t\t\t\t\t\t\t\t\tTerima Melalui:"
                              ...
                              _c("input", {
                                ...
                                attrs: {
                                  ...
                                  name: "terima_melalui",
                                  placeholder:
                                    "Silahkan masukkan terima melalui",
                                  "data-vv-as": "terima_melalui",
                                },
                                domProps: { value: _vm.form.terima_melalui },
                                on: {
                                  input: function ($event) {
                                    if ($event.target.composing) {
                                      return
                        ...
                        _c("div", { staticClass: "col-md-6" }, [
                          _c(
                            "div",
                            {
                              staticClass: "form-group",
                              class: {
                                "has-error": _vm.errors.has("form.tgl_terima"),
                              },
                            },
                            [
                              _c(
                                "h5",
                                {
                                  class: {
                                    "text-danger":
                                      _vm.errors.has("form.tgl_terima"),
                                  },
                                },
                                [
                                  _vm.errors.has("form.tgl_terima")
                              ...
                              _c("date-picker", {
                                attrs: {
                                  defaultDate: _vm.form.tgl_terima,
                                  "data-vv-as": "tgl_terima",
                                },
                                on: {
                                  dateSelected: function ($event) {
                                    _vm.form.tgl_terima = $event
                                  },
                                },
                                model: {
                                  value: _vm.form.tgl_terima,
                                  callback: function ($$v) {
                                    _vm.$set(_vm.form, "tgl_terima", $$v)
                                  },
                                  expression: "form.tgl_terima",
                                },
                              }),
                              _vm._v(" "),
                              _vm.errors.has("form.tgl_terima")
                                ? _c(
                                    ...
                                    [
                                      ...
                                      _vm._v(
                                        " " +
                                          _vm._s(
                                            _vm.errors.first("form.tgl terima")
                                          ) +
                                          "\n\t\t\t\t\t\t\t\t\t\t"
                                      ),
                                    ]
                        ...
                        _c("div", { staticClass: "col-md-12" }, [
                          _c(
                            "div",
                            {
                              staticClass: "form-group",
                              class: {
                                "has-error": _vm.errors.has("form.keterangan"),
                              },
                            },
                            [
                              _c(
                                "h5",
                                {
                                  class: {
                                    "text-danger":
                                      _vm.errors.has("form.keterangan"),
                                  },
                                },
                                [
                                  _vm.errors.has("form.keterngan")
                                    ? _c("i", { staticClass: "icon-cross2" })
                                    : _vm._e(),
                                  _vm._v(
                                    "\n\t\t\t\t\t\t\t\t\t\t\tKeterangan: "
                                ...
                                ? _c(
                                    ...
                                    [
                                      ...
                                      _vm._v(
                                        " " +
                                          _vm._s(
                                            _vm.errors.first("form.keterangan")
                                          ) +
                                          "\n\t\t\t\t\t\t\t\t\t\t"
                                      ),
                                    ]
