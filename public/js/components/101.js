...
var render = function render() {
  ...
  }) : _vm._e(), _vm._v(" "), _vm.$route.meta.mode != "jalan" && _vm.$route.meta.mode != "diikuti" ? _c("select-data", {
    attrs: {
      kelas: _vm.kelas
    }
  ...
  return _c("div", [_c("data-viewer", {
    ...
    scopedSlots: _vm._u([{
      ...
      fn: function fn(props) {
        return [_c("div", {
        ...
        }, [_c("li", [_vm._v("Mulai: "), _c("span", {
          staticClass: "text-muted"
        }, [_vm._v(_vm._s(_vm._f("date")(props.item.mulai)))])]), _vm._v(" "), _c("li", [_vm._v("Selesai: "), _c("span", {
          staticClass: "text-muted"
        }, [_vm._v(_vm._s(_vm._f("date")(props.item.selesai)))])]), _vm._v(" "), _c("li", [_vm._v("Durasi: "), _c("span", {
          staticClass: "text-muted"
        }, [_c("check-value", {
          attrs: {
            value: props.item.durasi
          }
        }), _vm._v(" jam")], 1)])])]), _vm._v(" "), _c("div", {
          staticClass: "col-sm-6"
        }, [_c("ul", {
          staticClass: "list list-unstyled mb-1"
          ...
          staticClass: "text-muted"
        }, [_vm._v("Belum ditentukan tempat")])], 1), _vm._v(" "), _c("li", [_vm._v("Kabupaten/Kota: "), props.item.regencies ? _c("check-value", {
          staticClass: "text-muted",
          attrs: {
            value: props.item.regencies.name
          }
          ...
          staticClass: "text-muted"
        }, [_vm._v("-")])], 1), _vm._v(" "), _c("li", [_vm._v("Provinsi: "), props.item.provinces ? _c("check-value", {
          staticClass: "text-muted",
          attrs: {
            value: props.item.provinces.name
          }
