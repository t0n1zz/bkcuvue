    ...
    modalConfirmOpen: function modalConfirmOpen(state, isMobile, itemMobile) {
      ...
      if (state == "hapus") {
        if (this.selectedItem.status_jalinan == null) {
          ...
          this.modalTitle = "Maaf " + this.title + " " + this.selectedItem.name + " tidak bisa dihapus karena memiliki riwayat klaim JALINAN, silahkan periksa kembali lagi.";
        }
                ...
                : _c("div", [
                    _c(
                      ...
                      [
                        ...
                        _vm._v(" "),
                        _vm._l(_vm.selectedItem.anggota_cu_cu_keluar, function(
                          cu,
                          index
                        ) {
                          return _c(
