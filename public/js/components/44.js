...
/* harmony import */ var _api_kegiatanBKCU__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../../api/kegiatanBKCU */ "./resources/assets/js/api/kegiatanBKCU.js");
function ownKeys(object, enumerableOnly) { var keys = Object.keys(object); if (Object.getOwnPropertySymbols) { var symbols = Object.getOwnPropertySymbols(object); enumerableOnly && (symbols = symbols.filter(function (sym) { return Object.getOwnPropertyDescriptor(object, sym).enumerable; })), keys.push.apply(keys, symbols); } return keys; }
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  watch: {
    ...
    kegiatanTerbaruDataStat: function kegiatanTerbaruDataStat(value) {
      if (value == 'success') {
  ...
  methods: {
    ...
    getKegiatanTerbaru: function getKegiatanTerbaru() {
      var _this2 = this;

      this.kegiatanTerbaruDataStat = 'loading';
      _api_kegiatanBKCU__WEBPACK_IMPORTED_MODULE_5__["default"].getKegiatanTerbaru().then(function (response) {
        _this2.kegiatanTerbaruData = response.data.model;
        _this2.kegiatanTerbaruDataStat = 'success';
      })["catch"](function (error) {
        _this2.kegiatanTerbaruData = error.response;
        _this2.kegiatanTerbaruDataStat = 'fail';
      });
    },
    getNews: function getNews() {
      ...
      _api_artikelSimo__WEBPACK_IMPORTED_MODULE_4__["default"].get().then(function (response) {
        _this3.newsData = response.data.model;
        _this3.newsDataStat = 'success';
      })["catch"](function (error) {
        _this3.newsData = error.response;
        _this3.newsDataStat = 'fail';
      });
    },
