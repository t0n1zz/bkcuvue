...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  data: function data() {
    ...
    return _ref = {
      ...
      votingWidgetRoute: {}
    }, _defineProperty(_ref, "produkCuWidgetRoute", {}), _defineProperty(_ref, "mitraPerseoranganWidgetRoute", {}), _defineProperty(_ref, "mitraLembagaWidgetRoute", {}), _defineProperty(_ref, "userWidgetRoute", {}), _defineProperty(_ref, "laporanCUWidgetRoute", {}), _defineProperty(_ref, "laporanGerakanWidgetRoute", {}), _defineProperty(_ref, "assesmentAccessWidgetRoute", {}), _defineProperty(_ref, "monitoringAccessWidgetRoute", {}), _defineProperty(_ref, "dokumenPUSKOPCUINAWidgetRoute", {}), _defineProperty(_ref, "dokumenWidgetRoute", {}), _defineProperty(_ref, "asetTetapWidgetRoute", {}), _ref;
  },
  ...
  methods: {
    countWidgetRoute: function countWidgetRoute() {
      ...
      this.dokumenPUSKOPCUINAWidgetRoute = {
        name: 'dokumenPus',
        params: {
          cu: '0'
        }
...
var render = function() {
  ...
  return _c("div", { staticClass: "row" }, [
    ...
    _c(
      "div",
      {
        ...
        on: {
          click: function($event) {
            $event.preventDefault()
            return _vm.goTo(_vm.dokumenPUSKOPCUINAWidgetRoute)
          }
        }
      },
      [
    ...
    _vm._v(" "),
    _vm.currentUser.can && _vm.currentUser.can["index_dokumen"]
      ? _c(
          "div",
          {
            staticClass: "col-lg-2 col-md-3 col-sm-6 col-6 cursor-pointer",
