...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    uploadDraft: function uploadDraft(tipe) {
...
var render = function() {
  ...
  return _c(
    ...
    [
      ...
      _c("singleFileUpload", {
        ref: "formDiklat",
        attrs: { title: "DATA_DIKLAT" },
        on: {
          LoadingStat: _vm.setLoadingStat,
          fileSelected: _vm.setFileCount,
          fileBatal: function($event) {
            return _vm.remove("DATA_DIKLAT")
          }
        }
      }),
      _vm._v(" "),
      ...
      _c("div", { staticClass: "container-fluid" }, [
        ...
        _vm.currentUser.id_cu == 0
          ? _c("input", {
              staticClass: "btn btn-danger btn-sm",
              staticStyle: { "margin-left": "10px", "margin-bottom": "10px" },
              attrs: { type: "button", value: "Batch Upload Ke Draft" },
              on: {
                click: function($event) {
                  $event.preventDefault()
                  return _vm.uploadDraft("batch")
                }
              }
            })
          : _vm._e(),
