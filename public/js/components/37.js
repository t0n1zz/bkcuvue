      ...
      if (this.state != "tambahPeserta" && this.state != "ubahPeserta") {
        if (value == "success") {
          if (this.checkPesertaData) {
            ...
            if (!this.currentUser.can["update_diklat_bkcu"] || !this.currentUser.can["destroy_diklat_bkcu"] || !this.currentUser.can["update_pertemuan_bkcu"] || !this.currentUser.can["destroy_pertemuan_bkcu"]) {
              this.modalOpen("pesertaTidakTerdaftar");
            }
          }
        }
  ...
  methods: {
    ...
    modalOpen: function modalOpen(state, isMobile, itemMobile) {
      ...
      if (state == "hapusPertemuan") {
        ...
        } else if (this.itemDataPesertaTerdaftar.data.length >= this.item.peserta_max_cu && this.currentUser.id_cu != 0) {
          this.modalState = "content-tutup";
          this.modalColor = "";
    ...
    modalBackgroundClick: function modalBackgroundClick() {
      ...
      } else if (this.state == "pesertaTidakTerdaftar" && this.item.tipe_tempat == "ONLINE" && !(this.currentUser.can["update_diklat_bkcu"] || this.currentUser.can["update_pertemuan_bkcu"])) {
        this.$router.push({
          name: "dashboard"
        });
      } else {
                        ...
                        _c("tbody", [
                          ...
                          _c("tr", [
                            ...
                            _c("td", { staticClass: "text-right" }, [
                              _vm._v(
                                "\n                        " +
                                  _vm._s(_vm.item.peserta_max_cu) +
                                  " orang\n                      "
                              ),
                            ]),
                          ]),
                      ...
                      _c("div", { staticClass: "nav-tabs-responsive" }, [
                        _c(
                          ...
                          [
                            ...
                            _vm._v(" "),
                            this.item.pilih && this.item.pilih.length > 0
                              ? _c("li", { staticClass: "nav-item" }, [
                                  _c(
                                    "a",
                                    {
