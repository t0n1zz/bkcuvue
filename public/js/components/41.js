...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  watch: {
    ...
    itemEvaluasiFormStatS: function itemEvaluasiFormStatS(value) {
      if (value == 'success') {
        var seenIds = new Set();

        var _iterator4 = _createForOfIteratorHelper(this.itemEvaluasiFormS),
            _step4;
  ...
  methods: {
    ...
    changeDataForm: function changeDataForm(event) {
    ...
    modalConfirmOk: function modalConfirmOk() {
      ...
      if (this.state == 'hapusPanitia') {
        ...
        this.selectedItemPanitia = {};
      } else if (this.state == 'evaluasi') {// do nothing
      } else {
        if (this.$route.meta.isDetail) {
          this.$router.push({
            name: this.kelas + 'Detail',
                        ...
                        _c(
                          ...
                          [
                            ...
                            _c("option", { attrs: { value: "0" } }, [
                              _vm._v("Tidak menggunakan sertifikat"),
                            ]),
                            _vm._v(" "),
                            _vm._l(
                              _vm.itemData.data,
                  ...
                  _c("div", { staticClass: "card" }, [
                    _c("div", { staticClass: "card-header bg-white" }, [
                      _c(
                        "h5",
                        { staticClass: "card-title" },
                        [_vm._v("5. Form Evaluasi "), _c("wajib-badge")],
                        1
                      ),
                    ]),
                    _vm._v(" "),
                        ...
                        _c(
                          "select",
                          {
                            directives: [
                              {
                                name: "model",
                                rawName: "v-model",
                                value: _vm.form.evaluasi_id,
                                expression: "form.evaluasi_id",
                              },
                              {
                                name: "validate",
                                rawName: "v-validate",
                            ...
                            on: {
                              change: [
                                ...
                                function ($event) {
                                  return _vm.changeDataForm($event.target.value)
                                },
                              ],
                            },
                          },
                          [
                            _c(
                              ...
                              { attrs: { disabled: "", value: "" } },
                              [
                                _vm.itemEvaluasiFormStatS === "loading"
                                  ? _c("span", [_vm._v("Mohon tunggu...")])
                                  : _c("span", [
                                      _vm._v("Silahkan pilih form evaluasi"),
                                    ]),
                              ]
                            ),
                            _vm._v(" "),
                            _c("option", { attrs: { value: "0" } }, [
                              _vm._v("Form Evaluasi Baru"),
                            ]),
                            _vm._v(" "),
                            _c(
                              "option",
                            ...
                            _vm._v(" "),
                            _vm._l(_vm.itemDataForm, function (data, index) {
                              return _c(
                                "option",
                                {
                                  key: index,
                                  domProps: { value: data.kegiatan_id },
                                },
                                [
                                  _vm._v(
                                    "\n\t\t\t\t\t\t\t\t\t\tForm Evaluasi " +
                                      _vm._s(data.kegiatan_name) +
                                      "\n\t\t\t\t\t\t\t\t\t"
                                  ),
                                ]
                              )
                    ...
                    _vm.form.evaluasi_id === "0"
                      ? _c("div", { staticClass: "card-body" }, [
                          _c("div", { staticClass: "row" }, [
                            _c(
                              ...
                              _vm._l(_vm.pertanyaan, function (per, p) {
                                return _c(
                                  "div",
                                  {
                                    key: p,
                                            ...
                                            [
                                              ...
                                              _c("input", {
                                                ...
                                                attrs: {
                                                  type: " text",
                                                  placeholder:
                                                    "Silahkan masukkan nama pertanyaan",
                                                },
                                                domProps: { value: per.name },
                                                on: {
                                                  input: function ($event) {
                                                    if (
                      ...
                      : _vm._e(),
                    _vm._v(" "),
                    _vm.form.evaluasi_id !== "0" && !_vm.form.evaluasi_id == ""
                      ? _c("div", { staticClass: "card-body" }, [
                          _c("div", { staticClass: "row" }, [
                            _c(
                              "form",
                              ...
                              _vm._l(_vm.itemEvaluasiFormS, function (per, p) {
                                return _c(
                                  "div",
                                  {
                                    key: p,
                                  ...
                                  [
                                    per.kegiatan_id == _vm.form.evaluasi_id
                                      ? _c("div", { staticClass: "row" }, [
                                          _c(
                                            "div",
                                            { staticClass: "col-md-6" },
