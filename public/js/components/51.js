...
var render = function () {
  ...
  return _c("div", { staticClass: "row" }, [
    ...
    _vm.currentUser.can && _vm.currentUser.can["index_monitoring"]
      ...
      : _vm._e(),
    _vm._v(" "),
    _vm.currentUser.can && _vm.currentUser.can["index_monitoring_cu"]
      ? _c(
          "div",
          {
            staticClass: "col-lg-2 col-md-3 col-sm-6 col-6 cursor-pointer",
            on: {
              click: function ($event) {
                $event.preventDefault()
                return _vm.goTo(_vm.monitoringCuWidgetRoute)
              },
            },
          },
          [
