...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  data: function data() {
    ...
    return _ref = {
      ...
      votingWidgetRoute: {}
    }, _defineProperty(_ref, "produkCuWidgetRoute", {}), _defineProperty(_ref, "mitraPerseoranganWidgetRoute", {}), _defineProperty(_ref, "mitraLembagaWidgetRoute", {}), _defineProperty(_ref, "userWidgetRoute", {}), _defineProperty(_ref, "laporanCUWidgetRoute", {}), _defineProperty(_ref, "laporanGerakanWidgetRoute", {}), _defineProperty(_ref, "assesmentAccessWidgetRoute", {}), _defineProperty(_ref, "assesmentCulegWidgetRoute", {}), _defineProperty(_ref, "monitoringAccessWidgetRoute", {}), _defineProperty(_ref, "dokumenGerakanPublikWidgetRoute", {}), _defineProperty(_ref, "dokumenWidgetRoute", {}), _defineProperty(_ref, "suratKeluarWidgetRoute", {}), _defineProperty(_ref, "suratMasukWidgetRoute", {}), _defineProperty(_ref, "asetTetapWidgetRoute", {}), _defineProperty(_ref, "kubnWidgetRoute", {}), _defineProperty(_ref, "kombasWidgetRoute", {}), _defineProperty(_ref, "enterpreneurWidgetRoute", {}), _defineProperty(_ref, "umkmWidgetRoute", {}), _ref;
  },
...
var render = function () {
  ...
  return _c("div", { staticClass: "row" }, [
    ...
    _vm.currentUser.can && _vm.currentUser.can["index_assesment_access"]
      ...
      : _vm._e(),
    _vm._v(" "),
    _vm.currentUser.can && _vm.currentUser.can["index_assesment_culeg"]
      ? _c(
          "div",
          {
            staticClass: "col-lg-2 col-md-3 col-sm-6 col-6 cursor-pointer",
    ...
    _vm.currentUser.can && _vm.currentUser.can["index_kubn"]
      ...
      : _vm._e(),
    _vm._v(" "),
    _vm.currentUser.can && _vm.currentUser.can["index_enterpreneur"]
      ? _c(
          "div",
          {
            staticClass: "col-lg-2 col-md-3 col-sm-6 col-6 cursor-pointer",
      ...
      : _vm._e(),
    _vm._v(" "),
    _vm.currentUser.can && _vm.currentUser.can["index_umkm"]
      ? _c(
          "div",
          {
            staticClass: "col-lg-2 col-md-3 col-sm-6 col-6 cursor-pointer",
      ...
      _c("div", { staticClass: "row text-center" }, [
        _vm.currentUser.can["index_cu"] && _vm.currentUser.id_cu == 0
          ? _c(
              ...
              {
                staticClass:
                  "col-lg-2 col-sm-4 col-xs-6 pb-3 cursor-pointer cursor-pointer",
                on: {
                  click: function ($event) {
                    $event.preventDefault()
        ...
        _vm.currentUser.can["index_mitra_lembaga"]
          ...
          : _vm._e(),
        _vm._v(" "),
        _vm.currentUser.can["index_kubn"]
          ? _c(
              "div",
              {
                staticClass: "col-lg-2 col-sm-4 col-xs-6 pb-3 cursor-pointer",
        ...
        _vm.currentUser.can["index_kubn"]
          ...
          : _vm._e(),
        _vm._v(" "),
        _vm.currentUser.can["index_umkm"]
          ? _c(
              "div",
              {
                staticClass: "col-lg-2 col-sm-4 col-xs-6 pb-3 cursor-pointer",
          ...
          : _vm._e(),
        _vm._v(" "),
        _vm.currentUser.can["index_enterpreneur"]
          ? _c(
              "div",
              {
                staticClass: "col-lg-2 col-sm-4 col-xs-6 pb-3 cursor-pointer",
              ...
              [
                ...
                _vm._v(" "),
                _c("h5", { staticClass: "font-weight-semibold mb-0" }, [
                  _vm._v(_vm._s(_vm.countEnterpreneur) + " "),
                  _vm.itemdataStat == "loading"
                    ? _c("i", {
                        staticClass: "icon-spinner2 spinner font-size-xs",
                      })
          ...
          : _vm._e(),
        _vm._v(" "),
        _vm.currentUser.can["index_mentor"]
          ? _c(
              "div",
              {
                staticClass: "col-lg-2 col-sm-4 col-xs-6 pb-3 cursor-pointer",
          ...
          : _vm._e(),
        _vm._v(" "),
        _vm.currentUser.can["index_fasilitator"]
          ? _c(
              "div",
              {
                staticClass: "col-lg-2 col-sm-4 col-xs-6 pb-3 cursor-pointer",
              ...
              [
                ...
                _vm._v(" "),
                _c("h5", { staticClass: "font-weight-semibold mb-0" }, [
                  _vm._v(_vm._s(_vm.countFasilitator) + " "),
                  _vm.itemdataStat == "loading"
                    ? _c("i", {
                        staticClass: "icon-spinner2 spinner font-size-xs",
                      })
...
var staticRenderFns = [
  ...
  function () {
    ...
    var _c = _vm._self._c || _h
    return _c("p", [
      _c("i", { staticClass: "icon-store2 icon-2x d-inline-block text-info" }),
    ])
  },
  function () {
    var _vm = this
    ...
    var _c = _vm._self._c || _h
    return _c("p", [
      _c("i", { staticClass: "icon-hat icon-2x d-inline-block text-info" }),
    ])
  },
  function () {
    var _vm = this
    ...
    var _c = _vm._self._c || _h
    return _c("p", [
      _c("i", { staticClass: "icon-brain icon-2x d-inline-block text-info" }),
    ])
  },
  function () {
    var _vm = this
    ...
    var _c = _vm._self._c || _h
    return _c("p", [
      _c("i", { staticClass: "icon-unlink2 icon-2x d-inline-block text-info" }),
    ])
  },
]
render._withStripped = true
