...
var staticRenderFns = [function () {
  ...
  }, [_vm._v("Anda tidak terdaftar")]), _vm._v(" "), _c("span", [_vm._v("Maaf anda tidak terdaftar dalam pertemuan ini, silahkan pastikan anda sudah mendaftar di pertemuan ini")])]);
}, function () {
  var _vm = this,
    _c = _vm._self._c;
  return _c("div", {
    ...
    staticClass: "alert-heading text-semibold"
  }, [_vm._v("Tidak ada data aktivis")]), _vm._v(" "), _c("span", [_vm._v("Anda tidak bisa melanjutkan karena user anda tidak memiliki informasi aktivis, silahkan tambahkan data aktivis kepada user anda.")])]);
}];
render._withStripped = true;
...
var render = function render() {
  ...
  return _c("div", [_c("data-viewer", {
    ...
    scopedSlots: _vm._u([{
      ...
      fn: function fn(props) {
        ...
        })], 1) : _vm._e(), _vm._v(" "), !_vm.columnDataPesertaTerdaftar[21].hide ? _c("td", [_c("check-value", {
          attrs: {
            value: props.item.kontak
          }
        })], 1) : _vm._e(), _vm._v(" "), !_vm.columnDataPesertaTerdaftar[22].hide ? _c("td", {
          domProps: {
  ...
  }), _vm._v(" Tolak\n        ")]), _vm._v(" "), _vm.selectedItem.status == 3 ? _c("button", {
    staticClass: "btn btn-light mb-1",
    on: {
      click: function click($event) {
        $event.preventDefault();
