...
var render = function render() {
  ...
  return _c("div", [_c("div", {
    ...
    staticClass: "text-right"
  }, [_vm._v(_vm._s(_vm.item.peserta_max) + " orang")])]), _vm._v(" "), _c("tr", [_c("td", {
    staticClass: "font-weight-semibold"
  }, [_vm._v("Peserta Max Per CU:")]), _vm._v(" "), _c("td", {
    staticClass: "text-right"
  }, [_vm._v(_vm._s(_vm.item.peserta_max_cu) + " orang")])])])])]), _vm._v(" "), _c("div", {
    staticClass: "card"
    ...
    scopedSlots: _vm._u([{
      key: "item-desktop",
      fn: function fn(props) {
        return [props.item ? _c("tr", [_c("td", [_vm._v(_vm._s(props.index + 1))]), _vm._v(" "), _c("td", [props.item.gambar ? _c("img", {
  ...
  return _c("div", [_c("data-viewer", {
    ...
    scopedSlots: _vm._u([{
      ...
      fn: function fn(props) {
        ...
        })]), _vm._v(" "), !_vm.columnDataPesertaTerdaftar[2].hide ? _c("td", [props.item.aktivis ? [props.item.aktivis.gambar ? _c("img", {
          staticClass: "img-rounded img-fluid wmin-sm",
          attrs: {
