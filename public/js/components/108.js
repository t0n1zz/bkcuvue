  ...
  return _c("div", [_c("data-viewer", {
    ...
    scopedSlots: _vm._u([{
      ...
      fn: function fn(props) {
        ...
        }, [!_vm.columnData[0].hide ? _c("td", [_vm._v("\n\t\t\t\t\t" + _vm._s(props.index + 1 + (+_vm.itemData.current_page - 1) * +_vm.itemData.per_page + ".") + "\n\t\t\t\t")]) : _vm._e(), _vm._v(" "), !_vm.columnData[1].hide ? _c("td", [props.item.user && props.item.user.aktivis ? _c("check-value", {
          attrs: {
            value: props.item.user.aktivis.name
          }
        }) : props.item.user ? _c("check-value", {
          attrs: {
            value: props.item.user.name
          }
        }) : _c("span", [_vm._v("-")])], 1) : _vm._e(), _vm._v(" "), !_vm.columnData[2].hide ? _c("td", [props.item.user && props.item.user.cu ? _c("check-value", {
          attrs: {
            value: props.item.user.cu.name
          }
        }) : _c("span", [_vm._v("PUSKOPCUINA")])], 1) : _vm._e(), _vm._v(" "), !_vm.columnData[3].hide ? _c("td", [_c("check-value", {
          attrs: {
            value: props.item.status
          }
        })], 1) : _vm._e(), _vm._v(" "), !_vm.columnData[4].hide ? _c("td", [_vm._v("\n\t\t\t\t\t" + _vm._s(props.item.content.substring(0, 100)) + "...\n\t\t\t\t")]) : _vm._e(), _vm._v(" "), !_vm.columnData[5].hide ? _c("td", {
          domProps: {
    ...
    slot: "modal-body1"
  }, [_c("div", [_vm.selectedItem.status == 404 ? _c("span", [_c("b", [_vm._v("ERROR 404:")])]) : _vm.selectedItem.status == 419 ? _c("span", [_c("b", [_vm._v("ERROR 419:")])]) : _vm.selectedItem.status == 422 ? _c("span", [_c("b", [_vm._v("ERROR 422:")])]) : _vm.selectedItem.status == 500 ? _c("span", [_c("b", [_vm._v("ERROR 500:")])]) : _vm._e()]), _vm._v(" "), _c("br"), _vm._v(" "), _c("div", [_c("pre", {
    staticClass: "pre-scrollable language-markup content-group text-left"
  }, [_c("code", [_vm._v(_vm._s(_vm.selectedItem.content))])]), _vm._v(" "), _c("hr")]), _vm._v(" "), _c("div", {
