...
/* harmony import */ var _formKategori_vue__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./formKategori.vue */ "./resources/assets/js/views/artikel/formKategori.vue");
/* harmony import */ var _formPenulis_vue__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./formPenulis.vue */ "./resources/assets/js/views/artikel/formPenulis.vue");
/* harmony import */ var _helpers_auth__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ../../helpers/auth */ "./resources/assets/js/helpers/auth.js");
/* harmony import */ var _helpers_url_js__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ../../helpers/url.js */ "./resources/assets/js/helpers/url.js");
...
/* harmony default export */ __webpack_exports__["default"] = ({
  components: {
    ...
    formKategori: _formKategori_vue__WEBPACK_IMPORTED_MODULE_9__["default"],
    formPenulis: _formPenulis_vue__WEBPACK_IMPORTED_MODULE_10__["default"],
    wajibBadge: _components_wajibBadge_vue__WEBPACK_IMPORTED_MODULE_13__["default"]
  },
  data: function data() {
    return {
      ...
      UploadAdapter: function UploadAdapter(loader) {
        ...
        return {
          upload: function () {
            var _upload = _asyncToGenerator(/*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee() {
              var image, imagePath;
                ...
                while (1) {
                  switch (_context.prev = _context.next) {
                    case 0:
                      ...
                      }; // Example image naming logic
                      _context.next = 4;
                      return _this.$store.dispatch('artikel/uploadImage', {
                        loader: loader,
                        image: image
                      });
                    case 4:
                    ...
                    case 8:
                      ...
                      console.error('Error during image upload:', _context.t0);
                      throw _context.t0;
                    case 12:
                    case "end":
  ...
  computed: _objectSpread(_objectSpread(_objectSpread(_objectSpread(_objectSpread({}, Object(vuex__WEBPACK_IMPORTED_MODULE_1__["mapGetters"])('auth', {
    currentUser: 'currentUser'
  })), Object(vuex__WEBPACK_IMPORTED_MODULE_1__["mapGetters"])('artikel', {
    form: 'data',
    formStat: 'dataStat',
    rules: 'rules',
    options: 'options',
  ...
  })), Object(vuex__WEBPACK_IMPORTED_MODULE_1__["mapGetters"])('artikelKategori', {
    modelKategori: 'dataS',
    modelKategoriStat: 'dataStatS',
    updateKategoriResponse: 'update',
    updateKategoriStat: 'updateStat'
  })), Object(vuex__WEBPACK_IMPORTED_MODULE_1__["mapGetters"])('artikelPenulis', {
    modelPenulis: 'dataS',
