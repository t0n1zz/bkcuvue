...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    changeKodeKegiatan: function changeKodeKegiatan(event) {
      ...
      var selectedItem = this.itemKodeKegiatan.find(function (item) {
        return item.id === Number(_this.form.id_kode);
      });
      ...
      this.$validator.validateAll('form').then(function (result) {
        if (result) {
          if (_this2.$route.meta.mode == 'edit') {
            ...
            _this2.$store.dispatch(_this2.kelas + '/store', [_this2.$route.params.tipe, formData]);
          }
