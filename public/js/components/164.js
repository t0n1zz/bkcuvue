...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  updated: function updated() {// console.log(this.itemDataPanitia); 
  },
  created: function created() {
        ...
        if (Array.isArray(val)) {
          this.pesertaList = val.map(function (peserta) {
            return _objectSpread(_objectSpread({}, peserta), {}, {
              sertifikat_nomor: (peserta === null || peserta === void 0 ? void 0 : peserta.sertifikat_generate.nomor) || '-',
              nama_sertifikat: (peserta === null || peserta === void 0 ? void 0 : peserta.name_sertifikat) || '-'
            });
          });
        }

        console.log(this.pesertaList);
      }
    }
  },
  methods: {
          ...
          _c(
            ...
            [
              ...
              _c("detail-nomor-sertifikat", {
                attrs: { item: this.itemDataPanitia, mode: "panitia" },
                on: { tutup: _vm.modalTutup },
              }),
            ],
            1
        ...
        _c("div", { staticClass: "row" }, [
          _c("table", { staticClass: "table table-bordered" }, [
            ...
            this.mode == "panitia"
              ? _c(
                  "tbody",
                  _vm._l(_vm.item, function (panitia, index) {
                    return _c("tr", { key: index }, [
                      _c("td", [_vm._v(_vm._s(panitia.name))]),
                      _vm._v(" "),
                      _c("td", [_vm._v(_vm._s(panitia.nomor))]),
                    ])
                  }),
                  0
                )
      ...
      _c(
        ...
        [
          ...
          _c(
            ...
            [
              _c("detail-nomor-sertifikat", {
                attrs: { item: this.itemDataPesertaTerdaftar, mode: "peserta" },
                on: { tutup: _vm.modalTutup },
              }),
              _vm._v(" "),
