  ...
  methods: {
    ...
    changeTab: function changeTab(value) {
      ...
      if (value == 'asetDihapus' && !this.isAsetDihapus) {
        this.isAsetDihapus = true; // this.fetchAsetDihapus(this.params);
      } else if (value == 'asetSelesai' && !this.isAsetSelesai) {
        this.isAsetSelesai = true; // this.fetchAsetDihapus(this.params);
      } else if (value == 'asetRusak' && !this.isAsetRusak) {
        this.isAsetRusak = true; // this.fetchAsetDihapus(this.params);
      }
    }
  },
            ...
            switch (_context.prev = _context.next) {
              ...
              case 10:
                if (_this.itemData) {
                  ...
                  file_saver__WEBPACK_IMPORTED_MODULE_2___default.a.saveAs(_this.output, 'aset tetap halaman ' + _this.itemDataH.current_page);
                } else if (_this.itemDataS) {
                  file_saver__WEBPACK_IMPORTED_MODULE_2___default.a.saveAs(_this.output, 'aset tetap halaman ' + _this.itemDataS.current_page);
                }
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  props: ['title', 'kelas', 'tab1', 'tab2', 'tab3'],
  data: function data() {
    return {
      selectedItem: [],
      tabName: 'qrBig',
  ...
  computed: _objectSpread(_objectSpread({}, Object(vuex__WEBPACK_IMPORTED_MODULE_0__["mapGetters"])('auth', {
    ...
    itemDataS: 'dataS3',
    itemDataStat: 'dataStatS',
    itemDataStatH: 'dataStatH',
    itemDataStatS: 'dataStatS4',
                  ...
                  [
                    _c("li", { staticClass: "nav-item" }, [
                      _c(
                        "a",
                        {
                          ...
                          class: { active: _vm.tabName == "asetTetap" },
                          attrs: { href: "#" },
                          on: {
                            click: function ($event) {
                              $event.preventDefault()
                              return _vm.changeTab("asetTetap")
                            },
                          },
                        },
                        [
                          _c("i", { staticClass: "icon-list2 mr-2" }),
                          _vm._v(" Aset Tetap Dalam Penyusutan"),
                        ]
                      ),
                    ]),
                    _vm._v(" "),
                    _c("li", { staticClass: "nav-item" }, [
                      _c(
                        ...
                        {
                          staticClass: "nav-link",
                          class: { active: _vm.tabName == "asetSelesai" },
                          attrs: { href: "#" },
                          on: {
                            click: function ($event) {
                              $event.preventDefault()
                              return _vm.changeTab("asetSelesai")
                            },
                          },
                        },
                        [
                          _c("i", { staticClass: "icon-notebook mr-2" }),
                          _vm._v(" Aset Tetap Penyusutan Selesai"),
                        ]
                      ),
                    ]),
                    _vm._v(" "),
                    _c("li", { staticClass: "nav-item" }, [
                      _c(
                        ...
                        {
                          staticClass: "nav-link",
                          class: { active: _vm.tabName == "asetDihapus" },
                          attrs: { href: "#" },
                          on: {
                            click: function ($event) {
                              $event.preventDefault()
                              return _vm.changeTab("asetDihapus")
                            },
                          },
                        },
                        [
                          _c("i", { staticClass: "icon-books mr-2" }),
                          _vm._v(" Aset Tetap Dihapus Dari Laporan"),
                        ]
                      ),
                    ]),
                  ]
                      ...
                      directives: [
                        {
                          name: "show",
                          rawName: "v-show",
                          value: _vm.tabName == "asetTetap",
                          expression: "tabName == 'asetTetap'",
                        },
                      ],
                    },
                    [
                      ...
                      directives: [
                        {
                          name: "show",
                          rawName: "v-show",
                          value: _vm.tabName == "asetSelesai",
                          expression: "tabName == 'asetSelesai'",
                        },
                      ],
                    },
                    [
                      ...
                      directives: [
                        {
                          name: "show",
                          rawName: "v-show",
                          value: _vm.tabName == "asetDihapus",
                          expression: "tabName == 'asetDihapus'",
                        },
                      ],
                    },
                    [
              ...
              _c(
                ...
                [
                  _c(
                    ...
                    [
                      _vm.currentUser.can &&
                      _vm.currentUser.can["create_aset_tetap"]
                        ? _c(
                            "router-link",
                            {
                      ...
                      _vm._v(" "),
                      _vm.currentUser.can &&
                      _vm.currentUser.can["update_aset_tetap"]
                        ? _c(
                            "button",
                            {
                              staticClass: "btn btn-light mb-1",
                      ...
                      _vm._v(" "),
                      _vm.currentUser.can &&
                      _vm.currentUser.can["destroy_aset_tetap"]
                        ? _c(
                            "button",
                            {
                              staticClass: "btn btn-light mb-1",
              ...
              _c(
                "data-viewer",
                {
                  attrs: {
                    title: _vm.title,
                    columnData: _vm.columnData,
                    itemData: _vm.itemDataS,
                    query: _vm.query,
                    itemDataStat: _vm.itemDataStatS,
                    excelDownloadUrl: _vm.excelDownloadUrl,
                    isUploadExcel: false,
                  },
                  on: { fetch: _vm.fetch },
            ...
            [
              _c(
                "data-viewer",
                {
                  attrs: {
                    title: _vm.title,
                    columnData: _vm.columnDataH,
                    itemData: _vm.itemDataH,
                    query: _vm.query,
                    itemDataStat: _vm.itemDataStatH,
                    excelDownloadUrl: _vm.excelDownloadUrl,
                    isUploadExcel: false,
                  },
                  on: { fetch: _vm.fetch },
                            ...
                            _c(
                              ...
                              [
                                ...
                                !_vm.columnDataH[18].hide
                                  ...
                                  : _vm._e(),
                                _vm._v(" "),
                                !_vm.columnDataH[19].hide
                                  ? _c("td", {
                                      domProps: {
                                        innerHTML: _vm._s(
                                          _vm.$options.filters.dateTime(
                                            props.item.hapus_dari_laporan
                                          )
                                        ),
                                      },
                                    })
          ...
          _c(
            ...
            [
              _c("qr-code-all", {
                attrs: {
                  itemData: _vm.itemData,
                  itemDataH: _vm.itemDataH,
                  itemDataS: _vm.itemDataS,
                  tab1: _vm.tab1,
                  tab2: _vm.tab2,
                  tab3: _vm.tab3,
                },
