        ...
        <div class="postcontent nobottommargin clearfix">
          ...
          <div class="entry clearfix">
            ...
            <ul class="entry-meta clearfix">
              ...
              @if($artikel->kategori)
                <li><a href="{{ route('artikel.kategori',$artikel->kategori->slug) }}"><i class="icon-line-grid"></i>{{ $artikel->kategori->name }}</a></li>
              @else 
                <li><i class="icon-line-grid"></i>{{"-"}}</li> 
              @endif
              @if($artikel->penulis)
                <li><a href="{{ route('artikel.penulis',$artikel->penulis->slug) }}"><i class="icon-user"></i>{{ $artikel->penulis->name }}</a></li>
              @else 
          ...
          <div class="widget widget_links clearfix">
            ...
            <ul>
              @foreach($artikelKategoriList as $item)
                <li><a href="{{ route('artikel.kategori',$item->slug) }}""><div>{{ $item->name }}</div></a></li>
              @endforeach
            </ul>
