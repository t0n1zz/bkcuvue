<div class="card" id="laporanGerakan">
  <div class="card-header bg-white header-elements-inline">
    <h5 class="card-title">18. Laporan Statistik Gerakan</h5>
  ...
  <div class="card-body">	
    ...
    <ol>
      <li><strong>Grafik Statistik Gerakan</strong> grafik interaktif</li>
      <li><strong>Tabel Perkembangan</strong> tabel perkembangan periode terbaru</li>
      <li><strong>Tabel Infografis Gerakan</strong> tabel perkembangan semua periode</li>
    </ol>
