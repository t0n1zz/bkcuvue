<div class="card" id="artikelkategori">
  <div class="card-header bg-white header-elements-inline">
    <h5 class="card-title">8. Kategori Artikel</h5>
  ...
  <div class="card-body">	
    <div class="mb-3 text-center">
      <img src="{{ asset('images/panduan/artikelKategori.png') }}" class="img-thumbnail" alt="">
    </div>
    <p>
        Halaman kategori artikel berguna untuk mengelola semua kategori pada artikel yang ada.
    </p>

    <h6>A. Menambah Kategori Artikel</h6>
    <p>
