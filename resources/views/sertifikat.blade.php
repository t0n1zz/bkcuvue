...
<body>
    <div class="depan">
        ...
        <table style="margin-top: 30px;margin-left: 1100px;">
        ...
        <p class="isi"><span>{{$kegiatan}}</span> bagi Credit Union yang diselenggarakan 
    ...
    <div class="belakang">
        ...
        <table class="table center" style="width: 75%">
            ...
            <tbody>
                ...
                @endforeach
                    <tr>
                        <td colspan="2" class="fontNilai" style="padding-left: 10px; text-align: center">RATA-RATA NILAI / TOTAL JAM</td>
                        <td class="fontNilai" style="padding-left: 10px; text-align: center">{{strVal(round($averageNilai,0))}}</td>
                        ...
                        @endif
                        <td class="fontNilai" style="padding-left: 10px; text-align: center">{{strVal($sumWaktu)}} Jam </td>
                    </tr>
            </tbody>
          </table>
         </div>
