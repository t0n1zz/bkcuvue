export default {
  ...
  indexTp: function (p, id) {
    return axios.get('/api/laporanTp/indexTp/' + id, {
      params: p
    });
  },
  ...
  indexPeriode: function (p, id, periode) {
    return axios.get('/api/laporanTp/indexPeriode/' + id + '/' + periode, {
      params: p
    });
  },
  ...
  indexPearls: function (p) {
    return axios.get('/api/laporanTp/indexPearls', {
      params: p
    });
  },

  indexPearlsTp: function (p, id) {
    return axios.get('/api/laporanTp/indexPearlsTp/' + id, {
      params: p
    });
  },

  indexPearlsPeriode: function (p, id, periode) {
    return axios.get('/api/laporanTp/indexPearlsPeriode/' + id + '/' + periode, {
      params: p
    });
  },
