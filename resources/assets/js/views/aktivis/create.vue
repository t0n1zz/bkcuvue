		...
		<form @submit.prevent="save" enctype="multipart/form-data" data-vv-scope="form">
			...
			<div class="card" v-if="!canEditIdentitas">
				...
				<div class="card-footer bg-white d-flex">
					<button type="button" class="btn btn-light btn-block" @click.prevent="ubahCanEdit()"> <i
							class="icon-pencil5"></i> Edit Identitas</button>
				</div>
			</div>

			<div class="card card-body" v-if="canEditIdentitas && mode == 'create_old'">
				<button type="button" class="btn btn-light btn-block" @click.prevent="ubahCanEdit()"> <i
						class="icon-cross"></i> Batal Edit Identitas</button>
			</div>
			...
			<div class="card" v-if="canEditIdentitas">
					...
					<div class="row">
						...
						<div class="col-md-12">
							<div class="form-group">
								...
								<!-- imageupload -->
								<app-image-upload :image_loc="'/images/aktivis/'" :image_temp="form.gambar"
						...
						<div class="col-md-4" v-if="mode == 'edit' || mode == 'edit_profile'">
							<div class="form-group" :class="{ 'has-error': errors.has('form.nik') }">
								...
								<h6 :class="{ 'text-danger': errors.has('form.nik') }">
									...
									No. KTP: <wajib-badge></wajib-badge>
								</h6>

								<!-- text -->
								<cleave name="nik" v-model="form.nik" class="form-control" :options="cleaveOption.number16"
									placeholder="Silahkan masukkan no KTP" v-validate="'required'" data-vv-as="No. KTP">
								</cleave>
						...
						<div class="col-md-4">
							<div class="form-group">
								...
								<!-- text -->
								<cleave name="nik" v-model="form.nim_cu" class="form-control"
						...
						<div class="col-md-4">
							<div class="form-group">
								...
								<!-- text -->
								<cleave name="nik" v-model="form.npwp" class="form-control" :options="cleaveOption.number24"
						...
						<div class="col-md-4">
							<div class="form-group" :class="{ 'has-error': errors.has('form.name') }">
								...
								<!-- text -->
								<input type="text" name="name" class="form-control" placeholder="Silahkan masukkan nama"
									v-validate="'required'" data-vv-as="Nama" v-model="form.name">
						...
						<div class="col-md-4">
							<div class="form-group" :class="{ 'has-error': errors.has('form.kelamin') }">
								...
								<!-- select -->
								<select class="form-control" name="kelamin" v-model="form.kelamin" data-width="100%"
									v-validate="'required'" data-vv-as="Gender">
						...
						<div class="col-md-4">
							<div class="form-group" :class="{ 'has-error': errors.has('form.tanggal_lahir') }">
								...
								<h6 :class="{ 'text-danger': errors.has('form.tanggal_lahir') }">
									...
									Tgl. Lahir: <wajib-badge></wajib-badge>
								</h6>

								<!-- input -->
								<date-picker @dateSelected="form.tanggal_lahir = $event"
									:defaultDate="form.tanggal_lahir"></date-picker>
								<input v-model="form.tanggal_lahir" v-show="false" v-validate="'required'"
						...
						<div class="col-md-4">
							<div class="form-group" :class="{ 'has-error': errors.has('form.tempat_lahir') }">
								...
								<h6 :class="{ 'text-danger': errors.has('form.tempat_lahir') }">
									<i class="icon-cross2" v-if="errors.has('form.tempat_lahir')"></i>Tempat Lahir:
									<wajib-badge></wajib-badge>
								</h6>

								<!-- text -->
								<input type="text" name="tempat_lahir" class="form-control"
									placeholder="Silahkan masukkan tempat lahir" v-model="form.tempat_lahir"
						...
						<div class="col-md-4">
							<div class="form-group">
								...
								<!-- text -->
								<cleave name="tinggi" v-model="form.tinggi" class="form-control"
									:options="cleaveOption.number3" placeholder="Silahkan masukkan tinggi"></cleave>
				...
				<div class="col-md-12">
					<div class="form-group">
						...
						<!-- title -->
						<h6>Scan Tandatangan:</h6>

						<!-- imageupload -->
						<app-image-upload :image_loc="'/images/ttd/'" :image_temp="form.gambar_ttd"
							v-model="form.gambar_ttd"></app-image-upload>
					</div>
				</div>
			</div>
					...
					<div class="row" v-if="form.keluarga">
						...
						<div class="col-md-4">
							<div class="form-group">
								...
								<input type="text" name="ayah" class="form-control"
									placeholder="Silahkan masukkan nama ayah" v-model="form.keluarga.ayah">
						...
						<div class="col-md-4">
							<div class="form-group">
								...
								<!-- text -->
								<input type="text" name="ibu" class="form-control" placeholder="Silahkan masukkan nama ibu"
									v-model="form.keluarga.ibu">
						...
						<div class="col-md-4" v-if="form.status == 'MENIKAH' || form.status == 'Duda/Janda'">
							<div class="form-group">
								...
								<input type="text" name="pasangan" class="form-control"
									placeholder="Silahkan masukkan nama pasangan" v-model="form.keluarga.pasangan">
								...
								<div class="form-group">
									...
									<div class="input-group">
										...
										<input type="text" name="anak" class="form-control"
											placeholder="Silahkan masukkan nama anak" v-model="anak.name">
			...
			<div class="card" v-if="canEditIdentitas">
				...
				<div class="card-body" v-if="form.anggota_cu">
					<div class="row">
							...
							<div class="row">
								...
								<div class="col-md-4">
									<div class="form-group">
										...
										<div class="input-group">
											...
											<!-- select -->
											<select class="form-control" name="id_cu" v-model="cu.id_cu" data-width="100%"
								...
								<div class="col-md-4" v-if="cu.id_cu == 0">
									<div class="form-group">
										...
										<!-- text -->
										<input type="text" name="anggota_nama" class="form-control"
											placeholder="Silahkan masukkan nama CU" v-model="cu.name">
								...
								<div class="col-md-4">
									<div class="form-group">
										...
										<!-- text -->
										<input type="text" name="anggota_no_ba" class="form-control"
											placeholder="Silahkan masukkan no BA anggota CU" v-model="cu.no_ba">
								...
								<div class="col-md-4">
									<div class="form-group">
										...
										<!-- text -->
										<date-picker @dateSelected="cu.tanggal_masuk = $event"
											:defaultDate="cu.tanggal_masuk"></date-picker>
						...
						<div class="col-md-12">
							<button class="btn btn-light btn-block" @click.prevent="addCU()"><i
									class="icon-plus3"></i>Tambah Keanggotan di CU
							</button>
						</div>
					...
					<div class="row">
						...
						<div class="col-sm-12" v-if="currentUser.id_cu == 0">
							<div class="form-group" :class="{ 'has-error': errors.has('form.pekerjaan.id_tempat') }">
								...
								<!-- select -->
								<select class="form-control" name="id_tempat" v-model="form.pekerjaan.id_tempat"
									data-width="100%" v-validate="'required'" data-vv-as="Tempat pekerjaan"
									:disabled="modelCu.length == 0" @change="changeLembagaPekerjaan($event.target.value)">
									<option disabled value="">
										<span v-if="modelCuStat === 'loading'">Mohon tunggu...</span>
						...
						<div class="col-md-12" v-if="form.pekerjaan.id_tempat != ''">
							<div class="form-group">
								...
								<!-- select -->
								<select name="status" data-width="100%" class="form-control"
									v-model="form.pekerjaan.status">
						...
						<div class="col-sm-12" v-if="form.pekerjaan.status != ''">
							<div class="form-group" :class="{ 'has-error': errors.has('form.pekerjaan.tingkat') }">
								...
								<!-- select -->
								<select class="form-control" name="pekerjaan_tingkat" v-model="form.pekerjaan.tingkat"
									data-width="100%" v-validate="'required'" data-vv-as="Tingkat Pekerjaan">
									...
									<option value="7">Supervisor (Kepala Bagian, Kepala Divisi, Kepala/Koordinator TP,
						...
						<div class="col-sm-12" v-if="form.pekerjaan.tingkat != ''">
							<div class="form-group" :class="{ 'has-error': errors.has('form.pekerjaan.name') }">
								...
								<input type="text" name="jabatan" class="form-control"
									placeholder="Silahkan masukkan nama jabatan" v-validate="'required|min:5'"
									data-vv-as="Jabatan pekerjaan" v-model="form.pekerjaan.name">
						...
						<!-- tp -->
						<div class="col-sm-12"
							v-if="form.pekerjaan.tipe == 1 && form.pekerjaan.tingkat != '1' && form.pekerjaan.tingkat != '2' && form.pekerjaan.tingkat != '3' && form.pekerjaan.tingkat != '4' && form.pekerjaan.tingkat != ''">
							<div class="form-group" :class="{ 'has-error': errors.has('form.pekerjaan.id_tp') }">
								...
								<!-- select -->
								<select class="form-control" name="id_tp" v-model="form.pekerjaan.id_tp" data-width="100%"
									v-validate="'required'" data-vv-as="TP/KP">
									<option disabled value="">
									...
									<template v-if="modelTp">
										<option v-for="(tp, index) in modelTp" :value="tp.id" :key="index">{{ tp.name }}
										</option>
									</template>
								</select>
						...
						<div class="col-sm-12" v-if="form.pekerjaan.tingkat != ''">
							<div class="form-group" :class="{ 'has-error': errors.has('form.pekerjaan.mulai') }">
								...
								<!-- input -->
								<date-picker @dateSelected="form.pekerjaan.mulai = $event"
									:defaultDate="form.pekerjaan.mulai"></date-picker>
								<input v-model="form.pekerjaan.mulai" v-show="false" v-validate="'required'"
						...
						<!-- tanggal selesai -->
						<div class="col-sm-12"
							v-if="form.pekerjaan.status != '' && form.pekerjaan.tingkat != '' && form.pekerjaan.status != '1'">
							<div class="form-group">
								...
								<!-- input -->
								<date-picker @dateSelected="form.pekerjaan.selesai = $event"
									:defaultDate="form.pekerjaan.selesai"></date-picker>

								<small class="text-muted">Kosongkan apabila masih bekerja / tidak memiliki periode
									selesai</small>
							</div>
						</div>
						...
						<!-- keterangan -->
						<div class="col-sm-12"
							v-if="form.pekerjaan.status != '' && form.pekerjaan.tingkat != '' && form.pekerjaan.status == '3'">
							<div class="form-group">
								...
								<!-- text -->
								<input type="text" name="keterangan_tidak_aktif" class="form-control"
									placeholder="Silahkan masukkan keterangan tidak bekerja"
									v-model="form.pekerjaan.keterangan_tidak_aktif">
			...
			<div class="card card-body">
				<form-button :cancelState="''" :formValidation="'form'" :confirmIcon="confirmIcon"
					:confirmTitle="confirmTitle" v-if="mode == 'edit_profile'"></form-button>
				<form-button :cancelState="'methods'" :formValidation="'form'" :confirmIcon="confirmIcon"
					:confirmTitle="confirmTitle" @cancelClick="back" v-else></form-button>
			</div>
