	...
	<div>
		...
		<app-modal :show="modalShow" :state="modalState" :title="modalTitle" :content="modalContent" :color="modalColor" @batal="modalTutup" @tutup="modalTutup" @confirmOk="modalConfirmOk" @successOk="modalTutup" @failOk="modalTutup"  @backgroundClick="modalTutup">
			 ...
			 <template slot="modal-body1">
				 <!-- form pekerjaan -->
					<form-pekerjaan :selected="formModel" :formState="formState" @tutup="modalTutup" v-if="formState == 'create pekerjaan' || formState == 'edit pekerjaan'"></form-pekerjaan>

					<!-- form pendidikan -->
					<form-pendidikan :selected="formModel" :formState="formState" @tutup="modalTutup" v-if="formState == 'create pendidikan' || formState == 'edit pendidikan'"></form-pendidikan>

					<!-- form organisasi -->
					<form-organisasi :selected="formModel" :formState="formState" @tutup="modalTutup" v-if="formState == 'create organisasi' || formState == 'edit organisasi'"></form-organisasi>

					<!-- form diklat -->
					<form-diklat :selected="formModel" :formState="formState" @tutup="modalTutup" v-if="formState == 'create diklat' || formState == 'edit diklat'"></form-diklat>
			 </template>
	...
	export default {
		...
		methods: {
			fetch(){
				...
				this.$store.dispatch(this.kelas + '/indexDiklat',[this.$route.params.id, this.$route.params.cu]);
			},
			back(){
