            ...
            <div class="col-md-12">
                <div class="form-group">
                    ...
                    <div v-if="title == 'TERLAMBAT'">
                        <div style="color: red;">PASTIKAN ANDA MENGISI ALASAN KETERLAMBATAN, JIKA TIDAK MAKA AKAN DIANGGAP
                            TERLAMBAT TANPA ALASAN,</div>
                        <div style="color: red;">ANDA DAPAT MENGISI ALASAN KETERLAMBATAN PADA MENU ORGANISASI ->ABSEN
                            ->DAFTAR KETERLAMBATAN</div>
                    </div>
                    <div v-else-if="title == 'PULANG AWAL'">
                        <div style="color: red;">PASTIKAN ANDA MENGISI ALASAN PULANG AWAL DENGAN JELAS, JIKA TIDAK MAKA AKAN
                            DIANGGAP TANPA ALASAN</div>
                    </div>
                </div>
                <div class="text-center">
                    ...
                    <button :disabled="form.alasan == '' || form.alasan.length < 5" type="submit" value="submit"
