									...
									<div class="col-md-6">
										<div class="form-group" :class="{'has-error' : errors.has('form.kode_diklat')}">
											...
											<h5 :class="{ 'text-danger' : errors.has('form.kode_diklat')}">
												...
												Kode Pertemuan: <wajib-badge></wajib-badge></h5>

											<!-- text -->
											<input type="text" name="kode_diklat" class="form-control" placeholder="Silahkan masukkan kode pertemuan" v-validate="'required|min:5'" data-vv-as="Kode Pertemuan" v-model="form.kode_diklat">
