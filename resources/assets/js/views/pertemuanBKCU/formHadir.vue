				...
				<div class="card-body">
					<div class="media mt-0 mb-0">
						...
						<div class="media-body">
							...
							<br />
							<b>Tingkat:</b>
							{{ currentUser.aktivis && currentUser.aktivis.pekerjaan_aktif ? $options.filters.checkTingkatAktivis(currentUser.aktivis.pekerjaan_aktif.tingkat) : '' }}
							<br/>
							<b>Jabatan:</b>
