<template>
	<div>
		<!-- message -->
		<message v-if="errors.any('formKeputusan') && submited" :title="'Oops, terjadi kesalahan'" :errorItem="errors.items">
		</message>
				...
				<div class="form-group mb-0">
					...
					<div class="form-check form-check-inline">
						<label class="form-check-label">
							<input type="radio" class="form-check-input" value="1" v-model="formKeputusan.pilih[p.id]" :name="p.id" >
							Setuju
						</label>
					</div>
					...
					<div class="form-check form-check-inline">
						<label class="form-check-label">
							<input type="radio" class="form-check-input" value="2" v-model="formKeputusan.pilih[p.id]"  :name="p.id">
							Tidak Setuju
						</label>
					</div>
					...
					<div class="form-check form-check-inline">
						<label class="form-check-label">
							<input type="radio" class="form-check-input" value="3" v-model="formKeputusan.pilih[p.id]" :name="p.id">
      ...
      <div class="form-group">
        ...
        <!-- textarea -->
				<ckeditor type="classic" :config="ckeditorNoImageConfig" v-model="formKeputusan.keterangan"></ckeditor>
				...
				this.$validator.validateAll('formKeputusan').then((result) => {
					if (result) {
						if(this.mode == 'edit'){
							...
							this.$store.dispatch('pertemuanBKCU/updateKeputusan', [this.formKeputusan.id, this.formKeputusan]);
						}else{
							this.formKeputusan.id_user = this.currentUser.id;
							this.formKeputusan.id_cu = this.currentUser.id_cu;
							this.$store.dispatch('pertemuanBKCU/storeKeputusan', [this.kegiatan_id, this.formKeputusan]);
						}
					}else{
						this.submited = true;
					}	
