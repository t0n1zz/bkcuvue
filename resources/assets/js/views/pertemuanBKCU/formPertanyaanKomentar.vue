  ...
  import checkValue from '../../components/checkValue.vue';
	...
	export default {
      ...
      fetchKomentar(params){
        this.$store.dispatch('pertemuanBKCU/indexPertanyaanKomentar', [params, this.selected.id]);
      },
      save(){
              ...
              this.formKomentar.id_user = this.currentUser.id;
							this.$store.dispatch('pertemuanBKCU/updatePertanyaanKomentar', [this.formKomentar.id, this.formKomentar]);
						}else{
              this.formKomentar.id_user = this.currentUser.id;
							this.formKomentar.id_cu = this.currentUser.id_cu;
							this.$store.dispatch('pertemuanBKCU/storePertanyaanKomentar', [this.kegiatan_id, this.formKomentar]);
            }
					}else{
						this.submited = true;
					}	
      ...
      hapus(){
        this.$store.dispatch('pertemuanBKCU/destroyPertanyaanKomentar', this.selectedKomentar.id);
      },
      calculatePagination() {
        var i = 0;
        var startPage = 0;
