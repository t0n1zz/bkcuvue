  ...
  import checkValue from '../../components/checkValue.vue';
	...
	export default {
      ...
      checkValue
		...
		created() {
      this.formKomentar.kegiatan_tanggapan_id = this.selected.id;
      ...
      fetchKomentar(params){
        this.$store.dispatch('pertemuanBKCU/indexKomentar', [params, this.selected.id]);
      },
      save(){
              ...
              this.formKomentar.id_user = this.currentUser.id;
							this.$store.dispatch('pertemuanBKCU/updateKomentar', [this.formKomentar.id, this.formKomentar]);
						}else{
              this.formKomentar.id_user = this.currentUser.id;
							this.formKomentar.id_cu = this.currentUser.id_cu;
							this.$store.dispatch('pertemuanBKCU/storeKomentar', [this.kegiatan_id, this.formKomentar]);
            }
					}else{
						this.submited = true;
					}	
      ...
      hapus(){
        this.$store.dispatch('pertemuanBKCU/destroyKomentar', this.selectedKomentar.id);
      },
      calculatePagination() {
        var i = 0;
        var startPage = 0;
