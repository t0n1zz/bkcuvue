	...
	<div>
		...
		<data-viewer :title="title" :columnData="columnData" :itemData="itemData" :query="query" :itemDataStat="itemDataStat" :isUploadExcel="true" @fetch="fetch">
			...
			<template slot="button-kolom">
				<button type="button" class="btn btn-light btn-block btn-icon" v-tooltip:top="'Kolom Anggota'" :disabled="itemDataStat === 'loading'"
				  @click.prevent="columnGroup('anggota')">
					Anggota
				</button>
				<button type="button" class="btn btn-light btn-block  btn-icon" v-tooltip:top="'Kolom Aset'" :disabled="itemDataStat === 'loading'"
				  @click.prevent="columnGroup('aset')">
					Aset
				</button>
				<button type="button" class="btn btn-light btn-block  btn-icon" v-tooltip:top="'Kolom SHU'" :disabled="itemDataStat === 'loading'"
