    ...
    >
      ...
      <template slot="button-desktop">
        ...
        <button
          ...
          class="btn btn-light btn-icon mb-1"
          v-if="currentUser.can && currentUser.can['destroy_laporan_cu']"
          :disabled="!selectedItem.id"
        >
      ...
      <template slot="modal-body1">
        ...
        <div class="row">
          <div
            ...
            v-for="(index, laporanTp) in listLaporanTpData"
            :key="index"
          >
            <a
  ...
  methods: {
    fetch(params) {
      ...
      if (this.$route.meta.mode == "periode") {
        ...
        if (this.$route.params.tp == "konsolidasi") {
          ...
          this.excelDownloadUrl =
            "laporanTp" + "/indexTp/" + this.$route.params.tp;
          this.periode = "";
        }
    ...
    columnGroup(value) {
      ...
      if (value == "anggota") {
        ...
        for (i = 0; i < this.columnData.length; i++) {
          if (
            [0, 1, 2, 3, 4, 5, 6, 34, 35, 41, 42, 43, 44, 48, 49].includes(i)
          ) {
            this.columnData[i].hide = false;
          } else {
            this.columnData[i].hide = true;
        ...
        for (i = 0; i < this.columnData.length; i++) {
          if (
            [0, 1, 2, 3, 4, 5, 6, 27, 28, 29, 30, 31, 32, 33, 48, 49].includes(
              i
            )
          ) {
            this.columnData[i].hide = false;
