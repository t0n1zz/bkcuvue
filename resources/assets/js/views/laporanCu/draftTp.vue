            ...
            <div class="card-header d-print-none">
              <div class="row">
                ...
                <div class="col-md-8 col-lg-10 pb-2 d-none d-sm-block">
                  <!-- simpan -->
                  <button
                    @click.prevent="modalConfirmOpen('simpan')"
                    class="btn btn-light mb-1"
                  >
                    <i class="icon-floppy-disk"></i> Simpan ke laporan statistik
                    Tp
                  </button>
                  ...
                  <!-- hapus -->
                  <button
                    @click.prevent="modalConfirmOpen('hapus_semua')"
                    class="btn btn-light btn-icon mb-1"
                    :disabled="!selectedItem.id"
                  >
...
export default {
  ...
  data() {
    return {
      title: "Laporan TP/KP [Draft]",
      kelas: "laporanTp",
      titleDesc: "Mengelola data laporan TP/KP dari file excel",
