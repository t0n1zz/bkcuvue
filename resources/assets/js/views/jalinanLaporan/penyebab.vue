  ...
  import tableData from "../jalinanKlaim/table.vue";
	...
	export default {
      ...
      tableData,
		...
		data() {
			return {
				title: 'Laporan pencairan JALINAN berdasarkan penyebab',
		...
		methods: {
			cari(awal, akhir, cu){
        this.$router.push({name: 'jalinanLaporanKlaimPenyebabTanggal', params:{awal: awal, akhir: akhir, cu: cu, tp: 'semua'} });
			},
      ...
      bukaData(value){
				this.$router.push({name: 'jalinanLaporanKlaimPenyebabTanggal', params:{awal: this.$route.params.awal, akhir: this.$route.params.akhir,  cu: value, tp: 'semua'} });
			},
      changeTab(value) {
				this.tabName = value;
