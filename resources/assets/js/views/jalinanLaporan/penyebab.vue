  ...
  import tableData from "../jalinanKlaim/table.vue";
	...
	export default {
      ...
      tableData,
		...
		methods: {
			cari(awal, akhir, cu){
        this.$router.push({name: 'jalinanLaporanKlaimPenyebabTanggal', params:{awal: awal, akhir: akhir, cu: cu} });
			},
      ...
      bukaData(value){
				this.$router.push({name: 'jalinanLaporanKlaimPenyebabTanggal', params:{awal: this.$route.params.awal, akhir: this.$route.params.akhir,  cu: value} });
			},
      changeTab(value) {
				this.tabName = value;
