	...
	<div>
		...
		@fetch="fetch">
			...
			<template slot="button-desktop">
				...
				<!-- tambah -->
				<div class="btn-group pb-5" v-if="profile.can && profile.can['create_diklat_tempat']">
				...
				<!-- ubah-->
				<div class="btn-group pb-5" v-if="profile.can && profile.can['update_diklat_tempat']">
				...
				<!-- hapus -->
				<div class="btn-group pb-5" v-if="profile.can && profile.can['destroy_diklat_tempat']">
			...
			<template slot="button-context">
				...
				<!-- update -->
				<li v-if="profile.can && profile.can['update_diklat_tempat']">
				...
				<!-- destroy -->
				<li v-if="profile.can && profile.can['destroy_diklat_tempat']">
			...
			<!-- mobile -->
			<!-- button mobile -->
			<template slot="button-mobile" class="hidden-print" v-if="profile.can && profile.can['create_diklat_tempat']">
				<!-- tambah -->
				...
				<div class="panel panel-flat visible-xs">
					<table class="table table-striped">
						<tbody>
							...
							<tr v-if="!columnData[7].hide" class="collapse" :class="'collap'+props.item.id">
								<td colspan="2"><b>{{columnData[7].title}}</b></td>
							</tr>
							<tr v-if="!columnData[7].hide" class="collapse" :class="'collap'+props.item.id">
					...
					<div class="panel-footer hidden-print">
						<div class="text-center button-toolbar">
							...
							<!-- update -->
							<div class="pt-10 pb-10 pl-15 pr-15" v-if="profile.can && profile.can['update_diklat_tempat']">
							...
							<!-- destroy -->
							<div class="pb-10 pl-15 pr-15" v-if="profile.can && profile.can['destroy_diklat_tempat']">
