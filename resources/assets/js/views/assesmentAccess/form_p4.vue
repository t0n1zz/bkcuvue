<template>
	<div>
		...
		<div class="row" v-if="form.p3.p3b26_cu_penilaian != '' && form.p3.p3b26_cu_keterangan != ''">
			<div class="col-md-3">
		...
		<div v-show="tabName == 'semua'">
			<div class="card card-body bg-info text-white" v-if="form.p3.p3b26_cu_penilaian != '' && form.p3.p3b26_cu_keterangan != ''"> 
		...
		<!-- a1 -->
		<transition enter-active-class="animated fadeIn" mode="out-in">
		<div v-show="tabName == 'semua' || form.p4.p4a1_cu_penilaian == tabName">
			<div class="card border-info" v-if="form.p3.p3b26_cu_penilaian != '' && form.p3.p3b26_cu_keterangan != ''">
					...
					<div class="row">
						...
						<div class="col-md-12">
							...
							<div class="form-group">
								...
								class="form-control"
								placeholder="Silahkan masukkan keterangan " v-model="form.p4.p4a1_cu_keterangan" :disabled="$route.meta.mode == 'penilaian_bkcu' || $route.meta.mode == 'lihat'"></textarea>
							</div>
						</div>
						<!-- penilaian bkcu -->
		...
		<!-- a2 -->
		<transition enter-active-class="animated fadeIn" mode="out-in">
		<div v-show="tabName == 'semua' || form.p4.p4a2_cu_penilaian == tabName">
			<div class="card border-info" v-if="form.p4.p4a1_cu_penilaian != '' && form.p4.p4a1_cu_keterangan != ''">
				<div class="card-header bg-info text-white">
					<h5 class="card-title">
					...
					<div class="row">
						...
						<div class="col-md-12">
							...
							<div class="form-group">
								...
								class="form-control"
								placeholder="Silahkan masukkan keterangan " v-model="form.p4.p4a2_cu_keterangan" :disabled="$route.meta.mode == 'penilaian_bkcu' || $route.meta.mode == 'lihat'"></textarea>
							</div>
						</div>
						<!-- penilaian bkcu -->
						<div class="col-md-12" v-if="mode == 'penilaian_bkcu' || mode == 'lihat'">
		...
		<!-- a3 -->
		<transition enter-active-class="animated fadeIn" mode="out-in">
		<div v-show="tabName == 'semua' || form.p4.p4a3_cu_penilaian == tabName">
			<div class="card border-info" v-if="form.p4.p4a2_cu_penilaian != '' && form.p4.p4a2_cu_keterangan != ''">
				<div class="card-header bg-info text-white">
					<h5 class="card-title">
					...
					<div class="row">
						...
						<div class="col-md-12">
							...
							<div class="form-group">
								...
								class="form-control"
								placeholder="Silahkan masukkan keterangan " v-model="form.p4.p4a3_cu_keterangan" :disabled="$route.meta.mode == 'penilaian_bkcu' || $route.meta.mode == 'lihat'"></textarea>
							</div>
						</div>
						<!-- penilaian bkcu -->
						<div class="col-md-12" v-if="mode == 'penilaian_bkcu' || mode == 'lihat'">
		...
		<!-- a4 -->
		<transition enter-active-class="animated fadeIn" mode="out-in">
		<div v-show="tabName == 'semua' || form.p4.p4a4_cu_penilaian == tabName">
			<div class="card border-info" v-if="form.p4.p4a3_cu_penilaian != '' && form.p4.p4a3_cu_keterangan != ''">
				<div class="card-header bg-info text-white">
					<h5 class="card-title">
						4. Fungsi Wali</h5>
				</div>
					...
					<div class="row">
						...
						<div class="col-md-12">
							...
							<div class="form-group">
								...
								class="form-control"
								placeholder="Silahkan masukkan keterangan " v-model="form.p4.p4a4_cu_keterangan" :disabled="$route.meta.mode == 'penilaian_bkcu' || $route.meta.mode == 'lihat'"></textarea>
							</div>
						</div>
						<!-- penilaian bkcu -->
						<div class="col-md-12" v-if="mode == 'penilaian_bkcu' || mode == 'lihat'">
		...
		<!-- a5 -->
		<transition enter-active-class="animated fadeIn" mode="out-in">
		<div v-show="tabName == 'semua' || form.p4.p4a5_cu_penilaian == tabName">
			<div class="card border-info" v-if="form.p4.p4a4_cu_penilaian != '' && form.p4.p4a4_cu_keterangan != ''">
				<div class="card-header bg-info text-white">
					<h5 class="card-title">
						5. Sebagai Simbol</h5>
				</div>
					...
					<div class="row">
						...
						<div class="col-md-12">
							...
							<div class="form-group">
								...
								class="form-control"
								placeholder="Silahkan masukkan keterangan " v-model="form.p4.p4a5_cu_keterangan" :disabled="$route.meta.mode == 'penilaian_bkcu' || $route.meta.mode == 'lihat'"></textarea>
							</div>
						</div>
						<!-- penilaian bkcu -->
						<div class="col-md-12" v-if="mode == 'penilaian_bkcu' || mode == 'lihat'">
		...
		<!-- a6 -->
		<transition enter-active-class="animated fadeIn" mode="out-in">
		<div v-show="tabName == 'semua' || form.p4.p4a6_cu_penilaian == tabName">
			<div class="card border-info" v-if="form.p4.p4a5_cu_penilaian != '' && form.p4.p4a5_cu_keterangan != ''">
				<div class="card-header bg-info text-white">
					<h5 class="card-title">
					...
					<div class="row">
						...
						<div class="col-md-12">
							...
							<div class="form-group">
								...
								class="form-control"
								placeholder="Silahkan masukkan keterangan " v-model="form.p4.p4a6_cu_keterangan" :disabled="$route.meta.mode == 'penilaian_bkcu' || $route.meta.mode == 'lihat'"></textarea>
							</div>
						</div>
						<!-- penilaian bkcu -->
						<div class="col-md-12" v-if="mode == 'penilaian_bkcu' || mode == 'lihat'">
		...
		<!-- a7 -->
		<transition enter-active-class="animated fadeIn" mode="out-in">
		<div v-show="tabName == 'semua' || form.p4.p4a7_cu_penilaian == tabName">
			<div class="card border-info" v-if="form.p4.p4a6_cu_penilaian != '' && form.p4.p4a6_cu_keterangan != ''">
				<div class="card-header bg-info text-white">
					<h5 class="card-title">
					...
					<div class="row">
						...
						<div class="col-md-12">
							...
							<div class="form-group">
								...
								class="form-control"
								placeholder="Silahkan masukkan keterangan " v-model="form.p4.p4a7_cu_keterangan" :disabled="$route.meta.mode == 'penilaian_bkcu' || $route.meta.mode == 'lihat'"></textarea>
							</div>
						</div>
						<!-- penilaian bkcu -->
						<div class="col-md-12" v-if="mode == 'penilaian_bkcu' || mode == 'lihat'">
		...
		<!-- a8 -->
		<transition enter-active-class="animated fadeIn" mode="out-in">
		<div v-show="tabName == 'semua' || form.p4.p4a8_cu_penilaian == tabName">
			<div class="card border-info" v-if="form.p4.p4a7_cu_penilaian != '' && form.p4.p4a7_cu_keterangan != ''">
				<div class="card-header bg-info text-white">
					<h5 class="card-title">
						8. Tata Kelola</h5>
				</div>
					...
					<div class="row">
						...
						<div class="col-md-12">
							...
							<div class="form-group">
								...
								class="form-control"
								placeholder="Silahkan masukkan keterangan " v-model="form.p4.p4a8_cu_keterangan" :disabled="$route.meta.mode == 'penilaian_bkcu' || $route.meta.mode == 'lihat'"></textarea>
							</div>
						</div>
						<!-- penilaian bkcu -->
						<div class="col-md-12" v-if="mode == 'penilaian_bkcu' || mode == 'lihat'">
		...
		<!-- a9 -->
		<transition enter-active-class="animated fadeIn" mode="out-in">
		<div v-show="tabName == 'semua' || form.p4.p4a9_cu_penilaian == tabName">
					...
					<div class="row">
						...
						<div class="col-md-12">
							...
							<div class="form-group">
								...
								class="form-control"
								placeholder="Silahkan masukkan keterangan " v-model="form.p4.p4a9_cu_keterangan" :disabled="$route.meta.mode == 'penilaian_bkcu' || $route.meta.mode == 'lihat'"></textarea>
							</div>
						</div>
						<!-- penilaian bkcu -->
						<div class="col-md-12" v-if="mode == 'penilaian_bkcu' || mode == 'lihat'">
					...
					<div class="row">
						...
						<div class="col-md-12">
							...
							<div class="form-group">
								...
								class="form-control"
								placeholder="Silahkan masukkan keterangan " v-model="form.p4.p4a10_cu_keterangan" :disabled="$route.meta.mode == 'penilaian_bkcu' || $route.meta.mode == 'lihat'"></textarea>
							</div>
						</div>
						<!-- penilaian bkcu -->
						<div class="col-md-12" v-if="mode == 'penilaian_bkcu' || mode == 'lihat'">
		...
		<transition enter-active-class="animated fadeIn" mode="out-in">
		<div v-show="tabName == 'semua'">
			<div class="card card-body bg-warning text-white" v-if="form.p4.p4a10_cu_penilaian != '' && form.p4.p4a10_cu_keterangan != ''">
				<div class="row justify-content-between">
					<div class="col-md-6">
		...
		<!-- b11 -->
		<transition enter-active-class="animated fadeIn" mode="out-in">
		<div v-show="tabName == 'semua' || form.p4.p4b11_cu_penilaian == tabName">
			<div class="card border-warning" v-if="form.p4.p4a10_cu_penilaian != '' && form.p4.p4a10_cu_keterangan != ''">
					...
					<div class="row">
						...
						<div class="col-md-12">
							...
							<div class="form-group">
								...
								class="form-control"
								placeholder="Silahkan masukkan keterangan " v-model="form.p4.p4b11_cu_keterangan" :disabled="$route.meta.mode == 'penilaian_bkcu' || $route.meta.mode == 'lihat'"></textarea>
							</div>
						</div>
		...
		<!-- b12 -->
		<transition enter-active-class="animated fadeIn" mode="out-in">
		<div v-show="tabName == 'semua' || form.p4.p4b12_cu_penilaian == tabName">
			<div class="card border-warning" v-if="form.p4.p4b11_cu_penilaian != '' && form.p4.p4b11_cu_keterangan != ''">
				<div class="card-header bg-warning text-white">
					<h5 class="card-title">
					...
					<div class="row">
						...
						<div class="col-md-12">
							...
							<div class="form-group">
								...
								class="form-control"
								placeholder="Silahkan masukkan keterangan " v-model="form.p4.p4b12_cu_keterangan" :disabled="$route.meta.mode == 'penilaian_bkcu' || $route.meta.mode == 'lihat'"></textarea>
							</div>
						</div>
		...
		<!-- b13 -->
		<transition enter-active-class="animated fadeIn" mode="out-in">
		<div v-show="tabName == 'semua' || form.p4.p4b13_cu_penilaian == tabName">
			<div class="card border-warning" v-if="form.p4.p4b12_cu_penilaian != '' && form.p4.p4b12_cu_keterangan != ''">
				<div class="card-header bg-warning text-white">
					<h5 class="card-title">
						13. Kompensasi</h5>
				</div>
					...
					<div class="row">
						...
						<div class="col-md-12">
							...
							<div class="form-group">
								...
								class="form-control"
								placeholder="Silahkan masukkan keterangan " v-model="form.p4.p4b13_cu_keterangan" :disabled="$route.meta.mode == 'penilaian_bkcu' || $route.meta.mode == 'lihat'"></textarea>
							</div>
						</div>
		...
		<!-- b14 -->
		<transition enter-active-class="animated fadeIn" mode="out-in">
		<div v-show="tabName == 'semua' || form.p4.p4b14_cu_penilaian == tabName">
			<div class="card border-warning" v-if="form.p4.p4b13_cu_penilaian != '' && form.p4.p4b13_cu_keterangan != ''">
				<div class="card-header bg-warning text-white">
					<h5 class="card-title">
					...
					<div class="row">
						...
						<div class="col-md-12">
							...
							<div class="form-group">
								...
								class="form-control"
								placeholder="Silahkan masukkan keterangan " v-model="form.p4.p4b14_cu_keterangan" :disabled="$route.meta.mode == 'penilaian_bkcu' || $route.meta.mode == 'lihat'"></textarea>
							</div>
						</div>
		...
		<!-- b15 -->
		<transition enter-active-class="animated fadeIn" mode="out-in">
		<div v-show="tabName == 'semua' || form.p4.p4b15_cu_penilaian == tabName">
			<div class="card border-warning" v-if="form.p4.p4b14_cu_penilaian != '' && form.p4.p4b14_cu_keterangan != ''">
				<div class="card-header bg-warning text-white">
					<h5 class="card-title">
					...
					<div class="row">
						...
						<div class="col-md-12">
							...
							<div class="form-group">
								...
								class="form-control"
								placeholder="Silahkan masukkan keterangan " v-model="form.p4.p4b15_cu_keterangan" :disabled="$route.meta.mode == 'penilaian_bkcu' || $route.meta.mode == 'lihat'"></textarea>
							</div>
						</div>
		...
		<!-- b16 -->
		<transition enter-active-class="animated fadeIn" mode="out-in">
		<div v-show="tabName == 'semua' || form.p4.p4b16_cu_penilaian == tabName">
			<div class="card border-warning" v-if="form.p4.p4b15_cu_penilaian != '' && form.p4.p4b15_cu_keterangan != ''">
				<div class="card-header bg-warning text-white">
					<h5 class="card-title">
					...
					<div class="row">
						...
						<div class="col-md-12">
							...
							<div class="form-group">
								...
								class="form-control"
								placeholder="Silahkan masukkan keterangan " v-model="form.p4.p4b16_cu_keterangan" :disabled="$route.meta.mode == 'penilaian_bkcu' || $route.meta.mode == 'lihat'"></textarea>
							</div>
						</div>
		...
		<!-- b17 -->
		<transition enter-active-class="animated fadeIn" mode="out-in">
		<div v-show="tabName == 'semua' || form.p4.p4b17_cu_penilaian == tabName">
					...
					<div class="row">
						...
						<div class="col-md-12">
							...
							<div class="form-group">
								...
								class="form-control"
								placeholder="Silahkan masukkan keterangan " v-model="form.p4.p4b17_cu_keterangan" :disabled="$route.meta.mode == 'penilaian_bkcu' || $route.meta.mode == 'lihat'"></textarea>
							</div>
						</div>
		...
		<!-- b18 -->
		<transition enter-active-class="animated fadeIn" mode="out-in">
		<div v-show="tabName == 'semua' || form.p4.p4b18_cu_penilaian == tabName">
			<div class="card border-warning" v-if="form.p4.p4b17_cu_penilaian != '' && form.p4.p4b17_cu_keterangan != ''">
				<div class="card-header bg-warning text-white">
					<h5 class="card-title">
						18. Kecakapan Tim</h5>
				</div>
					...
					<div class="row">
						...
						<div class="col-md-12">
							...
							<div class="form-group">
								...
								class="form-control"
								placeholder="Silahkan masukkan keterangan " v-model="form.p4.p4b18_cu_keterangan" :disabled="$route.meta.mode == 'penilaian_bkcu' || $route.meta.mode == 'lihat'"></textarea>
							</div>
						</div>
		...
		<!-- b19 -->
		<transition enter-active-class="animated fadeIn" mode="out-in">
		<div v-show="tabName == 'semua' || form.p4.p4b19_cu_penilaian == tabName">
			<div class="card border-warning" v-if="form.p4.p4b18_cu_penilaian != '' && form.p4.p4b18_cu_keterangan != ''">
				<div class="card-header bg-warning text-white">
					<h5 class="card-title">
						19. Jenjang Karir</h5>
				</div>
					...
					<div class="row">
						...
						<div class="col-md-12">
							...
							<div class="form-group">
								...
								class="form-control"
								placeholder="Silahkan masukkan keterangan " v-model="form.p4.p4b19_cu_keterangan" :disabled="$route.meta.mode == 'penilaian_bkcu' || $route.meta.mode == 'lihat'"></textarea>
							</div>
						</div>
		...
		<!-- b20 -->
		<transition enter-active-class="animated fadeIn" mode="out-in">
		<div v-show="tabName == 'semua' || form.p4.p4b20_cu_penilaian == tabName">
			<div class="card border-warning" v-if="form.p4.p4b19_cu_penilaian != '' && form.p4.p4b19_cu_keterangan != ''">
				<div class="card-header bg-warning text-white">
					<h5 class="card-title">
					...
					<div class="row">
						...
						<div class="col-md-12">
							...
							<div class="form-group">
								...
								class="form-control"
								placeholder="Silahkan masukkan keterangan " v-model="form.p4.p4b20_cu_keterangan" :disabled="$route.meta.mode == 'penilaian_bkcu' || $route.meta.mode == 'lihat'"></textarea>
							</div>
						</div>
		...
		<transition enter-active-class="animated fadeIn" mode="out-in">
		<div v-show="tabName == 'semua'">
			<div class="card card-body" v-if="form.p4.p4b20_cu_penilaian != '' && form.p4.p4b20_cu_keterangan != ''">
