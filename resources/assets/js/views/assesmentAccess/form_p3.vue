<template>
	<div>
		...
		<div class="card bg-danger card-body" v-if="form.p2.p2b27_cu_penilaian ==null && form.p2.p2b27_cu_keterangan ==null && mode != 'penilaianBkcu' && mode != 'lihat'">
			<h6 class="mb-0">Maaf, anda tidak bisa melanjutkan mengisi perspektif ini sebelum melengkapi perspektif sebelumnya.</h6>
		</div>

		<div v-if="form.p2.p2b27_cu_penilaian !=null && form.p2.p2b27_cu_keterangan !=null || (mode == 'penilaianBkcu' || mode == 'lihat')">
			<form-filter 
			:cuTabName="cuTabName" 
		...
		<div v-show="cuTabName == 'semua' && bkcuTabName == 'semua'">
			<div class="card card-body bg-info text-white" v-if="form.p2.p2b27_cu_penilaian != null && form.p2.p2b27_cu_keterangan != null || (mode == 'penilaianBkcu' || mode == 'lihat')"> 
		...
		<!-- a1 -->
		<transition enter-active-class="animated fadeIn" mode="out-in">
		<div v-show="(cuTabName == 'semua' && bkcuTabName == 'semua') || form.p3.p3a1_cu_penilaian == cuTabName || form.p3.p3a1_bkcu_penilaian == bkcuTabName">
			<div class="card border-info" v-if="form.p2.p2b27_cu_penilaian != null && form.p2.p2b27_cu_keterangan != null || (mode == 'penilaianBkcu' || mode == 'lihat')">
					...
					<div class="row">
						...
						<div class="col-md-12">
							...
							<div class="form-group">
								...
								class="form-control"
								placeholder="Silahkan masukkan keterangan " v-model="form.p3.p3a1_cu_keterangan" :readonly="$route.meta.mode == 'penilaianBkcu' || $route.meta.mode == 'lihat'"></textarea>
							</div>
						</div>
						<!-- penilaian bkcu -->
							...
							<div class="row">
								...
								<div class="col-md-6">
									<div class="form-group">
										...
										class="form-control"
										placeholder="Silahkan masukkan keterangan " v-model="form.p3.p3a1_bkcu_keterangan" :readonly="$route.meta.mode == 'lihat'"></textarea>
									</div>
								</div>
								<div class="col-md-6">
									<div class="form-group">
										...
										class="form-control"
										placeholder="Silahkan masukkan rekomendasi " v-model="form.p3.p3a1_bkcu_rekomendasi" :readonly="$route.meta.mode == 'lihat'"></textarea>
									</div>
								</div>
							</div>
						</div>
		...
		<!-- a2 -->
		<transition enter-active-class="animated fadeIn" mode="out-in">
		<div v-show="(cuTabName == 'semua' && bkcuTabName == 'semua') || form.p3.p3a2_cu_penilaian == cuTabName || form.p3.p3a2_bkcu_penilaian == bkcuTabName">
			<div class="card border-info" v-if="form.p3.p3a1_cu_penilaian !=null && form.p3.p3a1_cu_keterangan !=null || (mode == 'penilaianBkcu' || mode == 'lihat')">
				<div class="card-header bg-info text-white">
					<h5 class="card-title">
					...
					<div class="row">
						...
						<div class="col-md-12">
							...
							<div class="form-group">
								...
								class="form-control"
								placeholder="Silahkan masukkan keterangan " v-model="form.p3.p3a2_cu_keterangan" :readonly="$route.meta.mode == 'penilaianBkcu' || $route.meta.mode == 'lihat'"></textarea>
							</div>
						</div>
						<!-- penilaian bkcu -->
						<div class="col-md-12" v-if="mode == 'penilaianBkcu' || mode == 'lihat'">
							<div class="row">
								...
								<div class="col-md-6">
									<div class="form-group">
										...
										class="form-control"
										placeholder="Silahkan masukkan keterangan " v-model="form.p3.p3a2_bkcu_keterangan" :readonly="$route.meta.mode == 'lihat'"></textarea>
									</div>
								</div>
								<div class="col-md-6">
									<div class="form-group">
										...
										class="form-control"
										placeholder="Silahkan masukkan rekomendasi " v-model="form.p3.p3a2_bkcu_rekomendasi" :readonly="$route.meta.mode == 'lihat'"></textarea>
									</div>
								</div>
							</div>
						</div>
		...
		<!-- a3 -->
		<transition enter-active-class="animated fadeIn" mode="out-in">
		<div v-show="(cuTabName == 'semua' && bkcuTabName == 'semua') || form.p3.p3a3_cu_penilaian == cuTabName || form.p3.p3a3_bkcu_penilaian == bkcuTabName">
			<div class="card border-info" v-if="form.p3.p3a2_cu_penilaian !=null && form.p3.p3a2_cu_keterangan !=null || (mode == 'penilaianBkcu' || mode == 'lihat')">
				<div class="card-header bg-info text-white">
					<h5 class="card-title">
					...
					<div class="row">
						...
						<div class="col-md-12">
							...
							<div class="form-group">
								...
								class="form-control"
								placeholder="Silahkan masukkan keterangan " v-model="form.p3.p3a3_cu_keterangan" :readonly="$route.meta.mode == 'penilaianBkcu' || $route.meta.mode == 'lihat'"></textarea>
							</div>
						</div>
						<!-- penilaian bkcu -->
						<div class="col-md-12" v-if="mode == 'penilaianBkcu' || mode == 'lihat'">
							<div class="row">
								...
								<div class="col-md-6">
									<div class="form-group">
										...
										class="form-control"
										placeholder="Silahkan masukkan keterangan " v-model="form.p3.p3a3_bkcu_keterangan" :readonly="$route.meta.mode == 'lihat'"></textarea>
									</div>
								</div>
								<div class="col-md-6">
									<div class="form-group">
										...
										class="form-control"
										placeholder="Silahkan masukkan rekomendasi " v-model="form.p3.p3a3_bkcu_rekomendasi" :readonly="$route.meta.mode == 'lihat'"></textarea>
									</div>
								</div>
							</div>
						</div>
		...
		<!-- a4 -->
		<transition enter-active-class="animated fadeIn" mode="out-in">
		<div v-show="(cuTabName == 'semua' && bkcuTabName == 'semua') || form.p3.p3a4_cu_penilaian == cuTabName || form.p3.p3a4_bkcu_penilaian == bkcuTabName">
			<div class="card border-info" v-if="form.p3.p3a3_cu_penilaian !=null && form.p3.p3a3_cu_keterangan !=null || (mode == 'penilaianBkcu' || mode == 'lihat')">
				<div class="card-header bg-info text-white">
					<h5 class="card-title">
					...
					<div class="row">
						...
						<div class="col-md-12">
							...
							<div class="form-group">
								...
								class="form-control"
								placeholder="Silahkan masukkan keterangan " v-model="form.p3.p3a4_cu_keterangan" :readonly="$route.meta.mode == 'penilaianBkcu' || $route.meta.mode == 'lihat'"></textarea>
							</div>
						</div>
						<!-- penilaian bkcu -->
						<div class="col-md-12" v-if="mode == 'penilaianBkcu' || mode == 'lihat'">
							<div class="row">
								...
								<div class="col-md-6">
									<div class="form-group">
										...
										class="form-control"
										placeholder="Silahkan masukkan keterangan " v-model="form.p3.p3a4_bkcu_keterangan" :readonly="$route.meta.mode == 'lihat'"></textarea>
									</div>
								</div>
								<div class="col-md-6">
									<div class="form-group">
										...
										class="form-control"
										placeholder="Silahkan masukkan rekomendasi " v-model="form.p3.p3a4_bkcu_rekomendasi" :readonly="$route.meta.mode == 'lihat'"></textarea>
									</div>
								</div>
							</div>
						</div>
		...
		<!-- a5 -->
		<transition enter-active-class="animated fadeIn" mode="out-in">
		<div v-show="(cuTabName == 'semua' && bkcuTabName == 'semua') || form.p3.p3a5_cu_penilaian == cuTabName || form.p3.p3a5_bkcu_penilaian == bkcuTabName">
			<div class="card border-info" v-if="form.p3.p3a4_cu_penilaian !=null && form.p3.p3a4_cu_keterangan !=null || (mode == 'penilaianBkcu' || mode == 'lihat')">
				<div class="card-header bg-info text-white">
					<h5 class="card-title">
					...
					<div class="row">
						...
						<div class="col-md-12">
							...
							<div class="form-group">
								...
								class="form-control"
								placeholder="Silahkan masukkan keterangan " v-model="form.p3.p3a5_cu_keterangan" :readonly="$route.meta.mode == 'penilaianBkcu' || $route.meta.mode == 'lihat'"></textarea>
							</div>
						</div>
						<!-- penilaian bkcu -->
						<div class="col-md-12" v-if="mode == 'penilaianBkcu' || mode == 'lihat'">
							<div class="row">
								...
								<div class="col-md-6">
									<div class="form-group">
										...
										class="form-control"
										placeholder="Silahkan masukkan keterangan " v-model="form.p3.p3a5_bkcu_keterangan" :readonly="$route.meta.mode == 'lihat'"></textarea>
									</div>
								</div>
								<div class="col-md-6">
									<div class="form-group">
										...
										class="form-control"
										placeholder="Silahkan masukkan rekomendasi " v-model="form.p3.p3a5_bkcu_rekomendasi" :readonly="$route.meta.mode == 'lihat'"></textarea>
									</div>
								</div>
							</div>
						</div>
		...
		<!-- a6 -->
		<transition enter-active-class="animated fadeIn" mode="out-in">
		<div v-show="(cuTabName == 'semua' && bkcuTabName == 'semua') || form.p3.p3a6_cu_penilaian == cuTabName || form.p3.p3a6_bkcu_penilaian == bkcuTabName">
			<div class="card border-info" v-if="form.p3.p3a5_cu_penilaian !=null && form.p3.p3a5_cu_keterangan !=null || (mode == 'penilaianBkcu' || mode == 'lihat')">
				<div class="card-header bg-info text-white">
					<h5 class="card-title">
					...
					<div class="row">
						...
						<div class="col-md-12">
							...
							<div class="form-group">
								...
								class="form-control"
								placeholder="Silahkan masukkan keterangan " v-model="form.p3.p3a6_cu_keterangan" :readonly="$route.meta.mode == 'penilaianBkcu' || $route.meta.mode == 'lihat'"></textarea>
							</div>
						</div>
						<!-- penilaian bkcu -->
						<div class="col-md-12" v-if="mode == 'penilaianBkcu' || mode == 'lihat'">
							<div class="row">
								...
								<div class="col-md-6">
									<div class="form-group">
										...
										class="form-control"
										placeholder="Silahkan masukkan keterangan " v-model="form.p3.p3a6_bkcu_keterangan" :readonly="$route.meta.mode == 'lihat'"></textarea>
									</div>
								</div>
								<div class="col-md-6">
									<div class="form-group">
										...
										class="form-control"
										placeholder="Silahkan masukkan rekomendasi " v-model="form.p3.p3a6_bkcu_rekomendasi" :readonly="$route.meta.mode == 'lihat'"></textarea>
									</div>
								</div>
							</div>
						</div>
		...
		<!-- a7 -->
		<transition enter-active-class="animated fadeIn" mode="out-in">
		<div v-show="(cuTabName == 'semua' && bkcuTabName == 'semua') || form.p3.p3a7_cu_penilaian == cuTabName || form.p3.p3a7_bkcu_penilaian == bkcuTabName">
			<div class="card border-info" v-if="form.p3.p3a6_cu_penilaian !=null && form.p3.p3a6_cu_keterangan !=null || (mode == 'penilaianBkcu' || mode == 'lihat')">
				<div class="card-header bg-info text-white">
					<h5 class="card-title">
					...
					<div class="row">
						...
						<div class="col-md-12">
							...
							<div class="form-group">
								...
								class="form-control"
								placeholder="Silahkan masukkan keterangan " v-model="form.p3.p3a7_cu_keterangan" :readonly="$route.meta.mode == 'penilaianBkcu' || $route.meta.mode == 'lihat'"></textarea>
							</div>
						</div>
						<!-- penilaian bkcu -->
						<div class="col-md-12" v-if="mode == 'penilaianBkcu' || mode == 'lihat'">
							<div class="row">
								...
								<div class="col-md-6">
									<div class="form-group">
										...
										class="form-control"
										placeholder="Silahkan masukkan keterangan " v-model="form.p3.p3a7_bkcu_keterangan" :readonly="$route.meta.mode == 'lihat'"></textarea>
									</div>
								</div>
								<div class="col-md-6">
									<div class="form-group">
										...
										class="form-control"
										placeholder="Silahkan masukkan rekomendasi " v-model="form.p3.p3a7_bkcu_rekomendasi" :readonly="$route.meta.mode == 'lihat'"></textarea>
									</div>
								</div>
							</div>
						</div>
		...
		<!-- a8 -->
		<transition enter-active-class="animated fadeIn" mode="out-in">
		<div v-show="(cuTabName == 'semua' && bkcuTabName == 'semua') || form.p3.p3a8_cu_penilaian == cuTabName || form.p3.p3a8_bkcu_penilaian == bkcuTabName">
			<div class="card border-info" v-if="form.p3.p3a7_cu_penilaian !=null && form.p3.p3a7_cu_keterangan !=null || (mode == 'penilaianBkcu' || mode == 'lihat')">
				<div class="card-header bg-info text-white">
					<h5 class="card-title">
					...
					<div class="row">
						...
						<div class="col-md-12">
							...
							<div class="form-group">
								...
								class="form-control"
								placeholder="Silahkan masukkan keterangan " v-model="form.p3.p3a8_cu_keterangan" :readonly="$route.meta.mode == 'penilaianBkcu' || $route.meta.mode == 'lihat'"></textarea>
							</div>
						</div>
						<!-- penilaian bkcu -->
						<div class="col-md-12" v-if="mode == 'penilaianBkcu' || mode == 'lihat'">
							<div class="row">
								...
								<div class="col-md-6">
									<div class="form-group">
										...
										class="form-control"
										placeholder="Silahkan masukkan keterangan " v-model="form.p3.p3a8_bkcu_keterangan" :readonly="$route.meta.mode == 'lihat'"></textarea>
									</div>
								</div>
								<div class="col-md-6">
									<div class="form-group">
										...
										class="form-control"
										placeholder="Silahkan masukkan rekomendasi " v-model="form.p3.p3a8_bkcu_rekomendasi" :readonly="$route.meta.mode == 'lihat'"></textarea>
									</div>
								</div>
							</div>
						</div>
		...
		<!-- a9 -->
		<transition enter-active-class="animated fadeIn" mode="out-in">
		<div v-show="(cuTabName == 'semua' && bkcuTabName == 'semua') || form.p3.p3a9_cu_penilaian == cuTabName || form.p3.p3a9_bkcu_penilaian == bkcuTabName">
			<div class="card border-info" v-if="form.p3.p3a8_cu_penilaian !=null && form.p3.p3a8_cu_keterangan !=null || (mode == 'penilaianBkcu' || mode == 'lihat')">
				<div class="card-header bg-info text-white">
					<h5 class="card-title">
					...
					<div class="row">
						...
						<div class="col-md-12">
							...
							<div class="form-group">
								...
								class="form-control"
								placeholder="Silahkan masukkan keterangan " v-model="form.p3.p3a9_cu_keterangan" :readonly="$route.meta.mode == 'penilaianBkcu' || $route.meta.mode == 'lihat'"></textarea>
							</div>
						</div>
						<!-- penilaian bkcu -->
						<div class="col-md-12" v-if="mode == 'penilaianBkcu' || mode == 'lihat'">
							<div class="row">
								...
								<div class="col-md-6">
									<div class="form-group">
										...
										class="form-control"
										placeholder="Silahkan masukkan keterangan " v-model="form.p3.p3a9_bkcu_keterangan" :readonly="$route.meta.mode == 'lihat'"></textarea>
									</div>
								</div>
								<div class="col-md-6">
									<div class="form-group">
										...
										class="form-control"
										placeholder="Silahkan masukkan rekomendasi " v-model="form.p3.p3a9_bkcu_rekomendasi" :readonly="$route.meta.mode == 'lihat'"></textarea>
									</div>
								</div>
							</div>
						</div>
		...
		<transition enter-active-class="animated fadeIn" mode="out-in">
		<div v-show="cuTabName == 'semua' && bkcuTabName == 'semua'">
			<div class="card card-body bg-warning text-white" v-if="form.p3.p3a9_cu_penilaian !=null && form.p3.p3a9_cu_keterangan !=null || (mode == 'penilaianBkcu' || mode == 'lihat')">
				<div class="row justify-content-between">
					<div class="col-md-6">
		...
		<!-- b10 -->
		<transition enter-active-class="animated fadeIn" mode="out-in">
		<div v-show="(cuTabName == 'semua' && bkcuTabName == 'semua') || form.p3.p3b10_cu_penilaian == cuTabName || form.p3.p3b10_bkcu_penilaian == bkcuTabName">
			<div class="card border-warning" v-if="form.p3.p3a9_cu_penilaian !=null && form.p3.p3a9_cu_keterangan !=null || (mode == 'penilaianBkcu' || mode == 'lihat')">
					...
					<div class="row">
						...
						<div class="col-md-12">
							...
							<div class="form-group">
								...
								class="form-control"
								placeholder="Silahkan masukkan keterangan " v-model="form.p3.p3b10_cu_keterangan" :readonly="$route.meta.mode == 'penilaianBkcu' || $route.meta.mode == 'lihat'"></textarea>
							</div>
						</div>
							...
							<div class="row">
								...
								<div class="col-md-6">
									<div class="form-group">
										...
										class="form-control"
										placeholder="Silahkan masukkan keterangan " v-model="form.p3.p3b10_bkcu_keterangan" :readonly="$route.meta.mode == 'lihat'"></textarea>
									</div>
								</div>
								<div class="col-md-6">
									<div class="form-group">
										...
										class="form-control"
										placeholder="Silahkan masukkan rekomendasi " v-model="form.p3.p3b10_bkcu_rekomendasi" :readonly="$route.meta.mode == 'lihat'"></textarea>
									</div>
								</div>
							</div>
						</div>
		...
		<!-- b11 -->
		<transition enter-active-class="animated fadeIn" mode="out-in">
		<div v-show="(cuTabName == 'semua' && bkcuTabName == 'semua') || form.p3.p3b11_cu_penilaian == cuTabName || form.p3.p3b11_bkcu_penilaian == bkcuTabName">
			<div class="card border-warning" v-if="form.p3.p3b10_cu_penilaian !=null && form.p3.p3b10_cu_keterangan !=null || (mode == 'penilaianBkcu' || mode == 'lihat')">
				<div class="card-header bg-warning text-white">
					<h5 class="card-title">
					...
					<div class="row">
						...
						<div class="col-md-12">
							...
							<div class="form-group">
								...
								class="form-control"
								placeholder="Silahkan masukkan keterangan " v-model="form.p3.p3b11_cu_keterangan" :readonly="$route.meta.mode == 'penilaianBkcu' || $route.meta.mode == 'lihat'"></textarea>
							</div>
						</div>
							...
							<div class="row">
								...
								<div class="col-md-6">
									<div class="form-group">
										...
										class="form-control"
										placeholder="Silahkan masukkan keterangan " v-model="form.p3.p3b11_bkcu_keterangan" :readonly="$route.meta.mode == 'lihat'"></textarea>
									</div>
								</div>
								<div class="col-md-6">
									<div class="form-group">
										...
										class="form-control"
										placeholder="Silahkan masukkan rekomendasi " v-model="form.p3.p3b11_bkcu_rekomendasi" :readonly="$route.meta.mode == 'lihat'"></textarea>
									</div>
								</div>
							</div>
						</div>
		...
		<!-- b12 -->
		<transition enter-active-class="animated fadeIn" mode="out-in">
		<div v-show="(cuTabName == 'semua' && bkcuTabName == 'semua') || form.p3.p3b12_cu_penilaian == cuTabName || form.p3.p3b12_bkcu_penilaian == bkcuTabName">
			<div class="card border-warning" v-if="form.p3.p3b11_cu_penilaian !=null && form.p3.p3b11_cu_keterangan !=null || (mode == 'penilaianBkcu' || mode == 'lihat')">
				<div class="card-header bg-warning text-white">
					<h5 class="card-title">
					...
					<div class="row">
						...
						<div class="col-md-12">
							...
							<div class="form-group">
								...
								class="form-control"
								placeholder="Silahkan masukkan keterangan " v-model="form.p3.p3b12_cu_keterangan" :readonly="$route.meta.mode == 'penilaianBkcu' || $route.meta.mode == 'lihat'"></textarea>
							</div>
						</div>
							...
							<div class="row">
								...
								<div class="col-md-6">
									<div class="form-group">
										...
										class="form-control"
										placeholder="Silahkan masukkan keterangan " v-model="form.p3.p3b12_bkcu_keterangan" :readonly="$route.meta.mode == 'lihat'"></textarea>
									</div>
								</div>
								<div class="col-md-6">
									<div class="form-group">
										...
										class="form-control"
										placeholder="Silahkan masukkan rekomendasi " v-model="form.p3.p3b12_bkcu_rekomendasi" :readonly="$route.meta.mode == 'lihat'"></textarea>
									</div>
								</div>
							</div>
						</div>
		...
		<!-- b13 -->
		<transition enter-active-class="animated fadeIn" mode="out-in">
		<div v-show="(cuTabName == 'semua' && bkcuTabName == 'semua') || form.p3.p3b13_cu_penilaian == cuTabName || form.p3.p3b13_bkcu_penilaian == bkcuTabName">
			<div class="card border-warning" v-if="form.p3.p3b12_cu_penilaian !=null && form.p3.p3b12_cu_keterangan !=null || (mode == 'penilaianBkcu' || mode == 'lihat')">
				<div class="card-header bg-warning text-white">
					<h5 class="card-title">
					...
					<div class="row">
						...
						<div class="col-md-12">
							...
							<div class="form-group">
								...
								class="form-control"
								placeholder="Silahkan masukkan keterangan " v-model="form.p3.p3b13_cu_keterangan" :readonly="$route.meta.mode == 'penilaianBkcu' || $route.meta.mode == 'lihat'"></textarea>
							</div>
						</div>
							...
							<div class="row">
								...
								<div class="col-md-6">
									<div class="form-group">
										...
										class="form-control"
										placeholder="Silahkan masukkan keterangan " v-model="form.p3.p3b13_bkcu_keterangan" :readonly="$route.meta.mode == 'lihat'"></textarea>
									</div>
								</div>
								<div class="col-md-6">
									<div class="form-group">
										...
										class="form-control"
										placeholder="Silahkan masukkan rekomendasi " v-model="form.p3.p3b13_bkcu_rekomendasi" :readonly="$route.meta.mode == 'lihat'"></textarea>
									</div>
								</div>
							</div>
						</div>
		...
		<!-- b14 -->
		<transition enter-active-class="animated fadeIn" mode="out-in">
		<div v-show="(cuTabName == 'semua' && bkcuTabName == 'semua') || form.p3.p3b14_cu_penilaian == cuTabName || form.p3.p3b14_bkcu_penilaian == bkcuTabName">
			<div class="card border-warning" v-if="form.p3.p3b13_cu_penilaian !=null && form.p3.p3b13_cu_keterangan !=null || (mode == 'penilaianBkcu' || mode == 'lihat')">
				<div class="card-header bg-warning text-white">
					<h5 class="card-title">
					...
					<div class="row">
						...
						<div class="col-md-12">
							...
							<div class="form-group">
								...
								class="form-control"
								placeholder="Silahkan masukkan keterangan " v-model="form.p3.p3b14_cu_keterangan" :readonly="$route.meta.mode == 'penilaianBkcu' || $route.meta.mode == 'lihat'"></textarea>
							</div>
						</div>
							...
							<div class="row">
								...
								<div class="col-md-6">
									<div class="form-group">
										...
										class="form-control"
										placeholder="Silahkan masukkan keterangan " v-model="form.p3.p3b14_bkcu_keterangan" :readonly="$route.meta.mode == 'lihat'"></textarea>
									</div>
								</div>
								<div class="col-md-6">
									<div class="form-group">
										...
										class="form-control"
										placeholder="Silahkan masukkan rekomendasi " v-model="form.p3.p3b14_bkcu_rekomendasi" :readonly="$route.meta.mode == 'lihat'"></textarea>
									</div>
								</div>
							</div>
						</div>
		...
		<!-- b15 -->
		<transition enter-active-class="animated fadeIn" mode="out-in">
		<div v-show="(cuTabName == 'semua' && bkcuTabName == 'semua') || form.p3.p3b15_cu_penilaian == cuTabName || form.p3.p3b15_bkcu_penilaian == bkcuTabName">
			<div class="card border-warning" v-if="form.p3.p3b14_cu_penilaian !=null && form.p3.p3b14_cu_keterangan !=null || (mode == 'penilaianBkcu' || mode == 'lihat')">
				<div class="card-header bg-warning text-white">
					<h5 class="card-title">
					...
					<div class="row">
						...
						<div class="col-md-12">
							...
							<div class="form-group">
								...
								class="form-control"
								placeholder="Silahkan masukkan keterangan " v-model="form.p3.p3b15_cu_keterangan" :readonly="$route.meta.mode == 'penilaianBkcu' || $route.meta.mode == 'lihat'"></textarea>
							</div>
						</div>
							...
							<div class="row">
								...
								<div class="col-md-6">
									<div class="form-group">
										...
										class="form-control"
										placeholder="Silahkan masukkan keterangan " v-model="form.p3.p3b15_bkcu_keterangan" :readonly="$route.meta.mode == 'lihat'"></textarea>
									</div>
								</div>
								<div class="col-md-6">
									<div class="form-group">
										...
										class="form-control"
										placeholder="Silahkan masukkan rekomendasi " v-model="form.p3.p3b15_bkcu_rekomendasi" :readonly="$route.meta.mode == 'lihat'"></textarea>
									</div>
								</div>
							</div>
						</div>
		...
		<!-- b16 -->
		<transition enter-active-class="animated fadeIn" mode="out-in">
		<div v-show="(cuTabName == 'semua' && bkcuTabName == 'semua') || form.p3.p3b16_cu_penilaian == cuTabName || form.p3.p3b16_bkcu_penilaian == bkcuTabName">
			<div class="card border-warning" v-if="form.p3.p3b15_cu_penilaian !=null && form.p3.p3b15_cu_keterangan !=null || (mode == 'penilaianBkcu' || mode == 'lihat')">
				<div class="card-header bg-warning text-white">
					<h5 class="card-title">
					...
					<div class="row">
						...
						<div class="col-md-12">
							...
							<div class="form-group">
								...
								class="form-control"
								placeholder="Silahkan masukkan keterangan " v-model="form.p3.p3b16_cu_keterangan" :readonly="$route.meta.mode == 'penilaianBkcu' || $route.meta.mode == 'lihat'"></textarea>
							</div>
						</div>
							...
							<div class="row">
								...
								<div class="col-md-6">
									<div class="form-group">
										...
										class="form-control"
										placeholder="Silahkan masukkan keterangan " v-model="form.p3.p3b16_bkcu_keterangan" :readonly="$route.meta.mode == 'lihat'"></textarea>
									</div>
								</div>
								<div class="col-md-6">
									<div class="form-group">
										...
										class="form-control"
										placeholder="Silahkan masukkan rekomendasi " v-model="form.p3.p3b16_bkcu_rekomendasi" :readonly="$route.meta.mode == 'lihat'"></textarea>
									</div>
								</div>
							</div>
						</div>
		...
		<!-- b17 -->
		<transition enter-active-class="animated fadeIn" mode="out-in">
		<div v-show="(cuTabName == 'semua' && bkcuTabName == 'semua') || form.p3.p3b17_cu_penilaian == cuTabName || form.p3.p3b17_bkcu_penilaian == bkcuTabName">
			<div class="card border-warning" v-if="form.p3.p3b16_cu_penilaian !=null && form.p3.p3b16_cu_keterangan !=null || (mode == 'penilaianBkcu' || mode == 'lihat')">
				<div class="card-header bg-warning text-white">
					<h5 class="card-title">
					...
					<div class="row">
						...
						<div class="col-md-12">
							...
							<div class="form-group">
								...
								class="form-control"
								placeholder="Silahkan masukkan keterangan " v-model="form.p3.p3b17_cu_keterangan" :readonly="$route.meta.mode == 'penilaianBkcu' || $route.meta.mode == 'lihat'"></textarea>
							</div>
						</div>
							...
							<div class="row">
								...
								<div class="col-md-6">
									<div class="form-group">
										...
										class="form-control"
										placeholder="Silahkan masukkan keterangan " v-model="form.p3.p3b17_bkcu_keterangan" :readonly="$route.meta.mode == 'lihat'"></textarea>
									</div>
								</div>
								<div class="col-md-6">
									<div class="form-group">
										...
										class="form-control"
										placeholder="Silahkan masukkan rekomendasi " v-model="form.p3.p3b17_bkcu_rekomendasi" :readonly="$route.meta.mode == 'lihat'"></textarea>
									</div>
								</div>
							</div>
						</div>
		...
		<!-- b18 -->
		<transition enter-active-class="animated fadeIn" mode="out-in">
		<div v-show="(cuTabName == 'semua' && bkcuTabName == 'semua') || form.p3.p3b18_cu_penilaian == cuTabName || form.p3.p3b18_bkcu_penilaian == bkcuTabName">
			<div class="card border-warning" v-if="form.p3.p3b17_cu_penilaian !=null && form.p3.p3b17_cu_keterangan !=null || (mode == 'penilaianBkcu' || mode == 'lihat')">
				<div class="card-header bg-warning text-white">
					<h5 class="card-title">
					...
					<div class="row">
						...
						<div class="col-md-12">
							...
							<div class="form-group">
								...
								class="form-control"
								placeholder="Silahkan masukkan keterangan " v-model="form.p3.p3b18_cu_keterangan" :readonly="$route.meta.mode == 'penilaianBkcu' || $route.meta.mode == 'lihat'"></textarea>
							</div>
						</div>
							...
							<div class="row">
								...
								<div class="col-md-6">
									<div class="form-group">
										...
										class="form-control"
										placeholder="Silahkan masukkan keterangan " v-model="form.p3.p3b18_bkcu_keterangan" :readonly="$route.meta.mode == 'lihat'"></textarea>
									</div>
								</div>
								<div class="col-md-6">
									<div class="form-group">
										...
										class="form-control"
										placeholder="Silahkan masukkan rekomendasi " v-model="form.p3.p3b18_bkcu_rekomendasi" :readonly="$route.meta.mode == 'lihat'"></textarea>
									</div>
								</div>
							</div>
						</div>
		...
		<!-- b19 -->
		<transition enter-active-class="animated fadeIn" mode="out-in">
		<div v-show="(cuTabName == 'semua' && bkcuTabName == 'semua') || form.p3.p3b19_cu_penilaian == cuTabName || form.p3.p3b19_bkcu_penilaian == bkcuTabName">
			<div class="card border-warning" v-if="form.p3.p3b18_cu_penilaian !=null && form.p3.p3b18_cu_keterangan !=null || (mode == 'penilaianBkcu' || mode == 'lihat')">
				<div class="card-header bg-warning text-white">
					<h5 class="card-title">
					...
					<div class="row">
						...
						<div class="col-md-12">
							...
							<div class="form-group">
								...
								class="form-control"
								placeholder="Silahkan masukkan keterangan " v-model="form.p3.p3b19_cu_keterangan" :readonly="$route.meta.mode == 'penilaianBkcu' || $route.meta.mode == 'lihat'"></textarea>
							</div>
						</div>
							...
							<div class="row">
								...
								<div class="col-md-6">
									<div class="form-group">
										...
										class="form-control"
										placeholder="Silahkan masukkan keterangan " v-model="form.p3.p3b19_bkcu_keterangan" :readonly="$route.meta.mode == 'lihat'"></textarea>
									</div>
								</div>
								<div class="col-md-6">
									<div class="form-group">
										...
										class="form-control"
										placeholder="Silahkan masukkan rekomendasi " v-model="form.p3.p3b19_bkcu_rekomendasi" :readonly="$route.meta.mode == 'lihat'"></textarea>
									</div>
								</div>
							</div>
						</div>
		...
		<!-- b20 -->
		<transition enter-active-class="animated fadeIn" mode="out-in">
		<div v-show="(cuTabName == 'semua' && bkcuTabName == 'semua') || form.p3.p3b20_cu_penilaian == cuTabName || form.p3.p3b20_bkcu_penilaian == bkcuTabName">
			<div class="card border-warning" v-if="form.p3.p3b19_cu_penilaian !=null && form.p3.p3b19_cu_keterangan !=null || (mode == 'penilaianBkcu' || mode == 'lihat')">
				<div class="card-header bg-warning text-white">
					<h5 class="card-title">
					...
					<div class="row">
						...
						<div class="col-md-12">
							...
							<div class="form-group">
								...
								class="form-control"
								placeholder="Silahkan masukkan keterangan " v-model="form.p3.p3b20_cu_keterangan" :readonly="$route.meta.mode == 'penilaianBkcu' || $route.meta.mode == 'lihat'"></textarea>
							</div>
						</div>
							...
							<div class="row">
								...
								<div class="col-md-6">
									<div class="form-group">
										...
										class="form-control"
										placeholder="Silahkan masukkan keterangan " v-model="form.p3.p3b20_bkcu_keterangan" :readonly="$route.meta.mode == 'lihat'"></textarea>
									</div>
								</div>
								<div class="col-md-6">
									<div class="form-group">
										...
										class="form-control"
										placeholder="Silahkan masukkan rekomendasi " v-model="form.p3.p3b20_bkcu_rekomendasi" :readonly="$route.meta.mode == 'lihat'"></textarea>
									</div>
								</div>
							</div>
						</div>
		...
		<!-- b21 -->
		<transition enter-active-class="animated fadeIn" mode="out-in">
		<div v-show="(cuTabName == 'semua' && bkcuTabName == 'semua') || form.p3.p3b21_cu_penilaian == cuTabName || form.p3.p3b21_bkcu_penilaian == bkcuTabName">
			<div class="card border-warning" v-if="form.p3.p3b20_cu_penilaian !=null && form.p3.p3b20_cu_keterangan !=null || (mode == 'penilaianBkcu' || mode == 'lihat')">
				<div class="card-header bg-warning text-white">
					<h5 class="card-title">
					...
					<div class="row">
						...
						<div class="col-md-12">
							...
							<div class="form-group">
								...
								class="form-control"
								placeholder="Silahkan masukkan keterangan " v-model="form.p3.p3b21_cu_keterangan" :readonly="$route.meta.mode == 'penilaianBkcu' || $route.meta.mode == 'lihat'"></textarea>
							</div>
						</div>
							...
							<div class="row">
								...
								<div class="col-md-6">
									<div class="form-group">
										...
										class="form-control"
										placeholder="Silahkan masukkan keterangan " v-model="form.p3.p3b21_bkcu_keterangan" :readonly="$route.meta.mode == 'lihat'"></textarea>
									</div>
								</div>
								<div class="col-md-6">
									<div class="form-group">
										...
										class="form-control"
										placeholder="Silahkan masukkan rekomendasi " v-model="form.p3.p3b21_bkcu_rekomendasi" :readonly="$route.meta.mode == 'lihat'"></textarea>
									</div>
								</div>
							</div>
						</div>
		...
		<!-- b22 -->
		<transition enter-active-class="animated fadeIn" mode="out-in">
		<div v-show="(cuTabName == 'semua' && bkcuTabName == 'semua') || form.p3.p3b22_cu_penilaian == cuTabName || form.p3.p3b22_bkcu_penilaian == bkcuTabName">
			<div class="card border-warning" v-if="form.p3.p3b21_cu_penilaian !=null && form.p3.p3b21_cu_keterangan !=null || (mode == 'penilaianBkcu' || mode == 'lihat')">
				<div class="card-header bg-warning text-white">
					<h5 class="card-title">
					...
					<div class="row">
						...
						<div class="col-md-12">
							...
							<div class="form-group">
								...
								class="form-control"
								placeholder="Silahkan masukkan keterangan " v-model="form.p3.p3b22_cu_keterangan" :readonly="$route.meta.mode == 'penilaianBkcu' || $route.meta.mode == 'lihat'"></textarea>
							</div>
						</div>
							...
							<div class="row">
								...
								<div class="col-md-6">
									<div class="form-group">
										...
										class="form-control"
										placeholder="Silahkan masukkan keterangan " v-model="form.p3.p3b22_bkcu_keterangan" :readonly="$route.meta.mode == 'lihat'"></textarea>
									</div>
								</div>
								<div class="col-md-6">
									<div class="form-group">
										...
										class="form-control"
										placeholder="Silahkan masukkan rekomendasi " v-model="form.p3.p3b22_bkcu_rekomendasi" :readonly="$route.meta.mode == 'lihat'"></textarea>
									</div>
								</div>
							</div>
						</div>
		...
		<!-- b23 -->
		<transition enter-active-class="animated fadeIn" mode="out-in">
		<div v-show="(cuTabName == 'semua' && bkcuTabName == 'semua') || form.p3.p3b23_cu_penilaian == cuTabName || form.p3.p3b23_bkcu_penilaian == bkcuTabName">
			<div class="card border-warning" v-if="form.p3.p3b22_cu_penilaian !=null && form.p3.p3b22_cu_keterangan !=null || (mode == 'penilaianBkcu' || mode == 'lihat')">
				<div class="card-header bg-warning text-white">
					<h5 class="card-title">
					...
					<div class="row">
						...
						<div class="col-md-12">
							...
							<div class="form-group">
								...
								class="form-control"
								placeholder="Silahkan masukkan keterangan " v-model="form.p3.p3b23_cu_keterangan" :readonly="$route.meta.mode == 'penilaianBkcu' || $route.meta.mode == 'lihat'"></textarea>
							</div>
						</div>
							...
							<div class="row">
								...
								<div class="col-md-6">
									<div class="form-group">
										...
										class="form-control"
										placeholder="Silahkan masukkan keterangan " v-model="form.p3.p3b23_bkcu_keterangan" :readonly="$route.meta.mode == 'lihat'"></textarea>
									</div>
								</div>
								<div class="col-md-6">
									<div class="form-group">
										...
										class="form-control"
										placeholder="Silahkan masukkan rekomendasi " v-model="form.p3.p3b23_bkcu_rekomendasi" :readonly="$route.meta.mode == 'lihat'"></textarea>
									</div>
								</div>
							</div>
						</div>
		...
		<!-- b24 -->
		<transition enter-active-class="animated fadeIn" mode="out-in">
		<div v-show="(cuTabName == 'semua' && bkcuTabName == 'semua') || form.p3.p3b24_cu_penilaian == cuTabName || form.p3.p3b24_bkcu_penilaian == bkcuTabName">
			<div class="card border-warning" v-if="form.p3.p3b23_cu_penilaian !=null && form.p3.p3b23_cu_keterangan !=null || (mode == 'penilaianBkcu' || mode == 'lihat')">
				<div class="card-header bg-warning text-white">
					<h5 class="card-title">
					...
					<div class="row">
						...
						<div class="col-md-12">
							...
							<div class="form-group">
								...
								class="form-control"
								placeholder="Silahkan masukkan keterangan " v-model="form.p3.p3b24_cu_keterangan" :readonly="$route.meta.mode == 'penilaianBkcu' || $route.meta.mode == 'lihat'"></textarea>
							</div>
						</div>
							...
							<div class="row">
								...
								<div class="col-md-6">
									<div class="form-group">
										...
										class="form-control"
										placeholder="Silahkan masukkan keterangan " v-model="form.p3.p3b24_bkcu_keterangan" :readonly="$route.meta.mode == 'lihat'"></textarea>
									</div>
								</div>
								<div class="col-md-6">
									<div class="form-group">
										...
										class="form-control"
										placeholder="Silahkan masukkan rekomendasi " v-model="form.p3.p3b24_bkcu_rekomendasi" :readonly="$route.meta.mode == 'lihat'"></textarea>
									</div>
								</div>
							</div>
						</div>
		...
		<!-- b25 -->
		<transition enter-active-class="animated fadeIn" mode="out-in">
		<div v-show="(cuTabName == 'semua' && bkcuTabName == 'semua') || form.p3.p3b25_cu_penilaian == cuTabName || form.p3.p3b25_bkcu_penilaian == bkcuTabName">
			<div class="card border-warning" v-if="form.p3.p3b24_cu_penilaian !=null && form.p3.p3b24_cu_keterangan !=null || (mode == 'penilaianBkcu' || mode == 'lihat')">
				<div class="card-header bg-warning text-white">
					<h5 class="card-title">
					...
					<div class="row">
						...
						<div class="col-md-12">
							...
							<div class="form-group">
								...
								class="form-control"
								placeholder="Silahkan masukkan keterangan " v-model="form.p3.p3b25_cu_keterangan" :readonly="$route.meta.mode == 'penilaianBkcu' || $route.meta.mode == 'lihat'"></textarea>
							</div>
						</div>
							...
							<div class="row">
								...
								<div class="col-md-6">
									<div class="form-group">
										...
										class="form-control"
										placeholder="Silahkan masukkan keterangan " v-model="form.p3.p3b25_bkcu_keterangan" :readonly="$route.meta.mode == 'lihat'"></textarea>
									</div>
								</div>
								<div class="col-md-6">
									<div class="form-group">
										...
										class="form-control"
										placeholder="Silahkan masukkan rekomendasi " v-model="form.p3.p3b25_bkcu_rekomendasi" :readonly="$route.meta.mode == 'lihat'"></textarea>
									</div>
								</div>
							</div>
						</div>
		...
		<!-- b26 -->
		<transition enter-active-class="animated fadeIn" mode="out-in">
		<div v-show="(cuTabName == 'semua' && bkcuTabName == 'semua') || form.p3.p3b26_cu_penilaian == cuTabName || form.p3.p3b26_bkcu_penilaian == bkcuTabName">
			<div class="card border-warning" v-if="form.p3.p3b25_cu_penilaian !=null && form.p3.p3b25_cu_keterangan !=null || (mode == 'penilaianBkcu' || mode == 'lihat')">
				<div class="card-header bg-warning text-white">
					<h5 class="card-title">
					...
					<div class="row">
						...
						<div class="col-md-12">
							...
							<div class="form-group">
								...
								class="form-control"
								placeholder="Silahkan masukkan keterangan " v-model="form.p3.p3b26_cu_keterangan" :readonly="$route.meta.mode == 'penilaianBkcu' || $route.meta.mode == 'lihat'"></textarea>
							</div>
						</div>
							...
							<div class="row">
								...
								<div class="col-md-6">
									<div class="form-group">
										...
										class="form-control"
										placeholder="Silahkan masukkan keterangan " v-model="form.p3.p3b26_bkcu_keterangan" :readonly="$route.meta.mode == 'lihat'"></textarea>
									</div>
								</div>
								<div class="col-md-6">
									<div class="form-group">
										...
										class="form-control"
										placeholder="Silahkan masukkan rekomendasi " v-model="form.p3.p3b26_bkcu_rekomendasi" :readonly="$route.meta.mode == 'lihat'"></textarea>
									</div>
								</div>
							</div>
						</div>
		...
		<transition enter-active-class="animated fadeIn" mode="out-in">
		<div v-show="cuTabName == 'semua' && bkcuTabName == 'semua'">
			<div class="card card-body" v-if="form.p3.p3b26_cu_penilaian !=null && form.p3.p3b26_cu_keterangan !=null || (mode == 'penilaianBkcu' || mode == 'lihat')">
