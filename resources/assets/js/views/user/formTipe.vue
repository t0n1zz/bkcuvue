    ...
    <form @submit.prevent="save" data-vv-scope="formData">
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <!-- identitas -->
          <identitas
            :itemData="formData.aktivis"
            v-if="formData.id_aktivis != '' && formData.id_aktivis != null"
...
export default {
  ...
  methods: {
    fetchAktivis(params) {
      this.$store.dispatch("aktivis/indexCu", [
        params,
        this.formData.id_cu,
        "semua",
        "aktif",
