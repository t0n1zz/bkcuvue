                  ...
                  <template v-if="item.tipe == 'diklat_bkcu'">
                    ...
                    <button
                      ...
                      v-if="
                        ...
                        (currentUser.id_cu == 0 &&
                          currentUser.can &&
                          currentUser.can['update_diklat_bkcu'])
                      "
                    >
                    ...
                    <button
                      ...
                      v-if="
                        ...
                        (currentUser.id_cu == 0 &&
                          currentUser.can &&
                          currentUser.can['destroy_diklat_bkcu'] &&
                          item.status == 1)
                      "
                    >
                    ...
                    <button
                      ...
                      v-if="
                        ...
                        (currentUser.id_cu != 0 &&
                          currentUser.can &&
                          currentUser.can['index_diklat_bkcu'] &&
                          item.status == 2)
                      "
                    >
                  ...
                  <template v-else-if="item.tipe == 'pertemuan_bkcu'">
                    ...
                    <button
                      ...
                      v-if="
                        ...
                        (currentUser.id_cu == 0 &&
                          currentUser.can &&
                          currentUser.can['update_pertemuan_bkcu'])
                      "
                    >
                      <i class="icon-plus22"></i> Tambah Materi
                    </button>
                    ...
                    <button
                      ...
                      v-if="
                        ...
                        (currentUser.id_cu == 0 &&
                          currentUser.can &&
                          currentUser.can['destroy_pertemuan_bkcu'] &&
                          item.status == 1)
                      "
                    >
                    ...
                    <button
                      ...
                      v-if="
                        ...
                        (currentUser.id_cu != 0 &&
                          currentUser.can &&
                          currentUser.can['index_pertemuan_bkcu'] &&
                          item.status == 2)
                      "
                    >
              ...
              <div class="card">
                <div class="nav-tabs-responsive">
                  <ul class="nav nav-tabs nav-tabs-bottom flex-nowrap mb-0">
                    ...
                    <li
                      class="nav-item"
                      v-if="this.item.pilih && this.item.pilih.length > 0"
                    >
                      <a
                        href="#"
                        class="nav-link"
                  ...
                  >
                    ...
                    >
                      ...
                      <button
                        ...
                        v-if="selectedItem.id && selectedItem.status == 7"
                      >
              ...
              <transition enter-active-class="animated fadeIn" mode="out-in">
                <div v-if="tabName == 'statistik'">
                  ...
                  <div class="card">
                    ...
                    <data-table
                      :items="itemDataPesertaTerdaftarCU"
      ...
      if (this.state != "tambahPeserta" && this.state != "ubahPeserta") {
        if (value == "success") {
          if (this.checkPesertaData) {
            ...
            if (
              !this.currentUser.can["update_diklat_bkcu"] ||
              !this.currentUser.can["destroy_diklat_bkcu"] ||
              !this.currentUser.can["update_pertemuan_bkcu"] ||
              !this.currentUser.can["destroy_pertemuan_bkcu"]
            ) {
              this.modalOpen("pesertaTidakTerdaftar");
            }
          }
    ...
    fetchPesertaTerdaftar(params) {
      if (this.item.status == "2") {
        if (this.currentUser.id_cu == 0) {
          ...
          this.$store.dispatch(this.kelas + "/indexPesertaCu", [
            params,
            this.item.id,
    ...
    modalOpen(state, isMobile, itemMobile) {
      ...
      if (state == "hapusPertemuan") {
        ...
        if (this.countPeserta >= this.item.peserta_max) {
          ...
          this.itemDataPesertaTerdaftar.data.length >=
            this.item.peserta_max_cu &&
          ...
          this.modalContent =
            "Maaf anda tidak bisa mendaftarkan peserta lagi, karena jumlah maksimal peserta per CU adalah " +
            this.item.peserta_max_cu +
            " orang.";
        } else {
          this.modalState = "normal1";
        ...
        if (this.item.keputusan_cu) {
          if (this.countKeputusan[0] >= this.item.keputusan_cu) {
            ...
            this.modalContent =
              "Maaf anda tidak bisa memberikan keputusan lagi, karena jumlah keputusan maksimal per CU adalah " +
              this.item.keputusan_cu +
              " kali.";
        ...
        if (this.item.pertanyaan_cu) {
          if (this.countPertanyaan[0] >= this.item.pertanyaan_cu) {
            ...
            this.modalContent =
              "Maaf anda tidak bisa memberikan pertanyaan lagi, karena jumlah pertanyaan maksimal per CU adalah " +
              this.item.pertanyaan_cu +
              " kali.";
