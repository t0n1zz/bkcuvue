				...
				<div class="content">
					...
					<div class="row">
						...
						<div class="col-md-12" v-else-if="state == 'pesertaTidakTerdaftar'">
							<div class="alert alert-styled-left alert-arrow-left alert-component content-group-lg alert-danger">
								<h5 class="alert-heading text-semibold">Anda tidak terdaftar</h5>
								<span>Maaf anda tidak terdaftar dalam pertemuan ini, silahkan pastikan anda sudah mendaftar di pertemuan ini</span>
							</div> 
						</div>
						...
						<div class="col-md-12" v-else-if="state == 'userTidakAktivis'">
							<div class="alert alert-styled-left alert-arrow-left alert-component content-group-lg alert-danger">
								...
								<span>Anda tidak bisa melanjutkan karena user anda tidak memiliki informasi aktivis, silahkan tambahkan data aktivis kepada user anda.</span>
							</div> 
						</div>
						...
						<div class="col-md-12" v-else>
							...
							<transition enter-active-class="animated fadeIn" mode="out-in">
								<div v-show="tabName == 'info'">
									<detail-informasi :kelas="kelas" @changeTab="changeTab" @fetchCountPeserta="fetchCountPeserta" @fetch="fetch" @back="back"></detail-informasi>
								</div>
							</transition>
