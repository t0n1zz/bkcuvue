	...
	<div>
					...
					<form @submit.prevent="save" enctype="multipart/form-data" data-vv-scope="form">
								...
								<div class="row">
									...
									<div class="col-md-12">
										<div class="form-group">
											...
											<!-- imageupload -->
											<app-image-upload :image_loc="'/images/pertemuan/'" :image_temp="form.gambar"
									...
									<!-- kode diklat bkcu -->
									<div class="col-md-12"
										v-if="$route.params.tipe == 'diklat_bkcu' || $route.params.tipe == 'diklat_bkcu_internal'">
										<div class="form-group" :class="{ 'has-error': errors.has('form.kode_kegiatan') }">
											...
											<h5 :class="{ 'text-danger': errors.has('form.kode_kegiatan') }">
												...
												Kode & Nama Kegiatan: <wajib-badge></wajib-badge>
											</h5>

											<!-- text -->
											<select class="form-control" name="id_kode" v-model="form.id_kode"
												data-width="100%" data-vv-as="KodeKegiatan"
												@change="changeKodeKegiatan($event.target.value)"
												:disabled="itemKodeKegiatanStat.length === 0">
												<option disabled value="">
													<span v-if="itemKodeKegiatanStat === 'loading'">Mohon tunggu...</span>
													<span v-else>Silahkan pilih kode</span>
												</option>
												<option v-for="(kodeKegiatan, index) in itemKodeKegiatan"
													:value="kodeKegiatan.id" :key="index">{{ kodeKegiatan.kode }} -
													{{ kodeKegiatan.name }}</option>
											</select>
									...
									<div class="col-md-6" v-else>
										<div class="form-group" :class="{ 'has-error': errors.has('form.kode_diklat') }">
											...
											<h5 :class="{ 'text-danger': errors.has('form.kode_diklat') }">
												...
												Kode Kegiatan: <wajib-badge></wajib-badge>
											</h5>

											<!-- text -->
											<input type="text" name="kode kegiatan" class="form-control"
												placeholder="Silahkan masukkan kode kegiatan" v-validate="'required|min:5'"
												data-vv-as="Kode Kegiatan" v-model="form.kode_diklat">
									...
									<div class="col-md-6"
										...
										<div class="form-group" :class="{ 'has-error': errors.has('form.name') }">
											...
											<input type="text" name="name" class="form-control"
												placeholder="Silahkan masukkan nama diklat" v-validate="'required|min:5'"
									...
									<div class="col-md-4">
										<div class="form-group" :class="{ 'has-error': errors.has('form.periode') }">
											...
											<h5 :class="{ 'text-danger': errors.has('form.periode') }">
												...
												Periode: <wajib-badge></wajib-badge> <info-icon
													:message="'Format: tahun. Contoh: 2019'"></info-icon>
											</h5>

											<!-- input -->
											<cleave name="periode" v-model="form.periode" class="form-control" :raw="false"
												:options="cleaveOption.year" placeholder="Silahkan masukkan periode"
									...
									<div class="col-md-4">
										<div class="form-group" :class="{ 'has-error': errors.has('form.mulai') }">
											...
											<h5 :class="{ 'text-danger': errors.has('form.mulai') }">
												...
												Tgl. Mulai: <wajib-badge></wajib-badge>
											</h5>

											<!-- input -->
											<date-picker @dateSelected="form.mulai = $event"
												:defaultDate="form.mulai"></date-picker>
											<input name="mulai" v-model="form.mulai" v-show="false" v-validate="'required'"
									...
									<div class="col-md-4">
										<div class="form-group" :class="{ 'has-error': errors.has('form.selesai') }">
											...
											<h5 :class="{ 'text-danger': errors.has('form.selesai') }">
												...
												Tgl. Selesai: <wajib-badge></wajib-badge>
											</h5>

											<!-- input  -->
											<date-picker @dateSelected="form.selesai = $event"
												:defaultDate="form.selesai"></date-picker>
											<input name="selesai" v-model="form.selesai" v-show="false"
												v-validate="'required'" data-vv-as="Tgl. selesai" />
									...
									<div class="col-md-4">
										<div class="form-group" :class="{ 'has-error': errors.has('form.durasi') }">
											...
											<h5 :class="{ 'text-danger': errors.has('form.durasi') }">
												...
												Durasi: <small>jam</small> <wajib-badge></wajib-badge>
											</h5>

											<!-- input -->
											<cleave name="durasi" v-model="form.durasi" class="form-control" :raw="false"
												:options="cleaveOption.number3"
												placeholder="Silahkan masukkan durasi kegiatan" v-validate="'required'"
												data-vv-as="Durasi"></cleave>
									...
									<div class="col-md-4">
										<div class="form-group" :class="{ 'has-error': errors.has('form.peserta_min') }">
											...
											<h5 :class="{ 'text-danger': errors.has('form.peserta_min') }">
												...
												Peserta Min: <wajib-badge></wajib-badge>
											</h5>

											<!-- input -->
											<cleave name="peserta_min" v-model="form.peserta_min" class="form-control"
												:raw="false" :options="cleaveOption.number3"
												placeholder="Silahkan masukkan peserta min" v-validate="'required'"
												data-vv-as="Peserta min"></cleave>
									...
									<div class="col-md-4">
										<div class="form-group" :class="{ 'has-error': errors.has('form.peserta_max') }">
											...
											<h5 :class="{ 'text-danger': errors.has('form.peserta_max') }">
												...
												Peserta Max: <wajib-badge></wajib-badge>
											</h5>

											<!-- input -->
											<cleave name="peserta_max" v-model="form.peserta_max" class="form-control"
												:raw="false" :options="cleaveOption.number3"
												placeholder="Silahkan masukkan peserta max" v-validate="'required'"
												data-vv-as="Peserta max"></cleave>
									...
									<div class="col-md-4">
										<div class="form-group" :class="{ 'has-error': errors.has('form.peserta_max_cu') }">
											...
											<h5 :class="{ 'text-danger': errors.has('form.peserta_max_cu') }">
												...
												Peserta Max Per CU: <wajib-badge></wajib-badge>
											</h5>

											<!-- input -->
											<cleave name="peserta_max_cu" v-model="form.peserta_max_cu" class="form-control"
												:raw="false" :options="cleaveOption.number3"
												placeholder="Silahkan masukkan peserta max per cu" v-validate="'required'"
												data-vv-as="Peserta max per cu"></cleave>

											<!-- error message -->
											<small class="text-muted text-danger" v-if="errors.has('form.peserta_max_cu')">
												<i class="icon-arrow-small-right"></i> {{
													errors.first('form.peserta_max_cu') }}
											</small>
											<small class="text-muted" v-else>&nbsp;</small>
										</div>
									</div>
									...
									<div class="col-md-12">
										<div class="form-group">
											...
											<div class="form-check form-check-inline">
												<label class="form-check-label">
													<input type="checkbox" class="form-check-input" value="7"
														v-model="sasaran">
													Supervisor
												</label>
											</div>
											<div class="form-check form-check-inline">
												<label class="form-check-label">
													<input type="checkbox" class="form-check-input" value="8"
														v-model="sasaran">
													Staf
												</label>
											</div>
											...
											<div class="form-check form-check-inline">
												<label class="form-check-label">
													<input type="checkbox" class="form-check-input" value="11"
														v-model="sasaran">
													Kelompok inti
												</label>
											</div>
											<div class="form-check form-check-inline">
												<label class="form-check-label">
													<input type="checkbox" class="form-check-input" value="12"
														v-model="sasaran">
													Supporting Unit
												</label>
											</div>
											<div class="form-check form-check-inline">
												<label class="form-check-label">
													<input type="checkbox" class="form-check-input" value="13"
														v-model="sasaran">
													Vendor sMartCU
												</label>
											</div>
								...
								<div class="row">
									...
									<div class="col-md-12">
										<div class="form-group" :class="{ 'has-error': errors.has('form.tipe_tempat') }">
											...
											<!-- select -->
											<select class="form-control" name="tipe_tempat" v-model="form.tipe_tempat"
												data-width="100%" v-validate="'required'" data-vv-as="Tipe Tempat">
									...
									<div class="col-md-4" v-if="form.tipe_tempat == 'OFFLINE'">
										<div class="form-group" :class="{ 'has-error': errors.has('form.id_provinces') }">
											...
											<!-- select -->
											<select class="form-control" name="id_provinces" v-model="form.id_provinces"
												data-width="100%" data-vv-as="Provinsi"
									...
									<div class="col-md-4" v-if="form.tipe_tempat == 'OFFLINE'">
										<div class="form-group" :class="{ 'has-error': errors.has('form.id_regencies') }">
											...
											<!-- select -->
											<select class="form-control" name="id_regencies" v-model="form.id_regencies"
												data-width="100%" data-vv-as="Kabupaten"
									...
									<div class="col-md-4" v-if="form.tipe_tempat == 'OFFLINE'">
										<div class="form-group" :class="{ 'has-error': errors.has('form.id_tempat') }">
											...
											<div class="input-group">
												<!-- select -->
												<select class="form-control" name="id_tempat" v-model="form.id_tempat"
													data-vv-as="Tempat" :disabled="!form.id_regencies"
													@change="changeTempat($event.target.value)">
													<option disabled value="">
													...
													<option v-for="(tempat, index) in modelTempat" :value="tempat.id"
														:key="index">{{ tempat.name }}</option>
												</select>

												<!-- button -->
												<div class="input-group-append">
													<button type="button" class="btn btn-light"
														@click.prevent="modalOpen('tempat')"
														:disabled="form.id_regencies === ''">
											...
											<div class="media flex-column flex-sm-row mt-0 mb-3">
												<div class="mr-sm-3 mb-2 mb-sm-0">
													<div class="card-img-actions">
														<a href="#"
															@click.prevent="modalImageShow('/images/tempat/' + tempatData.gambar + '.jpg')"
															v-if="tempatData.gambar">
															<img :src="'/images/tempat/' + tempatData.gambar + 'n.jpg'"
																class="img-fluid img-preview rounded">
															<span class="card-img-actions-overlay card-img"><i
																	class="icon-enlarge6 icon-2x"></i></span>
														</a>
														<a href="#" @click.prevent="modalImageShow('/images/no_image.jpg')"
															v-else>
													...
													<div class="row">
														<div class="col-md-6">
															<ul class="list list-unstyled mb-0">
																<li><b>Provinsi:</b>
																	<span v-if="tempatData.provinces">{{
																		tempatData.provinces.name }}</span>
																	<span v-else>-</span>
																</li>
																<li><b>Kabupaten/Kota:</b>
																	<span v-if="tempatData.regencies">{{
																		tempatData.regencies.name }}</span>
																	<span v-else>-</span>
																</li>
																<li><b>Kecamatan:</b>
																	<span v-if="tempatData.districts">{{
																		tempatData.districts.name }}</span>
																	<span v-else>-</span>
																</li>
																<li><b>Kelurahan:</b>
																	<span v-if="tempatData.villages">{{
																		tempatData.villages.name }}</span>
																	<span v-else>-</span>
																</li>
																<li><b>Alamat:</b>
																	<span v-if="tempatData.alamat">{{ tempatData.alamat
																	}}</span>
																	<span v-else>-</span>
																</li>
															</ul>
														...
														<div class="col-md-6">
															<ul class="list list-unstyled mb-0">
																<li><b>Website:</b>
																	<span v-if="tempatData.website">{{ tempatData.website
																	}}</span>
																	<span v-else>-</span>
																</li>
																<li><b>Email:</b>
																	<span v-if="tempatData.email">{{ tempatData.email
																	}}</span>
																	<span v-else>-</span>
																</li>
																<li><b>No. Telp:</b>
																	<span v-if="tempatData.telp">{{ tempatData.telp
																	}}</span>
																	<span v-else>-</span>
																</li>
																<li><b>No. Hp:</b>
								...
								<div class="row">
									...
									<div class="col-md-12">
										<div class="form-group">
											...
											<ckeditor type="classic" :config="ckeditorNoImageConfig"
												v-model="form.keterangan"></ckeditor>
									...
									<div class="col-md-12">
										<div class="form-group">
											...
											<ckeditor type="classic" :config="ckeditorNoImageConfig" v-model="form.jadwal">
											</ckeditor>
										</div>
									</div>
						...
						<div class="card">
							...
							<div class="card-body pb-2">
								<div class="row">
									...
									<div class="col-md-12">
										...
										<button class="btn btn-light mb-1" @click.prevent="modalOpen('hapusPanitia')"
											:disabled="!selectedItemPanitia.index">
							...
							<data-table :items="itemDataPanitia" :columnData="columnDataPanitia"
								:itemDataStat="itemDataPanitiaStat">
								<template slot="item-desktop" slot-scope="props">
									<tr :class="{ 'bg-info': selectedItemPanitia.index == props.index + 1 }"
										class="text-nowrap" @click="selectedRow(props.item, props.index + 1, 'panitia')"
										v-if="props.item">
										<td>{{ props.index + 1 }}</td>
										<td>
											<img :src="'/images/aktivis/' + props.item.gambar + 'n.jpg'" width="35px"
												class="img-rounded img-fluid wmin-sm" v-if="props.item.gambar">
											<img :src="'/images/no_image.jpg'" width="35px"
						...
						<div class="card">
							...
							<div class="card-body">
								<div class="row col-md-12">
									<select class="form-control" name="id_sertifikat" v-model="form.id_sertifikat"
										data-width="100%" data-vv-as="Sertifikat"
										@change="changeSertifikat($event.target.value)"
										:disabled="itemDataStat.length === 0">
										<option disabled value="">
										...
										<option v-for="(sertifikat, index) in itemData.data" :value="sertifikat.id"
											:key="index">{{ sertifikat.name }} -- {{ sertifikat.kode_sertifikat }}</option>
									</select>
								</div>
							</div>
						</div>
						...
						<div class="card">
							<div class="card-header bg-white">
								<h5 class="card-title">5. Form Evaluasi <wajib-badge></wajib-badge></h5>
							</div>

							<div class="card-body">
								<div class="row col-md-12">
									<!-- select -->
									<select class="form-control" name="kegiatan_id" v-model="form.evaluasi_id"
										data-width="100%" v-validate="'required'" data-vv-as="evaluasi"
										@change="changeDataForm($event.target.value)">
										<option disabled value="">
											<span v-if="itemEvaluasiFormStatS === 'loading'">Mohon tunggu...</span>
											<span v-else>Silahkan pilih form evaluasi</span>
										</option>
										<option value="0">Form Evaluasi Baru</option>
										<option disabled value="">
											--------------------------------------------------------------------</option>
										<option v-for="(data, index) in itemDataForm" :value="data.kegiatan_id"
											:key="index">
											Form Evaluasi {{ data.kegiatan_name }}
										</option>
									</select>
								</div>
							</div>

							<div class="card-body" v-if="form.evaluasi_id === '0'">
								<div class="row">
									<form class="col-md-12" @submit.prevent="save" enctype="multipart/form-data"
										data-vv-scope="form">
										<!-- pertanyaan -->
										<div class="form-group col-md-12" v-for="(per, p) in pertanyaan" :key="p">
											<div class="row">
												<div class="col-md-6">
													<h5 :class="{ 'text-danger': errors.has('form.pertanyaan.tipe') }">
														<i class="icon-cross2"
															v-if="errors.has('form.pertanyaan.tipe')"></i>
														Tipe Evaluasi:
														<wajib-badge></wajib-badge>
													</h5>
													<!-- select -->
													<select class="form-control" name="tipeForm" v-model="per.tipe"
														data-width="100%" v-validate="'required'" data-vv-as="evaluasi">
														<option disabled value="">
															<span v-if="itemEvaluasiFormStatS === 'loading'">Mohon
																tunggu...</span>
															<span v-else>Silahkan pilih jenis evaluasi</span>
														</option>
												...
												<div class="col-md-6" v-if="per.tipe !== ''">
													<h5 v-if="per.tipe === 'pilihan'"
														:class="{ 'text-danger': errors.has('form.pertanyaan') }">
														<i class="icon-cross2" v-if="errors.has('form.pertanyaan')"></i>
														Pertanyaan Evaluasi:
														<wajib-badge></wajib-badge>
													</h5>
													<h5 v-if="per.tipe === 'saran'"
														:class="{ 'text-danger': errors.has('form.pertanyaan') }">
														<i class="icon-cross2" v-if="errors.has('form.pertanyaan')"></i>
														Saran Evaluasi:
														<wajib-badge></wajib-badge>
													...
													<input type=" text" class="form-control"
														placeholder="Silahkan masukkan nama pertanyaan" v-model="per.name">
													<br />
													<span>
														<div class="form-group">
															<button @click="remove(p)"
																v-show="p || (!p && pertanyaan.length > 1)" type="button"
																class="btn bg-warning-400 mb-1"><i class="icon-bin2"></i>
																Hapus</button>
														</div>
														<div class="form-group">
															<button @click="add(p)" v-show="p == pertanyaan.length - 1"
																type="button" class="btn bg-blue"><i
																	class="icon-plus22"></i>
							...
							<div class="card-body" v-if="form.evaluasi_id !== '0' && !form.evaluasi_id == ''">
								<div class="row">
									<form class="col-md-12" @submit.prevent="save" enctype="multipart/form-data"
										data-vv-scope="form">
										<!-- pertanyaan -->
										<div class="form-group col-md-12" v-for="(per, p) in itemEvaluasiFormS" :key="p">
											<div class="row" v-if="per.kegiatan_id == form.evaluasi_id">
												<div class="col-md-6">
													<h5 :class="{ 'text-danger': errors.has('itemEvaluasiFormS.tipe') }">
														<i class="icon-cross2"
															v-if="errors.has('itemEvaluasiFormS.tipe')"></i>
														Tipe Evaluasi:
													</h5>
													<!-- select -->
													<select disabled="true" class="form-control" name="tipeForm"
														v-model="per.tipe" data-width="100%" v-validate="'required'"
														data-vv-as="evaluasi">
														<option disabled value="">
															<span v-if="itemEvaluasiFormStatS === 'loading'">Mohon
																tunggu...</span>
												...
												<div class="col-md-6" v-if="per.tipe !== ''">
													<h5 v-if="per.tipe === 'pilihan'"
														:class="{ 'text-danger': errors.has('form.itemEvaluasiFormS') }">
														<i class="icon-cross2"
															v-if="errors.has('form.itemEvaluasiFormS')"></i>
														Pertanyaan Evaluasi:
													</h5>
													<h5 v-if="per.tipe === 'saran'"
														:class="{ 'text-danger': errors.has('form.itemEvaluasiFormS') }">
		...
		<app-modal :show="modalShow" :state="modalState" :title="modalTitle" :content="modalContent" :size="modalSize"
			...
			<template slot="modal-body1">
				<!-- panitia -->
				<form-panitia :mode="formPanitiaMode" :selected="selectedItemPanitia" @createPanitia="createPanitia"
					@editPanitia="editPanitia" @tutup="modalTutup"
					v-if="state == 'tambahPanitia' || state == 'ubahPanitia'"></form-panitia>
				<!-- pilih -->
				<form-pilih :mode="formPilihMode" :selected="selectedItemPilih" @createPilih="createPilih"
					@editPilih="editPilih" @tutup="modalTutup"
					v-else-if="state == 'tambahPilih' || state == 'ubahPilih'"></form-pilih>
			</template>

			<!-- tambah tempat -->
			<template slot="modal-body2">
				<form-tempat :id_provinces="form.id_provinces" :id_regencies="form.id_regencies"
...
export default {
	...
	watch: {
		formStat(value) {
			if (value === "success") {
				if (this.$route.meta.mode == 'edit') {
					this.form.evaluasi_id = this.form.id;
		...
		itemEvaluasiFormStatS(value) {
			if (value == 'success') {
				const seenIds = new Set()
				for (const data of this.itemEvaluasiFormS) {
					if (!seenIds.has(data.kegiatan_id)) {
						seenIds.add(data.kegiatan_id)
						this.itemDataForm.push(data)
					}
				}
				return this.itemDataForm;
			}
	...
	methods: {
		fetch() {
			...
			this.$store.dispatch(this.kelas + '/getFormEvaluasi');
		...
		changeDataForm(event) {
			this.modalOpen('evaluasi');
			this.form.evaluasi_id = event;
		...
		save() {
			this.form.pertanyaan = this.pertanyaan;
		...
		modalOpen(state, isMobile, itemMobile) {
			...
			if (state == 'hapusPanitia') {
				...
				this.modalButton = 'Ok';
				this.modalSize = 'modal-lg';
			} else if (state == 'evaluasi') {
				this.modalState = 'confirm-tutup';
				this.modalColor = 'bg-primary';
				this.modalTitle = 'Mengubah Form Evaluasi Akan Menghapus Data Evaluasi yang Diisi Oleh Peserta Kegiatan !';
				this.modalButton = 'Ok';
				this.modalSize = 'modal-lg';
			}
		},
	...
	computed: {
		...mapGetters('kegiatanBKCU', {
			...
			itemEvaluasiFormS: 'dataFormS',
			itemEvaluasiFormStatS: 'dataFormStatS'
		}),
		...mapGetters('tempat', {
