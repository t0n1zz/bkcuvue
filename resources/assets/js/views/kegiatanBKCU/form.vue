                ...
                <div class="row">
                  ...
                  <div class="col-md-4">
                    <div
                      class="form-group"
                      :class="{
                        'has-error': errors.has('form.peserta_max_cu'),
                      }"
                    >
                      <!-- title -->
                      <h5
                        :class="{
                          'text-danger': errors.has('form.peserta_max_cu'),
                        }"
                      >
                        <i
                          class="icon-cross2"
                          v-if="errors.has('form.peserta_max_cu')"
                        ></i>
                ...
                <div class="row">
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <small class="text-muted"
                        ...
                        pertanyaan yang bisa diberikan CU</small
                      >
                    </div>
                  </div>
                  <div class="col-md-6">
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <small class="text-muted"
                        >Kosongkan apabila tidak ada batasan pada jumlah
                        keputusan yang bisa diberikan CU</small
                      >
                    </div>
                  </div>
...
export default {
  ...
  data() {
    return {
      title: "Tambah Pertemuan PUSKOPCUINA",
      titleDesc: "Menambah pertemuan PUSKOPCUINA baru",
