				...
				this.$validator.validateAll('formKeputusan').then((result) => {
					if (result) {
						if(this.mode == 'edit'){
							...
							this.$store.dispatch('kegiatanBKCU/updateKeputusan', [this.formKeputusan.id, this.formKeputusan]);
						}else{
							this.formKeputusan.id_user = this.currentUser.id;
							this.formKeputusan.id_cu = this.currentUser.id_cu;
							this.$store.dispatch('kegiatanBKCU/storeKeputusan', [this.kegiatan_id, this.formKeputusan]);
						}
					}else{
						this.submited = true;
					}	
