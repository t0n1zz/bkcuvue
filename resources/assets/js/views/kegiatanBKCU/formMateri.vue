		...
		<form @submit.prevent="save" enctype="multipart/form-data" data-vv-scope="formMateri">
			...
			<div class="form-group" :class="{ 'has-error': errors.has('formMateri.name') }">
				...
				<input type="text" name="name" class="form-control" placeholder="Silahkan masukkan nama"
					v-validate="'required'" data-vv-as="Nama di nametag" v-model="formMateri.name">
			...
			<div class="form-group">
				...
				<textarea rows="5" type="text" name="keterangan" class="form-control"
					placeholder="Silahkan masukkan keterangan " v-model="formMateri.keterangan"></textarea>
			...
			<div class="form-group" :class="{ 'has-error': errors.has('formMateri.format') }" v-if="mode == 'create'">
				...
				<!-- select -->
				<select class="form-control" name="format" v-model="formMateri.format" data-width="100%"
					v-validate="'required'" data-vv-as="format">
			...
			<template v-if="mode == 'create'">
				...
				<div class="form-group" v-else-if="formMateri.format == 'link'">
					...
					<!-- textarea -->
					<input type="text" name="link" class="form-control" placeholder="Silahkan masukkan link"
