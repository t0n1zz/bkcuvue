	...
	export default {
      ...
      save(){
              ...
              this.formKomentar.id_user = this.currentUser.id;
							this.$store.dispatch('kegiatanBKCU/updateKeputusanKomentar', [this.formKomentar.id, this.formKomentar]);
						}else{
              this.formKomentar.id_user = this.currentUser.id;
							this.formKomentar.id_cu = this.currentUser.id_cu;
							this.$store.dispatch('kegiatanBKCU/storeKeputusanKomentar', [this.kegiatan_id, this.formKomentar]);
            }
					}else{
						this.submited = true;
					}	
