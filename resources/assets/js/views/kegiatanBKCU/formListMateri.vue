<template>
	<div>
		<!-- message -->
		<message v-if="errors.any('formListMateri') && submited" :title="'Oops, terjadi kesalahan'"
		...
		<form @submit.prevent="save" enctype="multipart/form-data" data-vv-scope="formListMateri">
			...
			<div class="form-group" :class="{ 'has-error': errors.has('formListMateri.nama') }">
				...
				<!-- text -->
				<input type="text" name="name" class="form-control" placeholder="Silahkan masukkan nama materi"
					v-validate="'required'" v-model="formListMateri.nama">
			...
			<div class="form-group" :class="{ 'has-error': errors.has('formListMateri.waktu') }">
				...
				<!-- text -->
				<input type="text" name="waktu" class="form-control" placeholder="Silahkan masukkan waktu (jam)"
					v-validate="'required'" v-model="formListMateri.waktu">
