  ...
  <div>
    <div class="row">
      ...
      <div class="col-lg-3 col-md-4 order-md-12">
        ...
        <div class="card">
          <div class="card-header bg-transparent header-elements-inline">
            <span class="text-uppercase font-size-sm font-weight-semibold">Sasaran CU</span>
            <div class="header-elements">
              <div class="list-icons">
                <a class="list-icons-item" data-action="collapse"></a>
              </div>
          ...
          <div class="card-body">
            <span v-if="item.sasaran_cu">
              <label v-for="(sasaran_cu, index) in item.sasaran_cu" :key="index" class="badge badge-primary ml-1">
                {{ sasaran_cu.name }}
              </label>
            </span>
          </div>
