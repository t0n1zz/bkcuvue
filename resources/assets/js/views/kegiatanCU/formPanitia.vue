<template>
  <div>
    <form @submit.prevent="save" data-vv-scope="formPanitia">
      ...
      <div
        class="form-group"
        :class="{ 'has-error': errors.has('formPanitia.asal') }"
        v-if="mode == 'create'"
      >
        <!-- title -->
        ...
        <select
          class="form-control"
          name="asal"
          v-model="formPanitia.asal"
          data-width="100%"
          @change="changeAsal($event.target.value)"
          v-validate="'required'"
          data-vv-as="asal"
        >
        ...
        <small
          ...
          v-if="errors.has('formPanitia.asal')"
        >
          <i class="icon-arrow-small-right"></i>
          {{ errors.first("formPanitia.asal") }}
        </small>
          ...
          <div class="media flex-column flex-sm-row mt-0">
            <div class="mr-sm-3 mb-2 mb-sm-0">
              <div class="card-img-actions" v-if="formPanitia.asal == 'dalam'">
                <img
                  :src="'/images/aktivis/' + formPanitia.gambar + '.jpg'"
                  class="img-fluid img-preview rounded"
                  v-if="formPanitia.gambar"
                />
                <img
              ...
              <div class="card-img-actions" v-if="formPanitia.asal == 'luar'">
                <img
                  :src="'/images/mitra_orang/' + formPanitia.gambar + '.jpg'"
                  class="img-fluid img-preview rounded"
                  v-if="formPanitia.gambar"
                />
                <img
              ...
              <div
                ...
                v-if="formPanitia.asal == 'luar lembaga'"
              >
                <img
                  :src="'/images/mitra_lembaga/' + formPanitia.gambar + '.jpg'"
                  class="img-fluid img-preview rounded"
                  v-if="formPanitia.gambar"
                />
                <img
      ...
      <data-viewer
        :title="'Aktivis'"
        :columnData="columnDataDalam"
        :itemData="itemDataDalam"
        :query="query"
        :itemDataStat="itemDataDalamStat"
        @fetch="fetchDalam"
        :isDasar="'true'"
        :isNoButtonRow="'true'"
        v-if="
          formPanitia.asal == 'dalam' &&
          formPanitia.aktivis_id == '' &&
          mode == 'create'
        "
      >
        <!-- item  -->
          ...
          >
            <td>
              {{
                props.index +
                1 +
                (+itemDataDalam.current_page - 1) * +itemDataDalam.per_page +
                "."
              }}
            </td>
            <td>
              <img
                :src="'/images/' + kelas + '/' + props.item.gambar + 'n.jpg'"
            ...
            <td>
              <check-value
                ...
                v-if="props.item.pekerjaan_aktif"
              ></check-value>
              <span v-else>-</span>
            </td>
            <td>
              <check-value
                ...
                v-if="props.item.pendidikan_tertinggi"
              ></check-value>
              <span v-else>-</span>
            </td>
            <td>
      ...
      <data-viewer
        ...
        :columnData="columnDataLuar"
        :itemData="itemDataLuar"
        :query="query"
        :itemDataStat="itemDataLuarStat"
        @fetch="fetchLuar"
        :isDasar="'true'"
        :isNoButtonRow="'true'"
        v-if="
          formPanitia.asal == 'luar' &&
          formPanitia.aktivis_id == '' &&
          mode == 'create'
        "
      >
          ...
          >
            <td>
              {{
                props.index +
                1 +
                (+itemDataLuar.current_page - 1) * +itemDataLuar.per_page +
                "."
              }}
            </td>
            <td>
      ...
      <data-viewer
        :title="'Lembaga Mitra'"
        :columnData="columnDataLuarLembaga"
        :itemData="itemDataLuarLembaga"
        :query="query"
        :itemDataStat="itemDataLuarLembagaStat"
        @fetch="fetchLuarLembaga"
        :isDasar="'true'"
        :isNoButtonRow="'true'"
        v-if="
          formPanitia.asal == 'luar lembaga' &&
          formPanitia.aktivis_id == '' &&
          mode == 'create'
        "
      >
          ...
          >
            <td>
              {{
                props.index +
                1 +
                (+itemDataLuarLembaga.current_page - 1) *
                  +itemDataLuarLembaga.per_page +
                "."
              }}
            </td>
            <td>
      ...
      <div
        class="form-group"
        :class="{ 'has-error': errors.has('formPanitia.peran') }"
      >
        <!-- title -->
        ...
        <small
          class="text-muted text-danger"
          v-if="errors.has('formPanitia.peran')"
        >
          <i class="icon-arrow-small-right"></i>
          {{ errors.first("formPanitia.peran") }}
        </small>
        <small class="text-muted" v-else>&nbsp;</small>
      </div>
      ...
      <div class="form-group">
        ...
        <textarea
          ...
          v-model="formPanitia.keterangan"
        ></textarea>
      </div>

      <!-- message -->
      <message
        v-if="errors.any('formPanitia') && submited"
      ...
      <div class="text-center d-none d-md-block">
        ...
        <button
          ...
          :disabled="formPanitia.aktivis_id == ''"
        >
