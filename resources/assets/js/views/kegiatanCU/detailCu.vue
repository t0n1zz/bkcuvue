      ...
      <div class="content-wrapper">
        <div class="content">
          ...
          <div class="row">
            ...
            <div class="col-md-12">
              <div class="card">
                <template v-if="item.tipe == 'diklat_cu'">
                  <img
                    :src="'/images/diklat/' + item.gambar + '.jpg'"
                    class="img-fluid wmin-sm"
                    v-if="item.gambar"
                  />
                </template>
                <template v-else-if="item.tipe == 'pertemuan_cu'">
                  <img
                    :src="'/images/pertemuan/' + item.gambar + '.jpg'"
                    class="img-fluid wmin-sm"
                    v-if="item.gambar"
                  />
                </template>
            ...
            <div class="col-lg-3 col-md-4 order-md-12">
                ...
                <div div class="card-body">
                  ...
                  <template v-if="item.tipe == 'diklat_cu'">
                    ...
                    <button
                      ...
                      v-if="
                        (currentUser.id_cu == 0 && statusUser) ||
                        (currentUser.id_cu != 0 && statusUser) ||
                        (currentUser.can && currentUser.can['update_diklat_cu'])
                      "
                    >
                    ...
                    <button
                      ...
                      v-if="
                        (currentUser.id_cu != 0 &&
                          ...
                          item.status == 1) ||
                        (currentUser.can &&
                          currentUser.can['destroy_diklat_cu'] &&
                          item.status == 1)
                      "
                    >
                    ...
                    <button
                      ...
                      v-if="
                        ...
                        (currentUser.id_cu != 0 &&
                          currentUser.can &&
                          currentUser.can['update_diklat_cu']) ||
                        (currentUser.id_cu == 0 &&
                          currentUser.can &&
                          currentUser.can['index_diklat_cu'] &&
                          item.status == 2)
                      "
                    >
                  ...
                  <template v-else-if="item.tipe == 'pertemuan_cu'">
                    ...
                    <button
                      ...
                      v-if="
                        ...
                        (currentUser.id_cu != 0 &&
                          currentUser.can &&
                          currentUser.can['update_pertemuan_cu'])
                      "
                    >
                    ...
                    <button
                      ...
                      v-if="
                        ...
                        (currentUser.id_cu != 0 &&
                          currentUser.can &&
                          currentUser.can['destroy_pertemuan_cu'] &&
                          item.status == 1)
                      "
                    >
                    ...
                    <button
                      ...
                      v-if="
                        ...
                        (currentUser.id_cu == 0 &&
                          currentUser.can &&
                          currentUser.can['index_pertemuan_cu'] &&
                          item.status == 2)
                      "
                    >
                  ...
                  <template v-if="item.pilih && item.pilih.length > 0">
                    <button
                      class="btn bg-success btn-block mb-2"
                      @click.prevent="modalOpen('tambahKeputusan')"
                      v-if="
                        (item.status == 4 && statusUser) ||
                        (item.status == 4 &&
                          !currentUser.can['update_diklat_cu']) ||
                        (item.status == 4 &&
                          !currentUser.can['update_pertemuan_cu'])
                  ...
                  <button
                    class="btn bg-info btn-block mb-2"
              ...
              <div class="card">
                ...
                <table
                  class="table table-borderless table-xs border-top-0 my-2"
                >
                  <tbody>
                    <tr>
                      ...
                      <td class="text-right">
                        <span
                          v-html="$options.filters.statusDiklat(item.status)"
                        ></span>
                      </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                      ...
                      <td
                        class="text-right"
                        v-html="$options.filters.dateMonth(item.mulai)"
                      ></td>
                    </tr>
                    <tr>
                      ...
                      <td
                        class="text-right"
                        v-html="$options.filters.dateMonth(item.selesai)"
                      ></td>
                    </tr>
                    <tr>
              ...
              <div class="card">
                ...
                <div class="card-body">
                  <span v-if="item.sasaran">
                    <label
                      v-for="(sasaran, index) in item.sasaran"
                      :key="index"
              ...
              <div class="card" v-if="item.tempat">
                ...
                <div class="card-img-actions mx-1 mt-1">
                  <a
                    ...
                    @click.prevent="
                      modalImageOpen(
                        '/images/tempat/' + item.tempat.gambar + '.jpg'
                      )
                    "
                    v-if="item.tempat && item.tempat.gambar"
                  >
                    <img
                      :src="'/images/tempat/' + item.tempat.gambar + 'n.jpg'"
                      class="card-img img-fluid"
                    />
                    <span class="card-img-actions-overlay card-img"
                      ><i class="icon-enlarge6 icon-2x"></i
                    ></span>
                  </a>
                  <a
                    href="#"
                    @click.prevent="modalImageOpen('/images/no_image.jpg')"
                    v-else
                  >
                    <img
                ...
                >
                  <tbody>
                    <tr>
                      ...
                      <td class="text-right">
                        <check-value :value="item.tempat.name"></check-value>
                      </td>
                    </tr>
                    <tr>
                      <td class="font-weight-semibold">Email:</td>
                      <td class="text-right">
                        <check-value :value="item.tempat.email"></check-value>
                      </td>
                    </tr>
                    <tr>
                      <td class="font-weight-semibold">No. Telp:</td>
                      <td class="text-right">
                        <check-value :value="item.tempat.telp"></check-value>
                      </td>
                    </tr>
                    <tr>
                      <td class="font-weight-semibold">No. Hp:</td>
                      <td class="text-right">
                        <check-value :value="item.tempat.hp"></check-value>
                      </td>
                    </tr>
                    <tr>
                      <td class="font-weight-semibold">Alamat:</td>
                      <td class="text-right">
                        <check-value :value="item.tempat.alamat"></check-value>
                      </td>
                    </tr>
                    <tr>
                      <td class="font-weight-semibold">Website:</td>
                      <td class="text-right">
                        <check-value :value="item.tempat.website"></check-value>
                      </td>
                    </tr>
                  </tbody>
                </table>
              ...
              <div class="card" v-else-if="item.tipe_tempat == 'ONLINE'">
                ...
                <div class="card-body">Dilaksanakan secara online</div>
              </div>
              <div class="card" v-else>
                ...
                <div class="card-body">Belum menentukan tempat pertemuan</div>
              </div>
            </div>
            ...
            <div class="col-lg-9 col-md-8 order-md-1">
                  ...
                  <ul class="nav nav-tabs nav-tabs-bottom flex-nowrap mb-0">
                    ...
                    <li class="nav-item">
                      <a
                        ...
                        @click.prevent="changeTab('materi')"
                        ><i class="icon-folder-download2 mr-2"></i>
                        Unduhan
                      </a>
                    </li>
                    ...
                    <li class="nav-item">
                      <a
                        ...
                        @click.prevent="changeTab('tugas')"
                        ><i class="icon-paste mr-2"></i>
                        Tugas
                      </a>
                    </li>
                    ...
                    <li
                      class="nav-item"
                      v-if="item.pilih && item.pilih.length > 0"
                    >
                      <a
                        href="#"
                        class="nav-link"
                        :class="{ active: tabName == 'keputusan' }"
                        @click.prevent="changeTab('keputusan')"
                        ><i class="icon-hammer mr-2"></i>
                        Keputusan
                        <span
                          class="badge badge-success ml-2"
                          v-if="
                            countKeputusanStat == 'success' &&
                            countKeputusan[0] > 0
                          "
                    ...
                    <li class="nav-item">
                      <a
                        ...
                        @click.prevent="changeTab('pertanyaan')"
                        ><i class="icon-question7 mr-2"></i>
                        Pertanyaan
                        <span
                          class="badge badge-info ml-2"
                          v-if="
                            countPertanyaanStat == 'success' &&
                            countPertanyaan[0] > 0
                          "
                    ...
                    <li class="nav-item">
                      <a
                        ...
                        @click.prevent="changeTab('pesertaTerdaftar')"
                        ><i class="icon-people mr-2"></i>
                        Terdaftar
                        <span
                          class="badge badge-dark ml-2"
                          v-if="
                            countPesertaStat == 'success' &&
                            countPeserta > 0 &&
                            currentUser.id_cu == 0
                          "
                          >{{ countPeserta }}</span
                    ...
                    <li class="nav-item">
                      <a
                        ...
                        @click.prevent="changeTab('pesertaHadir')"
                        ><i class="icon-accessibility mr-2"></i>
                        Hadir
                        <span
                          class="badge badge-dark ml-2"
                          v-if="
                            countPesertaHadirStat == 'success' &&
                            countPesertaHadir > 0
                          "
                    ...
                    <li class="nav-item">
                      <a
                        ...
                        @click.prevent="changeTab('statistik')"
                        ><i class="icon-equalizer mr-2"></i>
                        Statistik
                      </a>
                    </li>
                  </ul>
              ...
              <transition enter-active-class="animated fadeIn" mode="out-in">
                <div v-show="tabName == 'info'">
                  <div class="card" v-if="item.keterangan">
                    ...
                    <div class="card-body" v-html="item.keterangan"></div>
                  </div>
                  ...
                  <div class="card" v-if="item.jadwal">
                    ...
                    <div class="card-body" v-html="item.jadwal"></div>
                  </div>
                  ...
                  <div class="card" v-if="itemDataPanitia">
                    ...
                    <data-table
                      :items="itemDataPanitia"
                      :columnData="columnDataPanitia"
                      ...
                      <template slot="item-desktop" slot-scope="props">
                        <tr v-if="props.item">
                          ...
                          <td>
                            <img
                              :src="
                                '/images/aktivis/' + props.item.gambar + 'n.jpg'
                              "
                              width="35px"
                          ...
                          <td v-if="props.item.pivot.asal == 'dalam'">
                            ...
                            >
                              <check-value
                                ...
                                v-if="props.item.pekerjaan_aktif.cu"
                              ></check-value>
                              <span v-else>-</span>
                            </span>
                            <span
                            ...
                            >
                              <check-value
                                :value="
                                  props.item.pekerjaan_aktif.lembaga_lain.name
                                "
                                v-if="props.item.pekerjaan_aktif.lembaga_lain"
                              ></check-value>
                              <span v-else>-</span>
                            </span>
                            <span
                          ...
                          <td
                            v-else-if="props.item.pivot.asal == 'luar lembaga'"
                          >
                            <check-value :value="props.item.name"></check-value>
                          </td>
                          <td>
              ...
              <transition enter-active-class="animated fadeIn" mode="out-in">
                <div v-show="tabName == 'materi'">
                  ...
                  <data-viewer
                    :title="'Unduhan'"
                    :itemData="itemDataMateri"
                    :columnData="columnDataMateri"
                    :itemDataStat="itemDataMateriStat"
                    :query="queryMateri"
                    @fetch="fetchMateri"
                    :isNoExcel="'true'"
                    :isDasar="'true'"
                  ...
                  >
                    ...
                    >
                      <button
                        ...
                        @click.prevent="modalOpen('tambahMateri')"
                      >
                        <i class="icon-plus3"></i> Tambah Unduhan
                      </button>
                    </template>
                    ...
                    <template slot="item-mobile" slot-scope="props">
                      <div class="col-md-12">
                        <div class="card">
                          <div
                            class="card-header bg-light header-elements-inline"
                          >
                            <h6 class="card-title">
                              <a
                                href="#"
                                @click.prevent="
                                  modalOpen('lihatMateri', true, props.item)
                                "
                                >{{ props.item.name }}</a
                              >
                            </h6>
                                ...
                                <div class="d-none d-sm-block">
                                  <button
                                    ...
                                    @click.prevent="
                                      downloadMateri(
                                        props.item.tipe != 'pdf'
                                          ? props.item.filename + '.jpg'
                                          : props.item.filename
                                      )
                                    "
                                    v-if="props.item.format == 'upload'"
                                  >
                                    <i class="icon-file-download"></i> Unduh
                                  </button>
                                  ...
                                  <a
                                    ...
                                    target="_blank"
                                    v-else-if="props.item.format == 'link'"
                                    ><i class="icon-file-download"></i> Unduh</a
                                  >
                                </div>
                              ...
                              <div class="col-md-6 text-right">
                                <div class="d-none d-sm-block">
                                  ...
                                  <button
                                    ...
                                    class="btn btn-light mb-1"
                                    @click.prevent="
                                      modalOpen('ubahMateri', true, props.item)
                                    "
                                    v-if="
                                      statusUser ||
                                      (currentUser.can &&
                                  ...
                                  <button
                                    ...
                                    class="btn btn-light mb-1"
                                    @click.prevent="
                                      modalOpen('hapusMateri', true, props.item)
                                    "
                                    v-if="
                                      statusUser ||
                                      (currentUser.can &&
              ...
              <transition enter-active-class="animated fadeIn" mode="out-in">
                <div v-show="tabName == 'tugas'">
                  ...
                  <data-viewer
                    :title="'Tugas'"
                    :itemData="itemDataTugas"
                    :columnData="columnDataTugas"
                    :itemDataStat="itemDataTugasStat"
                    :query="queryTugas"
                    @fetch="fetchTugas"
                    :isNoExcel="'true'"
                    :isDasar="'true'"
                  ...
                  >
                    ...
                    >
                      <button
                        type="button"
                        class="btn btn-light"
                        @click.prevent="modalOpen('tambahTugas')"
                      >
                        <i class="icon-plus3"></i> Tambah Tugas
                      </button>
                    </template>
                          ...
                          >
                            <h6 class="card-title">
                              <a
                                href="#"
                                @click.prevent="
                                  modalOpen('lihatTugas', true, props.item)
                                "
                                >{{ props.item.name }}</a
                              >
                            </h6>
                                ...
                                <div class="d-none d-sm-block">
                                  ...
                                  >
                                    ...
                                    <span
                                      ...
                                      v-if="
                                        props.item.hasjawaban_count > 0 &&
                                        statusUser
                                      "
                                      >{{ props.item.hasjawaban_count }}</span
                                    >
                                  </button>
                                </div>
                                <div class="d-block d-sm-none text-center">
                              ...
                              <div class="col-md-6 text-right">
                                <div class="d-none d-sm-block">
                                  <button
                                    ...
                                    class="btn btn-light mb-1"
                                    @click.prevent="
                                      modalOpen('ubahTugas', true, props.item)
                                    "
                                    v-if="
                                      statusUser ||
                                      (currentUser.can &&
                                  ...
                                  <button
                                    ...
                                    class="btn btn-light mb-1"
                                    @click.prevent="
                                      modalOpen('hapusTugas', true, props.item)
                                    "
                                    v-if="
                                      statusUser ||
                                      (currentUser.can &&
              ...
              <transition enter-active-class="animated fadeIn" mode="out-in">
                <div v-show="tabName == 'keputusan'">
                  ...
                  <data-viewer
                    :title="'Keputusan'"
                    :itemData="itemDataKeputusan"
                    :columnData="columnDataKeputusan"
                    :itemDataStat="itemDataKeputusanStat"
                    :query="queryKeputusan"
                    @fetch="fetchKeputusan"
                    :isNoExcel="'true'"
                    :isDasar="'true'"
                    :isDisable="isDisableTable"
                    :dataview="'grid'"
                  >
                    ...
                    <template
                      slot="button-desktop"
                      v-if="
                        item.status == 4 && item.pilih && item.pilih.length > 0
                      "
                    >
                      <button
                        type="button"
                    ...
                    <template slot="item-mobile" slot-scope="props">
                      <div class="col-md-12">
                        <div
                          ...
                          :class="{
                            'border-success':
                              props.item.id_cu == currentUser.id_cu,
                          }"
                        >
                          <div
                            class="card-header bg-light header-elements-inline"
                          >
                            <h6 class="card-title">
                              <img
                                :src="
                                  '/images/aktivis/' +
                                  props.item.user.aktivis.gambar +
                                  '.jpg'
                                "
                                width="30"
                                height="30"
                                ...
                                alt="user image"
                                v-if="props.item.user.aktivis.gambar"
                              />
                              <img
                                src="/images/no_image_man.jpg"
                                width="30"
                          ...
                          <div class="card-body" v-if="props.item.keterangan">
                            <div class="row">
                              <div
                                class="col-md-6"
                                v-for="pilih in props.item.pilih"
                                :key="pilih.id"
                              >
                                <div
                                  class="card"
                                ...
                                >
                                  ...
                                  >
                                    <span v-if="pilih.pivot.nilai == 1"
                                      >SETUJU</span
                                    >
                                    <span v-else-if="pilih.pivot.nilai == 2"
                                      >TIDAK SETUJU</span
                                    >
                                    <span v-else-if="pilih.pivot.nilai == 3"
                                      >TIDAK PUNYA TANGGAPAN</span
                                    >
                                  </div>
                                  <div class="card-body">
                                    <check-value
                              ...
                              <div class="col-md-6">
                                <div class="d-none d-sm-block">
                                  <button
                                    ...
                                    "
                                  >
                                    <i class="icon-reply"></i> Komentar
                                    <span
                                      class="badge badge-success"
                                      v-if="props.item.haskomentar_count > 0"
                                      >{{ props.item.haskomentar_count }}</span
                                    >
                                  </button>
                                </div>
              ...
              <transition enter-active-class="animated fadeIn" mode="out-in">
                <div v-show="tabName == 'pertanyaan'">
                  ...
                  <data-viewer
                    :title="'Pertanyaan'"
                    :itemData="itemDataPertanyaan"
                    :columnData="columnDataPertanyaan"
                    :itemDataStat="itemDataPertanyaanStat"
                    :query="queryPertanyaan"
                    @fetch="fetchPertanyaan"
                    :isNoExcel="'true'"
                    :isDasar="'true'"
                    :isDisable="isDisableTable"
                    :dataview="'grid'"
                          ...
                          >
                            <h6 class="card-title">
                              ...
                              <check-value
                                ...
                                v-if="props.item.cu"
                              ></check-value>
                              <span v-else-if="props.item.id_cu == 0"
                                >Puskopcuina</span
                              >
                            </h6>
                            <div class="d-none d-sm-block">
              ...
              <transition enter-active-class="animated fadeIn" mode="out-in">
                <div v-if="tabName == 'pesertaTerdaftar'">
                  <data-viewer
                    ...
                    :itemData="itemDataPesertaTerdaftar"
                    :columnData="columnDataPesertaTerdaftar"
                    :itemDataStat="itemDataPesertaTerdaftarStat"
                    :query="queryPesertaTerdaftar"
                    @fetch="fetchPesertaTerdaftar"
                  ...
                  >
                    ...
                    >
                      ...
                      <button
                        class="btn btn-light mb-1"
                        @click.prevent="modalOpen('batalPeserta')"
                        :disabled="!selectedItem.id"
                        v-if="
                          currentUser.can &&
                          currentUser.can['update_diklat_cu'] &&
                      ...
                      <button
                        class="btn btn-light mb-1"
                        @click.prevent="modalOpen('alasanPeserta')"
                        v-if="
                          currentUser.can &&
                          currentUser.can['index_diklat_cu'] &&
                          selectedItem.status == 7
                    ...
                    <template slot="button-mobile" v-else>
                      <template v-if="item.tipe == 'diklat_cu'">
                        <button
                          class="btn bg-warning-400 btn-block mb-1"
                          @click.prevent="modalOpen('tambahPeserta')"
                          v-if="
                            currentUser.can &&
                            currentUser.can['index_diklat_cu'] &&
                      ...
                      <button
                        ...
                        v-if="item.status == 2 && selectedItem.status != 7"
                      >
                        <i class="icon-pencil5"></i> Ubah
                      </button>
                    ...
                    <template slot="item-desktop" slot-scope="props">
                      ...
                      >
                        ...
                        <td>
                          <span
                            v-html="
                              $options.filters.statusPeserta(props.item.status)
                            "
                          ></span>
                        </td>
                        ...
                        <td
                          v-if="
                            props.item.aktivis &&
                            !columnDataPesertaTerdaftar[3].hide
                          "
                        >
                          <check-value
                        ...
                        <td
                          v-if="
                            !columnDataPesertaTerdaftar[4].hide &&
                            !columnDataPesertaTerdaftar[4].disable
                          "
                        >
                          <check-value
                        ...
                        <td
                          v-if="
                            !columnDataPesertaTerdaftar[6].hide &&
                            !columnDataPesertaTerdaftar[6].disable
                          "
                        >
                          <span
                            v-html="$options.filters.date(props.item.datang)"
                          ></span>
                        </td>
                        <td
                          v-if="
                            !columnDataPesertaTerdaftar[7].hide &&
                            !columnDataPesertaTerdaftar[7].disable
                          "
                        >
                          <span
                            v-html="$options.filters.date(props.item.pulang)"
                          ></span>
                        </td>
                        ...
                        <td
                          v-if="
                            props.item.aktivis &&
                            !columnDataPesertaTerdaftar[9].hide
                          "
                        >
                          <check-value
                        ...
                        <td
                          v-if="
                            props.item.aktivis &&
                            !columnDataPesertaTerdaftar[10].hide
                          "
                        >
                          <span
                            v-if="
                              props.item.aktivis.pekerjaan_aktif &&
                              props.item.aktivis.pekerjaan_aktif.tipe == 1
                            "
                          >
                            <check-value
                              :value="
                                props.item.aktivis.pekerjaan_aktif.cu.name
                              "
                              v-if="props.item.aktivis.pekerjaan_aktif.cu"
                            ></check-value>
                            <span v-else>-</span>
                          </span>
                          <span
                            v-else-if="
                              props.item.aktivis.pekerjaan_aktif &&
                              props.item.aktivis.pekerjaan_aktif.tipe == 2
                            "
                          >
                            <check-value
                              :value="
                                props.item.aktivis.pekerjaan_aktif.lembaga_lain
                                  .name
                              "
                              v-if="
                                props.item.aktivis.pekerjaan_aktif.lembaga_lain
                          ...
                          <span
                            v-else-if="
                              props.item.aktivis.pekerjaan_aktif &&
                              props.item.aktivis.pekerjaan_aktif.tipe == 3
                            "
                          >
                            Puskopcuina
                          </span>
                        ...
                        <td
                          v-if="
                            props.item.aktivis &&
                            !columnDataPesertaTerdaftar[11].hide
                          "
                        >
                          <span
                            v-html="
                              $options.filters.checkTingkatAktivis(
                                props.item.aktivis.pekerjaan_aktif.tingkat
                              )
                            "
                            v-if="
                              props.item.aktivis.pekerjaan_aktif &&
                        ...
                        <td
                          v-if="
                            props.item.aktivis &&
                            !columnDataPesertaTerdaftar[12].hide
                          "
                        >
                          <check-value
                            :value="props.item.aktivis.pekerjaan_aktif.name"
                            v-if="props.item.aktivis.pekerjaan_aktif"
                          ></check-value>
                          <span v-else>-</span>
                        </td>
                        <td
                          v-if="
                            props.item.aktivis &&
                            !columnDataPesertaTerdaftar[13].hide
                          "
                        >
                          <check-value
                            :value="
                              props.item.aktivis.pendidikan_tertinggi.tingkat
                            "
                            v-if="props.item.aktivis.pendidikan_tertinggi"
                          ></check-value>
                          <span v-else>-</span>
                        </td>
                        <td
                          v-if="
                            props.item.aktivis &&
                            !columnDataPesertaTerdaftar[14].hide
                          "
                        >
                          <check-value
                            :value="
                              props.item.aktivis.pendidikan_tertinggi.name
                            "
                            v-if="props.item.aktivis.pendidikan_tertinggi"
                          ></check-value>
                          <span v-else>-</span>
                        ...
                        <td
                          v-if="
                            props.item.aktivis &&
                            !columnDataPesertaTerdaftar[15].hide
                          "
                          v-html="
                        ...
                        <td
                          v-if="
                            props.item.aktivis &&
                            !columnDataPesertaTerdaftar[16].hide
                          "
                        >
                          <check-value
                        ...
                        <td
                          v-if="
                            props.item.aktivis &&
                            !columnDataPesertaTerdaftar[17].hide
                          "
                        >
                          <check-value
                        ...
                        <td
                          v-if="
                            props.item.aktivis &&
                            !columnDataPesertaTerdaftar[18].hide
                          "
                        >
                          <check-value
                        ...
                        <td
                          v-if="
                            props.item.aktivis &&
                            !columnDataPesertaTerdaftar[19].hide
                          "
                        >
                          <check-value
                        ...
                        <td
                          v-if="
                            props.item.aktivis &&
                            !columnDataPesertaTerdaftar[20].hide
                          "
                        >
                          <check-value
                        ...
                        <td
                          v-if="
                            props.item.aktivis &&
                            !columnDataPesertaTerdaftar[21].hide
                          "
                        >
                          <check-value
                        ...
                        <td
                          v-if="
                            props.item.aktivis &&
                            !columnDataPesertaTerdaftar[22].hide
                          "
                        >
                          <check-value
                        ...
                        <td
                          ...
                          "
                          v-html="
                            $options.filters.dateTime(props.item.created_at)
                          "
                        ></td>
                      </tr>
                    </template>
              ...
              <transition enter-active-class="animated fadeIn" mode="out-in">
                <div v-if="tabName == 'pesertaHadir'">
                  <data-viewer
                    :title="'peserta hadir'"
                    :itemData="itemDataPesertaHadir"
                    :columnData="columnDataPesertaHadir"
                    :itemDataStat="itemDataPesertaHadirStat"
                    :query="queryPesertaHadir"
                    @fetch="fetchPesertaHadir"
                    :excelDownloadUrl="excelDownloadUrl2"
                    :isDasar="'true'"
                    :isNoKolom="'true'"
                    :isDisable="isDisableTable"
                  >
                    <template slot="item-desktop" slot-scope="props">
                      <tr class="text-nowrap" v-if="props.item">
                        ...
                        <td
                          v-if="
                            !columnDataPesertaHadir[3].hide &&
                            !columnDataPesertaHadir[3].disable
                          "
                        >
                          <check-value
                            :value="props.item.name_nametag"
                        ...
                        <td
                          v-if="
                            !columnDataPesertaHadir[5].hide &&
                            !columnDataPesertaHadir[5].disable
                          "
                        >
                          <span
                            v-html="$options.filters.date(props.item.datang)"
                        ...
                        <td
                          v-if="
                            !columnDataPesertaHadir[6].hide &&
                            !columnDataPesertaHadir[6].disable
                          "
                        >
                          <span
                            v-html="$options.filters.date(props.item.pulang)"
                        ...
                        <td
                          v-if="!columnDataPesertaHadir[7].hide"
                          v-html="
                            $options.filters.dateTime(props.item.tanggal_hadir)
                          "
                        ></td>
                        ...
                        <td
                          v-if="
                            props.item.aktivis &&
                            !columnDataPesertaHadir[10].hide
                          "
                        >
                          <span
                            v-if="
                        ...
                        <td
                          v-if="
                            props.item.aktivis &&
                            !columnDataPesertaHadir[11].hide
                          "
                        >
                          <span
                            v-html="
                        ...
                        <td
                          v-if="
                            props.item.aktivis &&
                            !columnDataPesertaHadir[12].hide
                          "
                        >
                          <check-value
                            :value="props.item.aktivis.pekerjaan_aktif.name"
                        ...
                        <td
                          v-if="
                            props.item.aktivis &&
                            !columnDataPesertaHadir[13].hide
                          "
                        >
                          <check-value
                            :value="
                        ...
                        <td
                          v-if="
                            props.item.aktivis &&
                            !columnDataPesertaHadir[14].hide
                          "
                        >
                          <check-value
                            :value="
                        ...
                        <td
                          v-if="
                            props.item.aktivis &&
                            !columnDataPesertaHadir[15].hide
                          "
                          v-html="
                            $options.filters.date(
                              props.item.aktivis.tanggal_lahir
                        ...
                        <td
                          v-if="
                            props.item.aktivis &&
                            !columnDataPesertaHadir[16].hide
                          "
                        >
                          <check-value
                            :value="props.item.aktivis.tempat_lahir"
                        ...
                        <td
                          v-if="
                            props.item.aktivis &&
                            !columnDataPesertaHadir[17].hide
                          "
                        >
                          <check-value
                            :value="props.item.aktivis.tinggi"
                        ...
                        <td
                          v-if="
                            props.item.aktivis &&
                            !columnDataPesertaHadir[18].hide
                          "
                        >
                          <check-value
                            :value="props.item.aktivis.agama"
                        ...
                        <td
                          v-if="
                            props.item.aktivis &&
                            !columnDataPesertaHadir[19].hide
                          "
                        >
                          <check-value
                            :value="props.item.aktivis.status"
                        ...
                        <td
                          v-if="
                            props.item.aktivis &&
                            !columnDataPesertaHadir[20].hide
                          "
                        >
                          <check-value
                            :value="props.item.aktivis.email"
                        ...
                        <td
                          v-if="
                            props.item.aktivis &&
                            !columnDataPesertaHadir[21].hide
                          "
                        >
                          <check-value
                            :value="props.item.aktivis.hp"
                        ...
                        <td
                          v-if="
                            props.item.aktivis &&
                            !columnDataPesertaHadir[22].hide
                          "
                        >
                          <check-value
                            :value="props.item.aktivis.kontak"
                ...
                <div v-if="tabName == 'statistik'">
                  <template v-if="item.pilih && item.pilih.length > 0">
                    <div
                      class="card"
                      v-if="
                        itemDataKeputusanCountStat == 'success' &&
                        itemDataKeputusanCount.length > 0
                      "
                    >
                      ...
                      <div class="card-body">
                        <div v-for="p in itemDataKeputusanCount" :key="p.id">
                          ...
                          <div class="card card-body pt-1 pb-1 mt-1 mb-1">
                            <div class="row">
                              <div class="col-sm-3 mb-1 mt-1">Setuju</div>
                              <div class="col-sm-8 mb-1 mt-1">
                                <div class="progress">
                                  <div
                                    class="progress-bar-striped bg-primary"
                                    :style="{
                                      width:
                          ...
                          <div class="card card-body pt-1 pb-1 mt-1 mb-1">
                            <div class="row">
                              <div class="col-sm-3 mb-1 mt-1">Tidak Setuju</div>
                              <div class="col-sm-8 mb-1 mt-1">
                                <div class="progress">
                                  <div
                          ...
                          <div class="card card-body pt-1 pb-1 mt-1 mb-1">
                            <div class="row">
                              ...
                              <div class="col-sm-8 mb-1 mt-1">
                                <div class="progress">
                                  <div
                                    class="progress-bar-striped bg-secondary"
                                    :style="{
                                      width:
                  ...
                  <div class="card">
                    <div class="card-header bg-light">
                      <h6 class="card-title">Peserta Hadir</h6>
                    </div>
                    <data-table
                      :items="itemDataPesertaHadirCU"
                      :columnData="columnDataCU"
    ...
    >
      ...
      <template slot="modal-body1">
        <form-peserta
          ...
          @tutup="modalTutup"
          v-if="state == 'tambahPeserta' || state == 'ubahPeserta'"
        ></form-peserta>
      ...
      <template slot="modal-body2">
        <form-materi
          ...
          @tutup="modalTutup"
          v-if="state == 'tambahMateri' || state == 'ubahMateri'"
        ></form-materi>
        ...
        <form-tugas
          ...
          :kegiatan_tipe="item.tipe"
          @tutup="modalTutup"
          v-if="state == 'tambahTugas' || state == 'ubahTugas'"
        ></form-tugas>
        ...
        <form-status
          ...
          :id="item.id"
          :status="item.status"
          :keteranganBatal="item.keteranganBatal"
          @tutup="modalTutup"
          v-else-if="state == 'statusPertemuan'"
        ></form-status>
        ...
        <form-hadir
          ...
          :item="item"
          :state="state"
          v-else-if="state == 'pesertaTerdaftar' || state == 'panitiaTerdaftar'"
        ></form-hadir>
      </template>
      ...
      <template slot="modal-body3">
        <form-keputusan
          ...
          :pilih="item.pilih"
          @tutup="modalTutup"
          v-if="state == 'tambahKeputusan' || state == 'ubahKeputusan'"
        ></form-keputusan>
        ...
        <form-keputusan-komentar
          ...
          :kegiatan_id="item.id"
          @tutup="modalTutup"
          v-else-if="state == 'keputusanKomentar'"
        ></form-keputusan-komentar>
        ...
        <form-pertanyaan
          ...
          :pilih="item.pilih"
          @tutup="modalTutup"
          v-if="state == 'tambahPertanyaan' || state == 'ubahPertanyaan'"
        ></form-pertanyaan>
        ...
        <form-pertanyaan-komentar
          ...
          :kegiatan_id="item.id"
          @tutup="modalTutup"
          v-else-if="state == 'pertanyaanKomentar'"
        ></form-pertanyaan-komentar>
      </template>
    </app-modal>
  </div>
...
export default {
  ...
  data() {
    return {
      ...
      modalSize: "",
      submited: false,
      statusUser: false, // false jika status user adalah peserta
    };
  },
  ...
  updated() {
    for (let i = 0; i < this.itemDataPanitia.length; i++) {
    ...
    itemStat(value) {
      if (value === "success") {
        ...
        if (this.currentUser.aktivis) {
          ...
          if (
            !this.currentUser.can["update_diklat_cu"] ||
            !this.currentUser.can["destroy_diklat_cu"] ||
            !this.currentUser.can["update_pertemuan_cu"] ||
            !this.currentUser.can["destroy_pertemuan_cu"]
          ) {
    ...
    updateStat(value) {
      ...
      if (value === "success") {
        ...
        if (this.state == "statusPertemuan") {
          ...
          this.state == "tambahKeputusan" ||
          this.state == "hapusKeputusan"
        ) {
          this.fetchCountKeputusan();
        } else if (
          this.state == "tambahPertanyaan" ||
          this.state == "hapusPertanyaan"
        ) {
          this.fetchCountPertanyaan();
        }
      } else {
  ...
  methods: {
    ...
    fetchPesertaTerdaftar(params) {
      this.$store.dispatch(this.kelas + "/indexPeserta", [
        params,
        this.item.id,
    ...
    fetchPesertaHadir(params) {
      this.$store.dispatch(this.kelas + "/indexPesertaHadir", [
        params,
        this.item.id,
      ]);
    ...
    fetchKeputusan(params) {
      this.$store.dispatch(this.kelas + "/indexKeputusan", [
        params,
        this.item.id,
      ]);
    },
    fetchPertanyaan(params) {
      this.$store.dispatch(this.kelas + "/indexPertanyaan", [
        params,
        this.item.id,
      ]);
    },
    ...
    fetchCountKeputusan() {
      this.$store.dispatch(this.kelas + "/countKeputusan", [
        this.item.id,
        this.currentUser.id_cu,
        this.currentUser.id,
      ]);
    ...
    fetchCountPertanyaan() {
      this.$store.dispatch(this.kelas + "/countPertanyaan", [
        this.item.id,
        this.currentUser.id_cu,
        this.currentUser.id,
      ]);
    ...
    fetchStatistik() {
      ...
      this.$store.dispatch(
        this.kelas + "/indexPesertaHadirCountCu",
        this.item.id
      );
    ...
    checkPeserta() {
      this.$store.dispatch(this.kelas + "/checkPeserta", [
        this.item.id,
    ...
    checkPanitia() {
      if (this.currentUser.aktivis) {
        this.$store.dispatch(this.kelas + "/checkPanitia", [
          this.item.id,
          this.currentUser.id_aktivis,
        ]);
      } else {
    ...
    back() {
      this.$router.push({
        name: this.kelas,
        params: { tipe: this.item.tipe, periode: this.momentYear() },
      });
    },
    ubahKegiatan(id) {
      this.$router.push({
    ...
    modalOpen(state, isMobile, itemMobile) {
      ...
      if (isMobile) {
        if (
          this.state == "ubahMateri" ||
          this.state == "hapusMateri" ||
          this.state == "lihatMateri"
        ) {
          this.selectedItemMateri = itemMobile;
        } else if (
          this.state == "ubahKeputusan" ||
          this.state == "hapusKeputusan" ||
          this.state == "keputusanKomentar"
        ) {
          this.selectedItemKeputusan = itemMobile;
        } else if (
          this.state == "ubahTugas" ||
          this.state == "hapusTugas" ||
          this.state == "lihatTugas"
        ) {
      ...
      if (state == "hapusPertemuan") {
        ...
        this.modalColor = "";
        this.modalTitle =
          "Hapus Peserta " + this.selectedItem.aktivis.name + " ?";
        this.modalButton = "Iya, Hapus";
        ...
        this.modalContent =
          "Alasan penolakkan: <br/>" + this.selectedItem.keteranganBatal;
      } else if (state == "batalPeserta") {
        this.modalState = "normal1";
        this.modalColor = "bg-primary";
        this.modalTitle =
          "Tolak Peserta " + this.selectedItem.aktivis.name + " ?";
        this.modalButton = "Ok";
        ...
        if (this.countPeserta >= this.item.peserta_max) {
          ...
          this.modalContent =
            "Maaf anda tidak bisa mendaftarkan peserta lagi, karena kuota peserta pada diklat ini sudah terpenuhi.";
        } else {
          this.modalState = "normal1";
          this.modalColor = "bg-primary";
        ...
        if (this.selectedItemMateri.tipe != "pdf") {
          this.modalImageOpen(
            "/files/pertemuan/" + this.selectedItemMateri.filename + ".jpg"
          );
        } else {
        ...
        if (
          this.countKeputusan[1] >= this.item.keputusan_user &&
          this.item.keputusan_user != null
        ) {
          this.modalState = "content-tutup";
          this.modalColor = "";
          this.modalTitle = "Anda tidak bisa menambahkan keputusan lagi";
          this.modalContent =
            "Maaf anda tidak bisa memberikan keputusan lagi, karena jumlah keputusan maksimal per peserta adalah " +
            this.item.keputusan_user +
            " kali.";
        } else {
        ...
        if (
          this.countPertanyaan[1] >= this.item.pertanyaan_user &&
          this.item.keputusan_user != null
        ) {
          this.modalState = "content-tutup";
          this.modalColor = "";
          ...
          this.modalContent =
            "Maaf anda tidak bisa memberikan pertanyaan lagi, karena jumlah pertanyaan maksimal per peserta adalah " +
            this.item.pertanyaan_user +
            " kali.";
        } else {
          this.modalState = "normal3";
          this.modalColor = "bg-primary";
    ...
    modalConfirmOk() {
      ...
      if (this.state == "hapusPertemuan") {
        ...
        this.$store.dispatch(
          this.kelas + "/destroyPeserta",
          this.selectedItem.id
        );
      } else if (this.state == "hapusMateri") {
        this.$store.dispatch(this.kelas + "/destroyMateri", [
          this.item.tipe,
          this.selectedItemMateri.id,
        ]);
      } else if (this.state == "hapusTugas") {
        this.$store.dispatch(this.kelas + "/destroyTugas", [
          this.item.tipe,
          this.selectedItemTugas.id,
        ]);
      } else if (this.state == "hapusKeputusan") {
        this.$store.dispatch(
          this.kelas + "/destroyKeputusan",
          this.selectedItemKeputusan.id
        );
      } else if (this.state == "hapusPertanyaan") {
        this.$store.dispatch(
          this.kelas + "/destroyPertanyaan",
          this.selectedItemPertanyaan.id
        );
      }
    },
    modalTutup() {
      if (
        ...
        this.state == "ubahPeserta" ||
        this.state == "hapusPeserta" ||
        this.state == "batalPeserta"
      ) {
        this.changeTab("pesertaTerdaftar");
        this.fetchCountPeserta();
      } else if (
        this.state == "tambahMateri" ||
        this.state == "ubahMateri" ||
        this.state == "hapusMateri"
      ) {
        this.changeTab("materi");
      } else if (
        this.state == "tambahTugas" ||
        this.state == "ubahTugas" ||
        this.state == "hapusTugas"
      ) {
        ...
        this.state == "tambahPertanyaan" ||
        this.state == "ubahPertanyaan" ||
        this.state == "hapusPertanyaan" ||
        this.state == "pertanyaanKomentar"
      ) {
        this.changeTab("pertanyaan");
      } else if (this.state == "hapusPertemuan") {
        this.back();
      } else if (
        this.state == "pesertaTidakTerdaftar" &&
        this.item.tipe_tempat == "ONLINE"
      ) {
        this.$router.push({ name: "dashboard" });
      } else if (
        this.state == "pesertaTerdaftar" ||
        this.state == "panitiaTerdaftar"
      ) {
