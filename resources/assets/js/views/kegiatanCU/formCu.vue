        ...
        <div class="content">
          ...
          >
              ...
              <div class="card-body">
                <div class="row">
                  ...
                  <div class="col-md-12" v-if="currentUser.id_cu == 0">
                    <div class="form-group">
                      <!-- title -->
                      <h5>Pilih Cu: <wajib-badge></wajib-badge></h5>
                  ...
                  <div class="col-md-6">
                    <div
                      class="form-group"
                      :class="{ 'has-error': errors.has('form.kode_diklat') }"
                    >
                      <!-- title -->
                      <h5
                        :class="{
                          'text-danger': errors.has('form.kode_diklat'),
                        }"
                      >
                        <i
                          class="icon-cross2"
                          v-if="errors.has('form.kode_diklat')"
                        ></i>
                  ...
                  <div class="col-md-6">
                    <div
                      class="form-group"
                      :class="{ 'has-error': errors.has('form.name') }"
                    >
                      <!-- title -->
                      <h5 :class="{ 'text-danger': errors.has('form.name') }">
                        <i
                          class="icon-cross2"
                          v-if="errors.has('form.name')"
                        ></i>
                  ...
                  <div class="col-md-4">
                    <div
                      class="form-group"
                      :class="{ 'has-error': errors.has('form.periode') }"
                    >
                      <!-- title -->
                      <h5
                        :class="{ 'text-danger': errors.has('form.periode') }"
                      >
                        <i
                          class="icon-cross2"
                          v-if="errors.has('form.periode')"
                        ></i>
                  ...
                  <div class="col-md-4">
                    <div
                      class="form-group"
                      :class="{ 'has-error': errors.has('form.mulai') }"
                    >
                      <!-- title -->
                      <h5 :class="{ 'text-danger': errors.has('form.mulai') }">
                        <i
                          class="icon-cross2"
                          v-if="errors.has('form.mulai')"
                        ></i>
                      ...
                      <!-- input -->
                      <date-picker
                        @dateSelected="form.mulai = $event"
                        :defaultDate="form.mulai"
                      ></date-picker>
                      <input
                        v-model="form.mulai"
                        v-show="false"
                  ...
                  <div class="col-md-4">
                    <div
                      class="form-group"
                      :class="{ 'has-error': errors.has('form.selesai') }"
                    >
                      <!-- title -->
                      <h5
                        :class="{ 'text-danger': errors.has('form.selesai') }"
                      >
                        <i
                          class="icon-cross2"
                          v-if="errors.has('form.selesai')"
                        ></i>
                      ...
                      <!-- input  -->
                      <date-picker
                        @dateSelected="form.selesai = $event"
                        :defaultDate="form.selesai"
                      ></date-picker>
                      <input
                  ...
                  <div class="col-md-4">
                    <div
                      class="form-group"
                      :class="{ 'has-error': errors.has('form.durasi') }"
                    >
                      <!-- title -->
                      <h5 :class="{ 'text-danger': errors.has('form.durasi') }">
                        <i
                          class="icon-cross2"
                          v-if="errors.has('form.durasi')"
                        ></i>
                  ...
                  <div class="col-md-4">
                    <div
                      class="form-group"
                      :class="{ 'has-error': errors.has('form.peserta_min') }"
                    >
                      <!-- title -->
                      <h5
                        :class="{
                          'text-danger': errors.has('form.peserta_min'),
                        }"
                      >
                        <i
                          class="icon-cross2"
                          v-if="errors.has('form.peserta_min')"
                        ></i>
                  ...
                  <div class="col-md-4">
                    <div
                      class="form-group"
                      :class="{ 'has-error': errors.has('form.peserta_max') }"
                    >
                      <!-- title -->
                      <h5
                        :class="{
                          'text-danger': errors.has('form.peserta_max'),
                        }"
                      >
                        <i
                          class="icon-cross2"
                          v-if="errors.has('form.peserta_max')"
                        ></i>
              ...
              <div class="card-body">
                <div class="row">
                  ...
                  <div class="col-md-12">
                    <div
                      class="form-group"
                      :class="{ 'has-error': errors.has('form.tipe_tempat') }"
                    >
                      <!-- title -->
                      <h5
                        :class="{
                          'text-danger': errors.has('form.tipe_tempat'),
                        }"
                      >
                        <i
                          class="icon-cross2"
                          v-if="errors.has('form.tipe_tempat')"
                        ></i>
                  ...
                  <div class="col-md-4" v-if="form.tipe_tempat == 'OFFLINE'">
                    <div
                      class="form-group"
                      :class="{ 'has-error': errors.has('form.id_provinces') }"
                    >
                      <!-- title -->
                      <h5
                        :class="{
                          'text-danger': errors.has('form.id_provinces'),
                        }"
                      >
                        <i
                          class="icon-cross2"
                          v-if="errors.has('form.id_provinces')"
                        ></i>
                      ...
                      >
                        <option disabled value="">
                          <span v-if="modelProvincesStat === 'loading'"
                            >Mohon tunggu...</span
                          >
                          <span v-else>Silahkan pilih provinsi</span>
                        </option>
                        <option
                          v-for="(provinces, index) in modelProvinces"
                          :key="index"
                          :value="provinces.id"
                        >
                          {{ provinces.name }}
                      ...
                      >
                        <i class="icon-arrow-small-right"></i>
                        {{ errors.first("form.id_provinces") }}
                      </small>
                      <small class="text-muted" v-else>&nbsp;</small>
                    </div>
                  </div>
                  ...
                  <div class="col-md-4" v-if="form.tipe_tempat == 'OFFLINE'">
                    <div
                      class="form-group"
                      :class="{ 'has-error': errors.has('form.id_regencies') }"
                    >
                      <!-- title -->
                      <h5
                        :class="{
                          'text-danger': errors.has('form.id_regencies'),
                        }"
                      >
                        <i
                          class="icon-cross2"
                          v-if="errors.has('form.id_regencies')"
                        ></i>
                      ...
                      >
                        <option disabled value="">
                          <span v-if="modelRegenciesStat === 'loading'"
                            >Mohon tunggu...</span
                          >
                          <span v-else>Silahkan pilih kabupaten</span>
                        </option>
                        <option
                          v-for="(regencies, index) in modelRegencies"
                          :value="regencies.id"
                          :key="index"
                        >
                          {{ regencies.name }}
                      ...
                      >
                        <i class="icon-arrow-small-right"></i>
                        {{ errors.first("form.id_regencies") }}
                      </small>
                      <small class="text-muted" v-else>&nbsp;</small>
                    </div>
                  </div>
                  ...
                  <div class="col-md-4" v-if="form.tipe_tempat == 'OFFLINE'">
                    <div
                      class="form-group"
                      :class="{ 'has-error': errors.has('form.id_tempat') }"
                    >
                      <!-- title -->
                      <h5
                        :class="{ 'text-danger': errors.has('form.id_tempat') }"
                      >
                        <i
                          class="icon-cross2"
                          v-if="errors.has('form.id_tempat')"
                        ></i>
                      ...
                      <div class="input-group">
                        ...
                        >
                          <option disabled value="">
                            <span v-if="modelTempatStat === 'loading'"
                              >Mohon tunggu...</span
                            >
                          ...
                          <option
                            v-for="(tempat, index) in modelTempat"
                            :value="tempat.id"
                            :key="index"
                          >
                            {{ tempat.name }}
                  ...
                  <div
                    class="col-md-12"
                    v-if="form.tipe_tempat == 'OFFLINE' && tempatData != ''"
                  >
                        ...
                        <div class="mr-sm-3 mb-2 mb-sm-0">
                          <div class="card-img-actions">
                            <a
                              ...
                              @click.prevent="
                                modalImageShow(
                                  '/images/tempat/' + tempatData.gambar + '.jpg'
                                )
                              "
                            ...
                            <a
                              href="#"
                              @click.prevent="
                                modalImageShow('/images/no_image.jpg')
                              "
                              v-else
                            >
                              <img
                              ...
                              <ul class="list list-unstyled mb-0">
                                ...
                                <li>
                                  ...
                                  <span v-if="tempatData.villages">{{
                                    tempatData.villages.name
                                  }}</span>
                                  <span v-else>-</span>
                                </li>
                                <li>
                                  <b>Alamat:</b>
                                  <span v-if="tempatData.alamat">{{
                                    tempatData.alamat
                                  }}</span>
                                  <span v-else>-</span>
                                </li>
            ...
            <div class="card">
              <div class="card-header bg-white">
                <h5 class="card-title">
                  4. Panitia & Fasilitator <wajib-badge></wajib-badge>
                </h5>
              </div>
                ...
                <div class="row">
                  <div class="col-md-12">
                    <button
                      ...
                      @click.prevent="modalOpen('tambahPanitia')"
                    >
                    ...
                    <button
                      class="btn btn-light mb-1"
                      @click.prevent="modalOpen('ubahPanitia')"
                    ...
                    <button
                      class="btn btn-light mb-1"
                      @click.prevent="modalOpen('hapusPanitia')"
                      :disabled="!selectedItemPanitia.index"
                    >
              ...
              >
                <template slot="item-desktop" slot-scope="props">
                  <tr
                    :class="{
                      'bg-info': selectedItemPanitia.index == props.index + 1,
                    }"
                    class="text-nowrap"
                    @click="selectedRow(props.item, props.index + 1, 'panitia')"
                    v-if="props.item"
                  >
                    <td>{{ props.index + 1 }}</td>
                    <td>
            ...
            <div class="card">
                ...
                <div class="row">
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <small class="text-muted"
                        ...
                        pertanyaan yang bisa diberikan peserta</small
                      >
                    </div>
                  </div>
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <small class="text-muted"
                        >Kosongkan apabila tidak ada batasan pada jumlah
                        keputusan yang bisa diberikan peserta</small
                      >
                    </div>
                  </div>
                  ...
                  <div class="col-md-12">
                    <h5>
                      ...
                      <br />
                      <small class="text-muted"
                        >Kosongkan apabila tidak membutuhkan persetujuan</small
                      >
                    </h5>
                    <button
                      class="btn btn-light mb-1"
                      @click.prevent="modalOpen('tambahPilih')"
                    >
                      <i class="icon-plus22"></i> Tambah
                    </button>
                    ...
                    <button
                      class="btn btn-light mb-1"
                      @click.prevent="modalOpen('ubahPilih')"
                    ...
                    <button
                      class="btn btn-light mb-1"
                      @click.prevent="modalOpen('hapusPilih')"
                      :disabled="!selectedItemPilih.index"
                    >
                      <i class="icon-bin2"></i> Hapus
                    </button>
              ...
              <data-table
                :items="itemDataPilih"
                :columnData="columnDataPilih"
                :itemDataStat="itemDataPilihStat"
              >
                <template slot="item-desktop" slot-scope="props">
                  <tr
                    :class="{
                      'bg-info': selectedItemPilih.index == props.index + 1,
                    }"
                    class="text-nowrap"
                    @click="selectedRow(props.item, props.index + 1, 'pilih')"
                    v-if="props.item"
                  >
                    <td>{{ props.index + 1 }}</td>
                    <td>{{ props.item.name }}</td>
    ...
    >
      ...
      <template slot="modal-body1">
        ...
        <form-pilih
          ...
          @editPilih="editPilih"
          @tutup="modalTutup"
          v-else-if="state == 'tambahPilih' || state == 'ubahPilih'"
        ></form-pilih>
      </template>
...
export default {
  ...
  data() {
    return {
      ...
      columnDataPilih: [{ title: "No." }, { title: "Nama" }],
      selectedItemPilih: "",
      formPilihMode: "",
      itemDataPilih: [],
      ...
      this.$validator.validateAll("form").then((result) => {
        if (result) {
          if (this.$route.meta.mode == "edit") {
            ...
            this.$store.dispatch(this.kelas + "/store", [
    ...
    back() {
      if (this.$route.meta.isDetail) {
        ...
        if (this.$route.meta.mode == "edit") {
          this.$router.push({
            name: this.kelas,
            params: { tipe: this.form.tipe, periode: this.momentYear() },
          });
        } else {
          this.$router.push({
            name: this.kelas,
