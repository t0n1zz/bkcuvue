    ...
    <form @submit.prevent="checkPeserta" data-vv-scope="formPeserta">
      <div class="alert bg-info text-white alert-styled-left alert-dismissible">
        <span class="font-weight-semibold"
          ...
          <br />
          <label
            v-for="(sasaran, index) in tingkat"
            :key="index"
          ...
          <div class="media flex-column flex-sm-row mt-0 mb-3">
            <div class="mr-sm-3 mb-2 mb-sm-0">
              <div class="card-img-actions">
                <img
                  :src="'/images/aktivis/' + formPeserta.gambar + '.jpg'"
                  class="img-fluid img-preview rounded"
                  v-if="formPeserta.gambar"
                />
                <img
              ...
              <div class="row">
                <div class="col-sm-6">
                  <ul class="list list-unstyled mb-0">
                    ...
                    <li>
                      ...
                      <span
                        v-html="
                          $options.filters.date(formPeserta.tanggal_lahir)
                        "
                      ></span>
                    </li>
                ...
                <div class="col-sm-6">
                  <ul class="list list-unstyled mb-0">
                    ...
                    <li>
                      <b>Pendidikan:</b> <br />{{ formPeserta.pendidikan }}
                    </li>
                  </ul>
                </div>
              </div>
      ...
      <data-viewer
        ...
        :isDasar="'true'"
        :isNoButtonRow="'true'"
        v-if="formPeserta.aktivis_id == '' && mode == 'create'"
      >
        <!-- item  -->
      ...
      <div class="row">
        ...
        <div class="col-md-6" v-if="item.tipe_tempat == 'OFFLINE'">
          <div
            class="form-group"
            :class="{ 'has-error': errors.has('formPeserta.name_nametag') }"
          >
            <!-- title -->
            <h5
              :class="{ 'text-danger': errors.has('formPeserta.name_nametag') }"
            >
              <i
                class="icon-cross2"
                v-if="errors.has('formPeserta.name_nametag')"
              ></i>
              Nama di nametag:
            </h5>
            ...
            <input
              ...
              v-model="formPeserta.name_nametag"
            />
            ...
            >
              ...
              {{ errors.first("formPeserta.name_nametag") }}
            </small>
        ...
        <div
          :class="{
            'col-md-6': item.tipe_tempat == 'OFFLINE',
            'col-md-12': item.tipe_tempat == 'ONLINE',
          }"
        >
          <div
            class="form-group"
          ...
          >
            ...
            <h5
              :class="{
                'text-danger': errors.has('formPeserta.name_sertifikat'),
              }"
            >
              <i
                class="icon-cross2"
                v-if="errors.has('formPeserta.name_sertifikat')"
              ></i>
              Nama di sertifikat:
            </h5>
            ...
            <input
              ...
              v-model="formPeserta.name_sertifikat"
            />
            ...
            >
              <i class="icon-arrow-small-right"></i>
              {{ errors.first("formPeserta.name_sertifikat") }}
            </small>
            <small class="text-muted" v-else>&nbsp; </small>
          </div>
        </div>
        ...
        <div class="col-md-6" v-if="item.tipe_tempat == 'OFFLINE'">
          <div class="form-group">
            ...
            <!-- input -->
            <date-picker
              @dateSelected="formPeserta.datang = $event"
              :defaultDate="formPeserta.datang"
            ></date-picker>
          </div>
        </div>
        ...
        <div class="col-md-6" v-if="item.tipe_tempat == 'OFFLINE'">
          <div class="form-group">
            ...
            <!-- input -->
            <date-picker
              @dateSelected="formPeserta.pulang = $event"
              :defaultDate="formPeserta.pulang"
            ></date-picker>
          </div>
        </div>
      </div>
      ...
      <div class="form-group">
        ...
        <textarea
          ...
          v-model="formPeserta.keterangan"
        ></textarea>
      </div>
      ...
      <div class="text-center d-none d-md-block">
        ...
        <button
          ...
          :disabled="formPeserta.aktivis_id == ''"
        >
...
export default {
  ...
  methods: {
    ...
    checkPeserta() {
      if (this.mode != "edit") {
        this.$store.dispatch("kegiatanCU/checkPeserta", [
          this.item.id,
          this.formPeserta.aktivis_id,
        ]);
      } else {
    ...
    save() {
      this.$validator.validateAll("formPeserta").then((result) => {
        if (result) {
          if (this.mode == "edit") {
            this.$store.dispatch("kegiatanCU/updatePeserta", [
              this.formPeserta.id,
              this.formPeserta,
            ]);
          } else {
            this.formPeserta.status = this.item.status;
            this.$store.dispatch("kegiatanCU/storePeserta", [
              this.item.tipe,
              this.item.id,
              this.formPeserta,
            ]);
