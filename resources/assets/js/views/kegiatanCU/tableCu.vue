  ...
  <div>
    ...
    >
      ...
      <template slot="button-desktop">
        <!-- diklat cu button -->
        <template v-if="$route.params.tipe == 'diklat_cu'">
          <!-- tambah -->
          <router-link
            :to="{
              name: kelas + 'Create',
            ...
            v-if="currentUser.can && currentUser.can['create_diklat_cu']"
          >
          ...
          <button
            ...
            class="btn btn-light mb-1"
            v-if="currentUser.can && currentUser.can['update_diklat_cu']"
          ...
          <button
            ...
            class="btn btn-light mb-1"
            v-if="currentUser.can && currentUser.can['destroy_diklat_cu']"
            :disabled="!selectedItem.id"
          >
          ...
          <button
            ...
            class="btn btn-light mb-1"
            v-if="currentUser.can && currentUser.can['index_diklat_cu']"
            :disabled="!selectedItem.id"
          >
        ...
        <!-- pertemuan cu button -->
        <template v-else-if="$route.params.tipe == 'pertemuan_cu'">
          <!-- tambah -->
          <router-link
            :to="{
              name: kelas + 'Create',
            ...
            class="btn btn-light mb-1"
            v-if="currentUser.can && currentUser.can['create_pertemuan_cu']"
          >
            <i class="icon-plus3"></i> Tambah
          </router-link>
          ...
          <button
            @click.prevent="ubahData(selectedItem.id)"
            class="btn btn-light mb-1"
            v-if="currentUser.can && currentUser.can['update_pertemuan_cu']"
            :disabled="!selectedItem.id"
          >
            <i class="icon-pencil5"></i> Ubah
          </button>
          ...
          <button
            @click.prevent="modalConfirmOpen('hapus')"
            class="btn btn-light mb-1"
            v-if="currentUser.can && currentUser.can['destroy_pertemuan_cu']"
            :disabled="!selectedItem.id"
          >
            <i class="icon-bin2"></i> Hapus
          </button>
          ...
          <button
            @click.prevent="detail(selectedItem.id)"
            class="btn btn-light mb-1"
            v-if="currentUser.can && currentUser.can['index_pertemuan_cu']"
            :disabled="!selectedItem.id"
          >
            <i class="icon-stack2"></i> Detail
          </button>
      ...
      <template slot="item-desktop" slot-scope="props">
        <tr
          ...
          v-if="
            idCu() === 0 ||
            (idCu() === props.item.id_cu &&
              idAktivis() === props.item.id_aktivis)
          "
        >
          <td>
            {{
          ...
          <td v-if="idCu() === 0 && !columnData[3].hide">
            <check-value :value="cuName(props.item.id_cu)"></check-value>
          </td>
          <td v-if="!columnData[4].hide">
            <check-value :value="props.item.name"></check-value>
          </td>
          <td v-if="!columnData[5].hide && !columnData[4].disable">
            <check-value
          ...
          <td v-if="!columnData[7].hide && !columnData[6].disable">
            <check-value
          ...
          <td v-if="!columnData[13].hide" class="text-warp">
      ...
      <template
        slot="item-mobile"
        slot-scope="props"
        v-if="idCu() === 0 || idCu() === props.item.id_cu"
      >
        <div class="col-lg-4 col-md-6">
          ...
          >
            ...
            <div class="card-body">
              ...
              <template v-else-if="props.item.tipe == 'pertemuan_cu'">
                <img
              ...
              <p class="mb-3" v-if="props.item.keterangan">
                {{ props.item.keterangan | trimString }}
              </p>
...
export default {
  ...
  methods: {
    ...
    cuName(id) {
      return this.modelCU.find((cu) => cu.id === id).name;
    },
    selectedRow(item) {
