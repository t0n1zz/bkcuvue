...
export default {
  ...
  methods: {
    fetchKomentar(params) {
      this.$store.dispatch("kegiatanCU/indexPertanyaanKomentar", [
        params,
        this.selected.id,
      ]);
    },
      ...
      this.$validator.validateAll("formKomentar").then((result) => {
        if (result) {
          if (this.mode == "edit") {
            ...
            this.$store.dispatch("kegiatanCU/updatePertanyaanKomentar", [
            ...
            this.$store.dispatch("kegiatanCU/storePertanyaanKomentar", [
              this.kegiatan_id,
              this.formKomentar,
            ]);
          }
    ...
    showOke() {
      if (this.isShowHapus) {
        this.$store.dispatch(
          "kegiatanCU/destroyPertanyaanKomentar",
          this.selectedKomentar.id
        );
      } else if (this.isShowJawaban) {
        this.$store.dispatch("kegiatanCU/jawabanPertanyaan", [
          this.selectedKomentar.id,
          "jawaban",
        ]);
