	...
	<div>
		...
		@fetch="fetch">
			...
			<template slot="button-desktop">
				...
				<!-- tambah -->
				<div class="btn-group pb-5" v-if="profile.can && profile.can['create_tempat']">
				...
				<!-- ubah-->
				<div class="btn-group pb-5" v-if="profile.can && profile.can['update_tempat']">
				...
				<!-- hapus -->
				<div class="btn-group pb-5" v-if="profile.can && profile.can['destroy_tempat']">
			...
			<template slot="button-context">
				...
				<!-- update -->
				<li v-if="profile.can && profile.can['update_tempat']">
				...
				<!-- destroy -->
				<li v-if="profile.can && profile.can['destroy_tempat']">
