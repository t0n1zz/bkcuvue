								...
								<div class="row">
									...
									<div class="col-md-4">
										<div class="form-group" :class="{ 'has-error': errors.has('form.name') }">
											...
											<input type="text" name="name" class="form-control"
												placeholder="Silahkan masukkan judul artikel" v-validate="'required|min:5'"
												data-vv-as="Judul" v-model="form.name">
										...
										<div class="form-group"
											...
											<div class="input-group">
												...
												<select class="form-control" name="id_artikel_penulis"
													...
													<option disabled value="">
														<span v-if="form.id_cu != 0 && modelPenulis.length == 0">Silahkan
												...
												<div class="input-group-append">
													<button type="button" class="btn btn-light" @click="modalOpen_Penulis"
														:disabled="form.id_cu === ''">
									...
									<div class="col-md-12">
										<div class="form-group">
											...
											<!-- editor -->
											<ckeditor type="classic" v-model="form.content" :upload-adapter="UploadAdapter">
											</ckeditor>
