  ...
  <div>
    <div class="row" v-if="dataStat == 'success'">
        ...
        <div class="form-group">
          <div class="input-group">
            ...
            <select
              ...
              data-width="100%"
              class="form-control"
              @change="changePeran($event.target.value)"
              v-model="selectPeran"
            >
              <option disabled value="" selected>
                Silahkan pilih peran user
              </option>
      ...
      <div
        ...
        v-for="akses in hakAkses"
        v-if="tipeUser === akses.tipe || akses.tipe === 'all'"
      >
        <div class="card">
            ...
            <div class="header-elements">
              <div class="list-icons">
                <a
                  ...
                  @click.prevent="checkGroup(akses.name)"
                >
                ...
                <a
                  href="#"
                  class="list-icons-item"
                  @click.prevent="unCheckGroup(akses.name)"
                >
          ...
          <div class="card-body">
            ...
            <div class="row">
              <div
                class="col-sm-3 mb-2"
                v-for="permission in akses.permission"
                v-if="
                  tipeUser == permission.tipe ||
                  permission.tipe == 'all' ||
      ...
      hakAkses: [
        {
          name: "Artikel",
          keterangan:
            "Mengelola data artikel yang akan muncul pada halaman website",
          icon: "icon-newspaper",
          secondRow: true,
          tipe: "all",
          permission: [
        ...
        },
        {
          ...
          keterangan:
            "Mengelola data diklat yang diselenggarakan oleh PUSKOPCUINA",
        ...
        },
        {
          ...
          keterangan:
            "Mengelola data pertemuan yang diselenggarakan oleh PUSKOPCUINA",
          icon: "icon-ungroup",
          secondRow: true,
          tipe: "all",
          permission: [
        ...
        },
        {
          name: "Diklat CU",
          keterangan:
            "Mengelola data diklat yang diselenggarakan oleh CU PRIMER",
          icon: "icon-graduation2",
          secondRow: true,
          tipe: "all",
          permission: [
        ...
        },
        {
          name: "Pertemuan CU",
          keterangan:
            "Mengelola data pertemuan yang diselenggarakan oleh CU PRIMER",
          icon: "icon-ungroup",
          secondRow: true,
          tipe: "all",
          permission: [
        ...
        },
        {
          name: "Tempat",
          keterangan:
            "Mengelola data tempat diklat dan pertemuan yang diselenggarakan oleh PUSKOPCUINA",
          icon: "icon-location4",
          secondRow: true,
          tipe: "bkcu",
          permission: [
        ...
        },
        {
          name: "Klaim JALINAN",
          keterangan:
            "Mengelola data pengajuan klaim JALINAN dan mengatur tingkat aktivis yang melakukan verifikasi dimana 1 user hanya boleh memiliki 1 hak akses verifikasi",
        ...
        },
        {
          name: "CU",
          keterangan:
            "Mengelola data profil CU yang juga akan muncul di website",
          icon: "icon-office",
          secondRow: true,
          tipe: "all",
          permission: [
        ...
        },
        {
          name: "TP/KP",
          keterangan:
            "Mengelola data profil TP/KP dari CU yang akan muncul di website",
          icon: "icon-home9",
          secondRow: true,
          tipe: "all",
          permission: [
        ...
        },
        {
          ...
          keterangan:
            "Mengelola data produk dan pelayanan CU yang akan muncul di website",
          icon: "icon-list3",
          secondRow: true,
          tipe: "all",
          permission: [
        ...
        },
        {
          name: "Aktivis CU",
          keterangan:
            "Mengelola data aktivis CU yang terdiri dari pengurus, pengawas, komite, penasihat, dan manajemen",
          icon: "icon-user-tie",
          secondRow: true,
          tipe: "all",
          permission: [
        ...
        },
        {
          name: "Laporan CU",
          keterangan:
            "Mengelola data statistik laporan CU yang merupakan konsolidasi dari laporan TP/KP",
    ...
    checkPeran(value) {
      if (this.tipeUser == "cu") {
        if (_.isEqual(_.sortBy(this.hakForm), _.sortBy(this.peran.penuhCU))) {
          ...
          _.isEqual(_.sortBy(this.hakForm), _.sortBy(this.peran.organisasiCU))
        ) {
          this.selectPeran = "organisasi";
        } else if (
          _.isEqual(_.sortBy(this.hakForm), _.sortBy(this.peran.kegiatanCU))
        ) {
          this.selectPeran = "kegiatan";
        } else if (
          _.isEqual(_.sortBy(this.hakForm), _.sortBy(this.peran.monitoring))
        ) {
          this.selectPeran = "monitoring";
        } else if (
          _.isEqual(_.sortBy(this.hakForm), _.sortBy(this.peran.tataKelola))
        ) {
          this.selectPeran = "tataKelola";
        } else if (
          _.isEqual(_.sortBy(this.hakForm), _.sortBy(this.peran.publikasi))
        ) {
        ...
        if (_.isEqual(_.sortBy(this.hakForm), _.sortBy(this.peran.penuhBKCU))) {
          ...
          _.isEqual(_.sortBy(this.hakForm), _.sortBy(this.peran.organisasiBKCU))
        ) {
          this.selectPeran = "organisasi";
        } else if (
          _.isEqual(_.sortBy(this.hakForm), _.sortBy(this.peran.kegiatanBKCU))
        ) {
          this.selectPeran = "kegiatan";
        } else if (
          _.isEqual(_.sortBy(this.hakForm), _.sortBy(this.peran.monitoring))
      ...
      for (var key in this.hakAkses) {
        for (var key2 in this.hakAkses[key].permission) {
          if (this.hakAkses[key].permission[key2].group == value) {
            if (
              !_.includes(this.hakForm, this.hakAkses[key].permission[key2].key)
            ) {
      ...
      for (var key in this.hakAkses) {
        for (var key2 in this.hakAkses[key].permission) {
          if (this.hakAkses[key].permission[key2].group == value) {
            if (this.hakAkses[key].permission[key2].tipe == "all") {
              this.hakForm.splice(
                this.hakForm.indexOf(this.hakAkses[key].permission[key2].key),
                1
              );
            } else {
              if (this.hakAkses[key].permission[key2].tipe == this.tipeUser) {
