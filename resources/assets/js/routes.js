...
const formEvaluasi = () => import("./views/formEvaluasi/index.vue");
const formEvaluasi_form = () => import("./views/formEvaluasi/form.vue");
const formEvaluasi_formSub = () => import("./views/formEvaluasi/subMateri.vue");
...
const routes = [
  ...
  {
    path: "/kegiatanBKCU/buka",
    name: "kegiatanBKCUDibuka",
    components: { default: kegiatanBKCU, header: header, footer: footer },
    meta: { requiresAuth: true, mode: "buka" },
  },
  {
