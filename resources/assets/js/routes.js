...
const notification = () =>
    import ('./views/sistem/notification.vue');
const changelog = () =>
    import ('./views/sistem/changelog.vue');
const saran = () =>
    import ('./views/saran/index.vue');
const errorLog = () =>
    import ('./views/errorLog/index.vue');
const activityLog = () =>
    import ('./views/user/indexAktivitas.vue');
const pengumuman = () =>
    import ('./views/pengumuman/index.vue');
const notFound = () =>
    import ('./views/notFound.vue');
const artikel = () =>
    import ('./views/artikel/index.vue');
const artikel_form = () =>
    import ('./views/artikel/form.vue');
const artikelPenulis = () =>
    import ('./views/artikelPenulis/index.vue');
const artikelPenulis_form = () =>
    import ('./views/artikelPenulis/form.vue');
const artikelKategori = () =>
    import ('./views/artikelKategori/index.vue');
const artikelKategori_form = () =>
    import ('./views/artikelKategori/form.vue');
const artikelSimo = () =>
    import ('./views/artikelSimo/index.vue');
const artikelSimo_form = () =>
    import ('./views/artikelSimo/form.vue');
const laporanCu = () =>
    import ('./views/laporanCu/index.vue');
const laporanCu_form = () =>
    import ('./views/laporanCu/form.vue');
const laporanCu_detail = () =>
    import ('./views/laporanCu/detail.vue');
const laporanCu_draft = () =>
    import ('./views/laporanCu/draft.vue');
const laporanTp_draft = () =>
    import ('./views/laporanCu/draftTp.vue');
const laporanGerakan = () =>
    import ('./views/laporanGerakan/index.vue');
const laporanGerakan_form = () =>
    import ('./views/laporanGerakan/form.vue');
const coa = () =>
    import ('./views/coa/index.vue');
const coa_form = () =>
    import ('./views/coa/form.vue');
const kegiatanBKCU = () =>
    import ('./views/kegiatanBKCU/index.vue');
const kegiatanBKCU_form = () =>
    import ('./views/kegiatanBKCU/form.vue');
const kegiatanBKCU_detail = () =>
    import ('./views/kegiatanBKCU/detail.vue');
const kegiatanPeserta = () =>
    import ('./views/kegiatanPeserta/index.vue');
const sertifikatKegiatan = () =>
    import ('./views/sertifikatKegiatan/index.vue');
const sertifikatKegiatan_form = () =>
    import ('./views/sertifikatKegiatan/form.vue');
const kodeKegiatan = () =>
    import ('./views/kodeKegiatan/index.vue');
const kodeKegiatan_form = () =>
    import ('./views/kodeKegiatan/form.vue');
const formEvaluasi = () =>
    import ('./views/formEvaluasi/index.vue');
const formEvaluasi_form = () =>
    import ('./views/formEvaluasi/form.vue');
const formEvaluasi_formSub = () =>
    import ('./views/formEvaluasi/subMateri.vue');
const tempat = () =>
    import ('./views/tempat/index.vue');
const tempat_form = () =>
    import ('./views/tempat/form.vue');
const cu = () =>
    import ('./views/cu/index.vue');
const cu_form = () =>
    import ('./views/cu/form.vue');
const tp = () =>
    import ('./views/tp/index.vue');
const tp_form = () =>
    import ('./views/tp/form.vue');
const aktivis = () =>
    import ('./views/aktivis/index.vue');
const aktivis_form = () =>
    import ('./views/aktivis/form.vue');
const aktivis_riwayat = () =>
    import ('./views/aktivis/riwayat.vue');
const asetTetap = () =>
    import ('./views/asetTetap/index.vue');
const asetTetap_form = () =>
    import ('./views/asetTetap/form.vue');
const asetTetap_detail = () =>
    import ('./views/asetTetap/detail.vue');
const asetTetapJenis = () =>
    import ('./views/asetTetapJenis/index.vue');
const asetTetapJenis_form = () =>
    import ('./views/asetTetapJenis/create.vue');
const asetTetapKelompok = () =>
    import ('./views/asetTetapKelompok/index.vue');
const asetTetapKelompok_form = () =>
    import ('./views/asetTetapKelompok/create.vue');
const asetTetapGolongan = () =>
    import ('./views/asetTetapGolongan/index.vue');
const asetTetapGolongan_form = () =>
    import ('./views/asetTetapGolongan/create.vue');
const asetTetapLokasi = () =>
    import ('./views/asetTetapLokasi/index.vue');
const asetTetapLokasi_form = () =>
    import ('./views/asetTetapLokasi/create.vue');
const surat = () =>
    import ('./views/surat/index.vue');
const surat_form = () =>
    import ('./views/surat/form.vue');
const suratKategori = () =>
    import ('./views/suratKategori/index.vue');
const suratKategori_form = () =>
    import ('./views/suratKategori/form.vue');
const suratKode = () =>
    import ('./views/suratKode/index.vue');
const suratKode_form = () =>
    import ('./views/suratKode/form.vue');
const suratMasuk = () =>
    import ('./views/suratMasuk/index.vue');
const suratMasuk_form = () =>
    import ('./views/suratMasuk/form.vue');
const dokumen = () =>
    import ('./views/dokumen/index.vue');
const dokumen_form = () =>
    import ('./views/dokumen/form.vue');
const dokumenKategori = () =>
    import ('./views/dokumenKategori/index.vue');
const dokumenKategori_form = () =>
    import ('./views/dokumenKategori/form.vue');
const mitraOrang = () =>
    import ('./views/mitraOrang/index.vue');
const mitraOrang_form = () =>
    import ('./views/mitraOrang/form.vue');
const mitraLembaga = () =>
    import ('./views/mitraLembaga/index.vue');
const mitraLembaga_form = () =>
    import ('./views/mitraLembaga/form.vue');
const anggotaCu = () =>
    import ('./views/anggotaCu/index.vue');
const anggotaCu_form = () =>
    import ('./views/anggotaCu/form.vue');
const anggotaCu_produk = () =>
    import ('./views/anggotaCu/produk.vue');
const anggotaCuDraft = () =>
    import ('./views/anggotaCuDraft/index.vue');
const anggotaCuDraft_form = () =>
    import ('./views/anggotaCuDraft/form.vue');
...
const saldo = () =>
    import ('./views/saldo/index.vue');
const jalinanKlaim = () =>
    import ('./views/jalinanKlaim/index.vue');
const jalinanKlaim_form = () =>
    import ('./views/jalinanKlaim/form.vue');
const jalinanCair = () =>
    import ('./views/jalinanCair/index.vue');
const jalinanLaporan_KlaimCu = () =>
    import ('./views/jalinanLaporan/cu.vue');
...
const produkCu = () =>
    import ('./views/produkCu/index.vue');
const produkCu_form = () =>
    import ('./views/produkCu/form.vue');
const user = () =>
    import ('./views/user/index.vue');
const user_form = () =>
    import ('./views/user/form.vue');
const user_aktivitas = () =>
    import ('./views/user/aktivitas.vue');
const profile = () =>
    import ('./views/user/profile.vue');
const assesmentAccess = () =>
    import ('./views/assesmentAccess/index.vue');
const assesmentAccess_form = () =>
    import ('./views/assesmentAccess/form.vue');
const monitoring = () =>
    import ('./views/monitoring/index.vue');
const monitoring_form = () =>
    import ('./views/monitoring/form.vue');
const monitoring_detail = () =>
    import ('./views/monitoring/detail.vue');
const pemilihan = () =>
    import ('./views/pemilihan/index.vue');
const pemilihan_form = () =>
    import ('./views/pemilihan/form.vue');
const pemilihan_detail = () =>
    import ('./views/pemilihan/detail.vue');
const pemilihan_pilih = () =>
    import ('./views/pemilihan/pilih.vue');
const pemilihan_input = () =>
    import ('./views/pemilihan/input.vue');
const voting = () =>
    import ('./views/voting/index.vue');
const voting_form = () =>
    import ('./views/voting/form.vue');
const voting_detail = () =>
    import ('./views/voting/detail.vue');
const voting_pilih = () =>
    import ('./views/voting/pilih.vue');
const voting_input = () =>
    import ('./views/voting/input.vue');
const jalinanIuran = () =>
    import ('./views/jalinanIuran/index.vue');
const jalinanIuran_form = () =>
    import ('./views/jalinanIuran/form.vue');
const jalinanIuran_detail = () =>
    import ('./views/jalinanIuran/detail.vue');
const dataAnggotaUpload = () =>
    import ('./views/sistem/dataAnggotaUpload.vue');
...
const routes = [
    ...
    // form evaluasi
    {
        path: '/formEvaluasi',
        name: 'formEvaluasi',
        components: { default: formEvaluasi, 'header': header, 'footer': footer },
        meta: { requiresAuth: true }
    },
    {
        path: '/formEvaluasi/create',
        name: 'formEvaluasiCreate',
        components: { default: formEvaluasi_form, 'header': header, 'footer': footer },
        meta: { requiresAuth: true }
    },
    {
        path: '/formEvaluasi/createSub',
        name: 'formEvaluasiCreateSub',
        components: { default: formEvaluasi_formSub, 'header': header, 'footer': footer },
        meta: { requiresAuth: true }
    },
    {
        path: '/formEvaluasi/edit/:id',
        name: 'formEvaluasiEdit',
        components: { default: formEvaluasi_form, 'header': header, 'footer': footer },
        meta: { requiresAuth: true, mode: 'edit' }
    },
    {
        path: '/formEvaluasi/editSub/:id',
        name: 'formEvaluasiEditSub',
        components: { default: formEvaluasi_formSub, 'header': header, 'footer': footer },
        meta: { requiresAuth: true, mode: 'edit' }
    },
