...
const routes = [
	...
	{ path: '/jalinan/laporan/klaim/cair',
		...
		meta: { requiresAuth: true }},
	{ path: '/jalinan/laporan/klaim/cair/:awal/:akhir/cu/:cu/:tp',
	...
	{ path: '/jalinan/laporan/klaim/penyebab',
		...
		meta: { requiresAuth: true }},
	{ path: '/jalinan/laporan/klaim/penyebab/:awal/:akhir/cu/:cu/:tp',
	...
	{ path: '/jalinan/laporan/klaim/lama',
		...
		meta: { requiresAuth: true }},
	{ path: '/jalinan/laporan/klaim/lama/:awal/:akhir/cu/:cu/:tp',
