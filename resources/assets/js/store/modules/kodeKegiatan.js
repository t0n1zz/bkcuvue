...
export const kodeKegiatan = {
    ...
    getters: {
        ...
        dataStoreStat: state => state.dataStoreStat,
    ...
    actions: {
        ...
        index({ commit }, p) {
            ...
            KODEKEGIATANAPI.index(p)
                .then(function(response) {
                    // console.log(response.data.model);
                    commit('setDataStore', response.data.model);
                    commit('setDataStoreStat', 'success');
                })
                .catch(error => {
                    commit('setDataStore', error.response);
                    commit('setDataStoreStat', 'fail');
                });
        },
        ...
        update({ commit, state, dispatch }, [id, form]) {
            commit('setUpdateStat', 'loading');
            KODEKEGIATANAPI.update(id, form)
                .then(function(response) {
                    if (response.data.saved) {
                        commit('setUpdate', response.data);
                        commit('setUpdateStat', 'success');
    ...
    mutations: {
        ...
        setDataStoreStat(state, status) {
            state.dataStoreStat = status;
        },
