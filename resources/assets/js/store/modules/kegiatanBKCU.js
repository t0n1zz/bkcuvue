...
export const kegiatanBKCU = {
  ...
  getters: {
    ...
    dataFormNilai: (state) => state.dataFormNilai,
    dataFormAllNilai: (state) => state.dataFormAllNilai,
    dataFormS: (state) => state.dataFormS,
    ...
    dataFormStat: (state) => state.dataFormStat,
    dataFormNilaiStat: (state) => state.dataFormNilaiStat,
    dataFormAllNilaiStat: (state) => state.dataFormAllNilaiStat,
    dataFormStatS: (state) => state.dataFormStatS,
    ...
    update3: (state) => state.update3,
    updateStat3: (state) => state.updateStat3,
  ...
  actions: {
    ...
    indexFormEvaluasi({ commit }, id) {
      commit("setDataFormStat", "loading");
      KEGIATANBKCUAPI.indexFormEvaluasi(id)
        .then(function (response) {
          commit("setDataForm", response.data.model);
          commit("setDataFormStat", "success");
        })
        .catch((error) => {
          commit("setDataForm", error.response);
          commit("setDataFormStat", "fail");
        });
    },

    indexEvaluasiNilai({ commit }, id) {
      commit("setDataFormNilaiStat", "loading");
      KEGIATANBKCUAPI.indexEvaluasiNilai(id)
        .then(function (response) {
          commit("setDataFormNilai", response.data.model);
          commit("setDataFormNilaiStat", "success");
        })
        .catch((error) => {
          commit("setDataFormNilai", error.response);
          commit("setDataFormNilaiStat", "fail");
        });
    },
    indexAllEvaluasiNilai({ commit }, id) {
      commit("setDataFormAllNilaiStat", "loading");
      KEGIATANBKCUAPI.indexAllEvaluasiNilai(id)
        .then(function (response) {
          commit("setDataFormAllNilai", response.data.model);
          commit("setDataFormAllNilaiStat", "success");
        })
        .catch((error) => {
          commit("setDataFormAllNilai", error.response);
          commit("setDataFormAllNilaiStat", "fail");
        });
    },
    ...
    getFormEvaluasi({ commit }) {
      commit("setDataFormStatS", "loading");

      KEGIATANBKCUAPI.getFormEvaluasi()
        .then(function (response) {
          commit("setDataFormS", response.data.model);
          commit("setDataFormStatS", "success");
        })
        .catch((error) => {
          commit("setDataFormS", error.response);
          commit("setDataFormStatS", "fail");
        });
    },
    ...
    storeFormEvaluasiNilai({ commit }, [form]) {
      commit("setUpdateStat3", "loading");
      KEGIATANBKCUAPI.storeFormEvaluasiNilai(form)
        .then(function (response) {
          if (response.data.saved) {
            commit("setUpdate3", response.data);
            commit("setUpdateStat3", "success");
          } else {
            commit("setUpdateStat3", "fail");
          }
        })
        .catch((error) => {
          commit("setUpdate3", error.response);
          commit("setUpdateStat3", "fail");
        });
    },
    // edit page
  ...
  mutations: {
    ...
    setDataFormNilai(state, data) {
      state.dataFormNilai = data;
    },
    setDataFormAllNilai(state, data) {
      state.dataFormAllNilai = data;
    },
    setDataFormS(state, data) {
      state.dataFormS = data;
    },
    ...
    setDataStat5(state, data) {
      state.dataStat5 = data;
    },
    ...
    setDataFormStat(state, data) {
      state.dataFormStat = data;
    },
    setDataFormNilaiStat(state, data) {
      state.dataFormNilaiStat = data;
    },
    setDataFormAllNilaiStat(state, data) {
      state.dataFormAllNilaiStat = data;
    },
    setDataFormStatS(state, data) {
      state.dataFormStatS = data;
    },
    ...
    setUpdate3(state, data) {
      state.update3 = data;
    },
    setUpdateStat3(state, status) {
      state.updateStat3 = status;
    },
