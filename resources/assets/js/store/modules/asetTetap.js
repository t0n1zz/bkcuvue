...
export const asetTetap = {
    ...
    actions: {
        ...
        indexHapus({ commit }, p) {
            commit('setDataStatH', 'loading');

            AsetTetapAPI.indexHapus(p)
                .then(function(response) {
                    commit('setDataH', response.data.model);
                    commit('setDataStatH', 'success');
                })
                .catch(error => {
                    commit('setDataH', error.response);
                    commit('setDataStatH', 'fail');
                });
        },
    ...
    mutations: {
        ...
        setDataStatH(state, status) {
            state.dataStatH = status;
        },
        setDataH(state, status) {
            state.dataH = status;
        },
