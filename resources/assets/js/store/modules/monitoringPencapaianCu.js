...
export const monitoringPencapaianCu = {
  namespaced: true,
  ...
  actions: {
    ...
    get( { commit }, id ){
      ...
      MonitoringPencapaianCuAPI.get( id )
    ...
    detail( { commit }, id ){
      ...
      MonitoringPencapaianCuAPI.detail( id )
        .then( function( response ){
    ...
    store( {commit, state, dispatch}, form ){
      ...
      MonitoringPencapaianCuAPI.store( form )
        .then( function( response ){
    ...
    update( {commit, state, dispatch}, [id, form] ){
      ...
      MonitoringPencapaianCuAPI.update( id, form )
        .then( function( response ){
          if(response.data.saved){
            commit('setUpdate', response.data);
            commit('setUpdateStat', 'success');
    ...
    restore( {commit, state, dispatch}, id ){
      ...
      MonitoringPencapaianCuAPI.restore( id )
        .then( function( response ){
    ...
    destroy( {commit, state, dispatch}, id ){
      ...
      MonitoringPencapaianCuAPI.destroy( id )
        .then( function( response ){
    ...
    count( { commit } ){
      ...
      MonitoringPencapaianCuAPI.count()
        .then( function( response ){
