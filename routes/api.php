...
Route::group(['middleware' => 'throttle:60,1'], function () {
    ...
    Route::group(['middleware' => 'jwt.auth'], function () {
        ...
        Route::get('/asetTetap/asetDihapus', 'AsetTetapController@indexAsetDihapus');
        Route::get('/asetTetap/asetSelesai', 'AsetTetapController@indexPenyusutanSelesai');
        ...
        Route::group(['middleware' => ['permission:update_aset_tetap']], function () {
            ...
            Route::post('/asetTetap/updateLokasi/{id}', 'AsetTetapController@updateLokasi');
            Route::post('/asetTetap/hapusDariLaporan/{id}', 'AsetTetapController@hapusDariLaporan');
        });
